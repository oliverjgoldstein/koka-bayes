...
static inline kk_std_num_random__sfc kk_std_num_random__sfc_unbox(kk_box_t _x, kk_context_t* _ctx) {
  ...
  else { kk_std_num_random__sfc_dup(_unbox); }
  return _unbox;
}
...
static inline kk_std_num_random__sfc kk_std_num_random__copy(kk_std_num_random__sfc _this, kk_std_core_types__optional x0, kk_std_core_types__optional y0, kk_std_core_types__optional z0, kk_std_core_types__optional cnt0, kk_context_t* _ctx) { /* (sfc, x : optional<int32>, y : optional<int32>, z : optional<int32>, cnt : optional<int32>) -> sfc */ 
  int32_t _x1551;
