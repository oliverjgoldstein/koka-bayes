...
static kk_box_t kk_sampling_populate_fun994(kk_function_t _fself, kk_integer_t _b_837, kk_context_t* _ctx) {
  ...
  _x995 = kk_handlers_weighted(_x996, kk_sampling_new_populate_fun997(k, model, _ctx), _ctx); /*(effects-and-types/exp, 1581)*/
...
kk_std_core__list kk_sampling_importance__sampling(kk_function_t model, kk_context_t* _ctx) { /* forall<a,e> (model : effects-and-types/model<a,<std/num/random/random|e>>) -> <std/num/random/random|e> effects-and-types/histogram<a> */ 
  kk_box_t _x1024 = kk_handlers_random__sampler(kk_sampling_new_importance__sampling_fun1025(model, _ctx), _ctx); /*312*/
...
// lift anonymous function
struct kk_sampling__lift737_weighted__choice_fun1046__t {
  struct kk_function_s _base;
};
static kk_box_t kk_sampling__lift737_weighted__choice_fun1046(kk_function_t _fself, kk_box_t _b_887, kk_context_t* _ctx);
static kk_function_t kk_sampling__new_lift737_weighted__choice_fun1046(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_sampling__lift737_weighted__choice_fun1046, _ctx)
  return kk_function_dup(_fself);
}
...
static kk_box_t kk_sampling__lift737_weighted__choice_fun1046(kk_function_t _fself, kk_box_t _b_887, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  double _x1047;
  kk_effects_dash_and_dash_types__exp _x1048 = kk_effects_dash_and_dash_types__exp_unbox(_b_887, _ctx); /*effects-and-types/exp*/
  _x1047 = kk_exponents_exp__to__double(_x1048, _ctx); /*double*/
  return kk_double_box(_x1047, _ctx);
}
...
kk_box_t kk_sampling__lift737_weighted__choice(double fuel, kk_std_core__list ws, kk_context_t* _ctx) { /* forall<a> (fuel : double, ws : list<(effects-and-types/exp, a)>) -> exn a */ 
  ...
  if (kk_std_core__is_Nil(ws)) {
    ...
    kk_std_core_types__optional _x1034 = kk_std_core_types__new_None(_ctx); /*forall<a> optional<a>*/
    if (kk_std_core_types__is_Optional(_x1034)) {
      kk_box_t _box_x874 = _x1034._cons.Optional.value;
    ...
    _match1035: ;
    exn_21565 = kk_std_core__new_Exception(_x1031, _x1033, _ctx); /*exception*/
    kk_std_core_hnd__ev ev_21566;
    size_t _x1037 = ((size_t)0); /*size_t*/
    ev_21566 = kk_evv_at(_x1037,kk_context()); /*std/core/hnd/ev<.hnd-exn>*/
    struct kk_std_core_hnd_Ev* _con1038 = kk_std_core_hnd__as_Ev(ev_21566);
    kk_std_core_hnd__marker m = _con1038->marker;
    kk_box_t _box_x875 = _con1038->hnd;
    ...
    struct kk_std_core__Hnd_exn* _con1040 = kk_std_core__as_Hnd_exn(h);
    kk_std_core_hnd__clause1 except_throw_exn = _con1040->except_throw_exn;
    ...
    return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x879, (_fun_unbox_x879, m, ev_21566, kk_std_core__exception_box(exn_21565, _ctx), _ctx));
  }
  struct kk_std_core_Cons* _con1041 = kk_std_core__as_Cons(ws);
  kk_box_t _box_x883 = _con1041->head;
  kk_std_core__list wxs = _con1041->tail;
  ...
  double fuel__new;
  double _x1044;
  kk_box_t _x1045 = kk_std_core_hnd__open_none1(kk_sampling__new_lift737_weighted__choice_fun1046(_ctx), kk_effects_dash_and_dash_types__exp_box(w, _ctx), _ctx); /*2*/
  _x1044 = kk_double_unbox(_x1045, _ctx); /*double*/
  fuel__new = (fuel - _x1044); /*double*/
...
// lift anonymous function
struct kk_sampling__mlift751_weighted__choice_fun1051__t {
  struct kk_function_s _base;
};
static kk_box_t kk_sampling__mlift751_weighted__choice_fun1051(kk_function_t _fself, kk_box_t _b_895, kk_context_t* _ctx);
static kk_function_t kk_sampling__new_mlift751_weighted__choice_fun1051(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_sampling__mlift751_weighted__choice_fun1051, _ctx)
  return kk_function_dup(_fself);
}
...
static kk_box_t kk_sampling__mlift751_weighted__choice_fun1051(kk_function_t _fself, kk_box_t _b_895, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  double _x1052;
  kk_effects_dash_and_dash_types__exp _x1053 = kk_effects_dash_and_dash_types__exp_unbox(_b_895, _ctx); /*effects-and-types/exp*/
  _x1052 = kk_exponents_exp__to__double(_x1053, _ctx); /*double*/
  return kk_double_box(_x1052, _ctx);
}


// lift anonymous function
struct kk_sampling__mlift751_weighted__choice_fun1054__t {
  struct kk_function_s _base;
  size_t i_771;
};
static kk_box_t kk_sampling__mlift751_weighted__choice_fun1054(kk_function_t _fself, kk_function_t cont, kk_box_t res, kk_context_t* _ctx);
static kk_function_t kk_sampling__new_mlift751_weighted__choice_fun1054(size_t i_771, kk_context_t* _ctx) {
  struct kk_sampling__mlift751_weighted__choice_fun1054__t* _self = kk_function_alloc_as(struct kk_sampling__mlift751_weighted__choice_fun1054__t, 1, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_sampling__mlift751_weighted__choice_fun1054, kk_context());
  _self->i_771 = i_771;
  return &_self->_base;
}

static kk_box_t kk_sampling__mlift751_weighted__choice_fun1054(kk_function_t _fself, kk_function_t cont, kk_box_t res, kk_context_t* _ctx) {
  struct kk_sampling__mlift751_weighted__choice_fun1054__t* _self = kk_function_as(struct kk_sampling__mlift751_weighted__choice_fun1054__t*, _fself);
...
kk_box_t kk_sampling__mlift751_weighted__choice(kk_std_core__list histogram, kk_effects_dash_and_dash_types__exp total__w, double _y_10, kk_context_t* _ctx) { /* forall<a> (histogram : effects-and-types/histogram<a>, total_w : effects-and-types/exp, double) -> <effects-and-types/sample,exn> a */ 
  double total__fuel;
  double _x1049;
  kk_box_t _x1050 = kk_std_core_hnd__open_none1(kk_sampling__new_mlift751_weighted__choice_fun1051(_ctx), kk_effects_dash_and_dash_types__exp_box(total__w, _ctx), _ctx); /*2*/
  _x1049 = kk_double_unbox(_x1050, _ctx); /*double*/
  total__fuel = (_x1049 * _y_10); /*double*/
  ...
  if (kk_yielding(kk_context())) {
    kk_box_drop(y, _ctx);
    return kk_std_core_hnd_yield_cont(kk_sampling__new_mlift751_weighted__choice_fun1054(i_771, _ctx), _ctx);
  }
  return y;
}
...
static kk_box_t kk_sampling_weighted__choice_fun1062(kk_function_t _fself, kk_function_t _b_911, kk_box_t _b_912, kk_context_t* _ctx);
static kk_function_t kk_sampling_new_weighted__choice_fun1062(size_t i_780, kk_context_t* _ctx) {
  struct kk_sampling_weighted__choice_fun1062__t* _self = kk_function_alloc_as(struct kk_sampling_weighted__choice_fun1062__t, 1, _ctx);
...
// lift anonymous function
struct kk_sampling_weighted__choice_fun1063__t {
  struct kk_function_s _base;
  kk_std_core__list histogram;
  kk_effects_dash_and_dash_types__exp total__w;
};
static kk_box_t kk_sampling_weighted__choice_fun1063(kk_function_t _fself, kk_box_t _b_922, kk_context_t* _ctx);
static kk_function_t kk_sampling_new_weighted__choice_fun1063(kk_std_core__list histogram, kk_effects_dash_and_dash_types__exp total__w, kk_context_t* _ctx) {
  struct kk_sampling_weighted__choice_fun1063__t* _self = kk_function_alloc_as(struct kk_sampling_weighted__choice_fun1063__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_sampling_weighted__choice_fun1063, kk_context());
...
static kk_box_t kk_sampling_weighted__choice_fun1063(kk_function_t _fself, kk_box_t _b_922, kk_context_t* _ctx) {
  struct kk_sampling_weighted__choice_fun1063__t* _self = kk_function_as(struct kk_sampling_weighted__choice_fun1063__t*, _fself);
  ...
  double _x1064 = kk_double_unbox(_b_922, _ctx); /*double*/
  return kk_sampling__mlift751_weighted__choice(histogram, total__w, _x1064, _ctx);
}


// lift anonymous function
struct kk_sampling_weighted__choice_fun1067__t {
  struct kk_function_s _base;
};
static kk_box_t kk_sampling_weighted__choice_fun1067(kk_function_t _fself, kk_box_t _b_925, kk_context_t* _ctx);
static kk_function_t kk_sampling_new_weighted__choice_fun1067(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_sampling_weighted__choice_fun1067, _ctx)
  return kk_function_dup(_fself);
}
...
static kk_box_t kk_sampling_weighted__choice_fun1067(kk_function_t _fself, kk_box_t _b_925, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  double _x1068;
  kk_effects_dash_and_dash_types__exp _x1069 = kk_effects_dash_and_dash_types__exp_unbox(_b_925, _ctx); /*effects-and-types/exp*/
  _x1068 = kk_exponents_exp__to__double(_x1069, _ctx); /*double*/
  return kk_double_box(_x1068, _ctx);
}


// lift anonymous function
struct kk_sampling_weighted__choice_fun1070__t {
  struct kk_function_s _base;
  size_t i0_783;
};
static kk_box_t kk_sampling_weighted__choice_fun1070(kk_function_t _fself, kk_function_t cont0, kk_box_t res0, kk_context_t* _ctx);
static kk_function_t kk_sampling_new_weighted__choice_fun1070(size_t i0_783, kk_context_t* _ctx) {
  struct kk_sampling_weighted__choice_fun1070__t* _self = kk_function_alloc_as(struct kk_sampling_weighted__choice_fun1070__t, 1, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_sampling_weighted__choice_fun1070, kk_context());
  _self->i0_783 = i0_783;
  return &_self->_base;
}

static kk_box_t kk_sampling_weighted__choice_fun1070(kk_function_t _fself, kk_function_t cont0, kk_box_t res0, kk_context_t* _ctx) {
  struct kk_sampling_weighted__choice_fun1070__t* _self = kk_function_as(struct kk_sampling_weighted__choice_fun1070__t*, _fself);
...
kk_box_t kk_sampling_weighted__choice(kk_std_core__list histogram, kk_context_t* _ctx) { /* forall<a> (histogram : effects-and-types/histogram<a>) -> <exn,effects-and-types/sample> a */ 
  ...
  kk_std_core__list _x1055 = kk_std_core__list_dup(histogram); /*effects-and-types/histogram<677>*/
  x = kk_sampling_sum__weights(_x1055, _ctx); /*effects-and-types/exp*/
  kk_unit_t keep = kk_Unit;
  kk_evv_set(w,kk_context());
  ...
  size_t _x1056 = ((size_t)0); /*size_t*/
  ev_389 = kk_evv_at(_x1056,kk_context()); /*std/core/hnd/ev<effects-and-types/.hnd-sample>*/
  kk_box_t _x1057;
  struct kk_std_core_hnd_Ev* _con1058 = kk_std_core_hnd__as_Ev(ev_389);
  kk_std_core_hnd__marker m = _con1058->marker;
  kk_box_t _box_x898 = _con1058->hnd;
  ...
  struct kk_effects_dash_and_dash_types__Hnd_sample* _con1060 = kk_effects_dash_and_dash_types__as_Hnd_sample(h);
  kk_std_core_hnd__clause0 fun_sample = _con1060->fun_sample;
  ...
  _x1057 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_context_t*), _fun_unbox_x901, (_fun_unbox_x901, m, ev_389, _ctx)); /*6*/
  y = kk_double_unbox(_x1057, _ctx); /*double*/
  kk_unit_t __w_l679_c9 = kk_Unit;
  kk_evv_set(w0,kk_context());
  if (kk_yielding(kk_context())) {
    kk_box_t _x1061 = kk_std_core_hnd_yield_cont(kk_sampling_new_weighted__choice_fun1062(i_780, _ctx), _ctx); /*3*/
    x0_777 = kk_double_unbox(_x1061, _ctx); /*double*/
  }
  else {
    x0_777 = y; /*double*/
  }
  if (kk_yielding(kk_context())) {
    return kk_std_core_hnd_yield_extend(kk_sampling_new_weighted__choice_fun1063(histogram, total__w, _ctx), _ctx);
  }
  double total__fuel;
  double _x1065;
  kk_box_t _x1066 = kk_std_core_hnd__open_none1(kk_sampling_new_weighted__choice_fun1067(_ctx), kk_effects_dash_and_dash_types__exp_box(total__w, _ctx), _ctx); /*2*/
  _x1065 = kk_double_unbox(_x1066, _ctx); /*double*/
  total__fuel = (_x1065 * x0_777); /*double*/
  ...
  if (kk_yielding(kk_context())) {
    kk_box_drop(y0, _ctx);
    return kk_std_core_hnd_yield_cont(kk_sampling_new_weighted__choice_fun1070(i0_783, _ctx), _ctx);
  }
  return y0;
}
...
// lift anonymous function
struct kk_sampling__mlift752_resample_fun1072__t {
  struct kk_function_s _base;
};
static kk_box_t kk_sampling__mlift752_resample_fun1072(kk_function_t _fself, kk_box_t _b_937, kk_context_t* _ctx);
static kk_function_t kk_sampling__new_mlift752_resample_fun1072(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_sampling__mlift752_resample_fun1072, _ctx)
  return kk_function_dup(_fself);
}

static kk_box_t kk_sampling__mlift752_resample_fun1072(kk_function_t _fself, kk_box_t _b_937, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  kk_std_core__list _x1073 = kk_std_core__list_unbox(_b_937, _ctx); /*effects-and-types/histogram<736>*/
  return kk_sampling_weighted__choice(_x1073, _ctx);
}
...
kk_box_t kk_sampling__mlift752_resample(kk_std_core__list histogram, kk_unit_t wild__, kk_context_t* _ctx) { /* forall<a> (histogram : effects-and-types/histogram<a>, wild_ : ()) -> <effects-and-types/score,exn,effects-and-types/sample> a */ 
  ...
  _x1071 = kk_std_core__new_Cons(kk_reuse_null, kk_size_box(_b_941_932, _ctx), _b_942_933, _ctx); /*list<0>*/
  _b_938_934 = kk_std_core_unvlist(_x1071, _ctx); /*vector<std/core/hnd/ev-index>*/
  return kk_std_core_hnd__open1(_b_938_934, kk_sampling__new_mlift752_resample_fun1072(_ctx), kk_std_core__list_box(histogram, _ctx), _ctx);
}


// lift anonymous function
struct kk_sampling_resample_fun1076__t {
  struct kk_function_s _base;
  kk_std_core__list histogram;
  kk_effects_dash_and_dash_types__exp total__w;
};
static kk_box_t kk_sampling_resample_fun1076(kk_function_t _fself, kk_context_t* _ctx);
static kk_function_t kk_sampling_new_resample_fun1076(kk_std_core__list histogram, kk_effects_dash_and_dash_types__exp total__w, kk_context_t* _ctx) {
  struct kk_sampling_resample_fun1076__t* _self = kk_function_alloc_as(struct kk_sampling_resample_fun1076__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_sampling_resample_fun1076, kk_context());
  _self->histogram = histogram;
  _self->total__w = total__w;
  return &_self->_base;
}
...
static kk_box_t kk_sampling_resample_fun1078(kk_function_t _fself, kk_function_t _b_950, kk_box_t _b_951, kk_context_t* _ctx);
static kk_function_t kk_sampling_new_resample_fun1078(size_t i_791, kk_context_t* _ctx) {
  struct kk_sampling_resample_fun1078__t* _self = kk_function_alloc_as(struct kk_sampling_resample_fun1078__t, 1, _ctx);
...
// lift anonymous function
struct kk_sampling_resample_fun1079__t {
  struct kk_function_s _base;
  kk_std_core__list histogram;
};
static kk_box_t kk_sampling_resample_fun1079(kk_function_t _fself, kk_box_t _b_961, kk_context_t* _ctx);
static kk_function_t kk_sampling_new_resample_fun1079(kk_std_core__list histogram, kk_context_t* _ctx) {
  struct kk_sampling_resample_fun1079__t* _self = kk_function_alloc_as(struct kk_sampling_resample_fun1079__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_sampling_resample_fun1079, kk_context());
  _self->histogram = histogram;
  return &_self->_base;
}

static kk_box_t kk_sampling_resample_fun1079(kk_function_t _fself, kk_box_t _b_961, kk_context_t* _ctx) {
  struct kk_sampling_resample_fun1079__t* _self = kk_function_as(struct kk_sampling_resample_fun1079__t*, _fself);
  ...
  kk_unit_t _x1080 = kk_Unit;
  kk_unit_unbox(_b_961);
  return kk_sampling__mlift752_resample(histogram, _x1080, _ctx);
}
static kk_box_t kk_sampling_resample_fun1076(kk_function_t _fself, kk_context_t* _ctx) {
  struct kk_sampling_resample_fun1076__t* _self = kk_function_as(struct kk_sampling_resample_fun1076__t*, _fself);
  kk_std_core__list histogram = _self->histogram; /* effects-and-types/histogram<736> */
  kk_effects_dash_and_dash_types__exp total__w = _self->total__w; /* effects-and-types/exp */
  kk_drop_match(_self, {kk_std_core__list_dup(histogram);kk_effects_dash_and_dash_types__exp_dup(total__w);}, {}, _ctx)
  ...
  kk_evv_set(w0,kk_context());
  if (kk_yielding(kk_context())) {
    kk_box_t _x1077 = kk_std_core_hnd_yield_cont(kk_sampling_new_resample_fun1078(i_791, _ctx), _ctx); /*3*/
    kk_unit_unbox(_x1077);
  }
  else {
    y;
  }
  if (kk_yielding(kk_context())) {
    return kk_std_core_hnd_yield_extend(kk_sampling_new_resample_fun1079(histogram, _ctx), _ctx);
  }
...
kk_std_core__list kk_sampling_resample(kk_std_core__list histogram, kk_context_t* _ctx) { /* forall<a> (histogram : effects-and-types/histogram<a>) -> <exn,effects-and-types/sample> effects-and-types/histogram<a> */ 
  ...
  n = kk_std_core_length_1(_x1074, _ctx); /*int*/
  kk_effects_dash_and_dash_types__exp total__w;
  kk_evv_t w = kk_evv_swap_create0(kk_context()); /*std/core/hnd/evv<(<>)>*/;
  kk_effects_dash_and_dash_types__exp x;
  kk_std_core__list _x1075 = kk_std_core__list_dup(histogram); /*effects-and-types/histogram<736>*/
  x = kk_sampling_sum__weights(_x1075, _ctx); /*effects-and-types/exp*/
  kk_unit_t keep = kk_Unit;
  kk_evv_set(w,kk_context());
  total__w = x; /*effects-and-types/exp*/
  return kk_sampling_populate(n, kk_sampling_new_resample_fun1076(histogram, total__w, _ctx), _ctx);
}
