// Koka generated module: "std/text/parse", koka version: 2.1.2
...
kk_integer_t kk_std_text_parse__mlift2566_pnat(kk_string_t _y_67, kk_context_t* _ctx) { /* (string) -> parse int */ 
  ...
  kk_box_t _x5058;
  bool _x5059;
  kk_std_core_types__optional _x5060 = kk_std_core_types__new_None(_ctx); /*forall<a> optional<a>*/
  if (kk_std_core_types__is_Optional(_x5060)) {
    kk_box_t _box_x3947 = _x5060._cons.Optional.value;
  ...
  hex0_21743 = kk_std_core_types__new_Optional(_x5058, _ctx); /*optional<bool>*/
  kk_string_t _x5063 = kk_std_core_trim(_y_67, _ctx); /*string*/
  bool _x5064;
  if (kk_std_core_types__is_Optional(hex0_21743)) {
    kk_box_t _box_x3950 = hex0_21743._cons.Optional.value;
    bool _hex_19366 = kk_bool_unbox(_box_x3950);
    _x5064 = _hex_19366; /*bool*/
    goto _match5065;
  }
  _x5064 = false; /*bool*/
  _match5065: ;
  m_21740 = kk_std_core_xparse_int(_x5063, _x5064, _ctx); /*maybe<int>*/
  ...
  kk_box_t _box_x3952 = m_21740._cons.Just.value;
...
// lift anonymous function
struct kk_std_text_parse_pnat_fun5070__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_text_parse_pnat_fun5070(kk_function_t _fself, kk_box_t _b_3954, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_pnat_fun5070(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_text_parse_pnat_fun5070, _ctx)
  return kk_function_dup(_fself);
}
...
static kk_box_t kk_std_text_parse_pnat_fun5070(kk_function_t _fself, kk_box_t _b_3954, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  kk_integer_t _x5071;
  kk_string_t _x5072 = kk_string_unbox(_b_3954); /*string*/
  _x5071 = kk_std_text_parse__mlift2566_pnat(_x5072, _ctx); /*int*/
  return kk_integer_box(_x5071);
}
...
kk_integer_t kk_std_text_parse_pnat(kk_context_t* _ctx) { /* () -> parse int */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x5069 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_pnat_fun5070(_ctx), _ctx); /*3991*/
    return kk_integer_unbox(_x5069);
  }
  ...
  bool _match_4360;
  kk_string_t _x5073 = kk_string_dup(x_2795); /*string*/
  _match_4360 = kk_std_core_is_empty_2(_x5073, _ctx); /*bool*/
  if (_match_4360) {
    kk_string_drop(x_2795, _ctx);
  ...
  kk_box_t _x5075;
  bool _x5076;
  kk_std_core_types__optional _x5077 = kk_std_core_types__new_None(_ctx); /*forall<a> optional<a>*/
  if (kk_std_core_types__is_Optional(_x5077)) {
    kk_box_t _box_x3958 = _x5077._cons.Optional.value;
    bool _hex_19382 = kk_bool_unbox(_box_x3958);
    _x5076 = _hex_19382; /*bool*/
    goto _match5078;
  }
  _x5076 = false; /*bool*/
  _match5078: ;
  _x5075 = kk_bool_box(_x5076); /*108*/
  hex0_21743 = kk_std_core_types__new_Optional(_x5075, _ctx); /*optional<bool>*/
  kk_string_t _x5080 = kk_std_core_trim(x_2795, _ctx); /*string*/
  bool _x5081;
  if (kk_std_core_types__is_Optional(hex0_21743)) {
    kk_box_t _box_x3961 = hex0_21743._cons.Optional.value;
    bool _hex_19366 = kk_bool_unbox(_box_x3961);
    _x5081 = _hex_19366; /*bool*/
    goto _match5082;
  }
  _x5081 = false; /*bool*/
  _match5082: ;
  m_21740 = kk_std_core_xparse_int(_x5080, _x5081, _ctx); /*maybe<int>*/
  if (kk_std_core_types__is_Nothing(m_21740)) {
    if (kk_std_core_types__is_Optional(default_2800)) {
  ...
  kk_box_t _box_x3963 = m_21740._cons.Just.value;
...
// lift anonymous function
struct kk_std_text_parse_sign_fun5086__t {
  struct kk_function_s _base;
};
static kk_char_t kk_std_text_parse_sign_fun5086(kk_function_t _fself, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_sign_fun5086(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_text_parse_sign_fun5086, _ctx)
  return kk_function_dup(_fself);
}
...
// lift anonymous function
struct kk_std_text_parse_sign_fun5092__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_text_parse_sign_fun5092(kk_function_t _fself, kk_box_t _b_3978, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_sign_fun5092(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_text_parse_sign_fun5092, _ctx)
  return kk_function_dup(_fself);
}

static kk_box_t kk_std_text_parse_sign_fun5092(kk_function_t _fself, kk_box_t _b_3978, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  kk_std_core_types__maybe _x5093;
  kk_std_core_types__maybe _match_4358;
  kk_std_core__sslice _x5094 = kk_std_core__sslice_unbox(_b_3978, _ctx); /*sslice*/
  _match_4358 = kk_std_core_next(_x5094, _ctx); /*maybe<(char, sslice)>*/
  if (kk_std_core_types__is_Just(_match_4358)) {
    ...
    if (kk_std_core_types__is_dash__lp__comma__rp_(_pat010)) {
      ...
      kk_string_t _x5099;
      kk_define_string_literal(, _s5100, 2, "+-")
      _x5099 = kk_string_dup(_s5100); /*string*/
      kk_string_t _x5101 = kk_std_core_string(c, _ctx); /*string*/
      if (kk_string_contains(_x5099,_x5101,kk_context())) {
        kk_std_core__sslice_dup(rest0);
        ...
        _x5093 = kk_std_core_types__new_Just(kk_std_core_types__tuple2__box(_b_3989_3984, _ctx), _ctx); /*maybe<103>*/
        goto _match5095;
      }
    }
  }
  kk_std_core_types__maybe_drop(_match_4358, _ctx);
  _x5093 = kk_std_core_types__new_Nothing(_ctx); /*maybe<103>*/
  _match5095: ;
  return kk_std_core_types__maybe_box(_x5093, _ctx);
}


// lift anonymous function
struct kk_std_text_parse_sign_fun5103__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_text_parse_sign_fun5103(kk_function_t _fself, kk_box_t _b_3995, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_sign_fun5103(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_text_parse_sign_fun5103, _ctx)
  return kk_function_dup(_fself);
}
...
static kk_box_t kk_std_text_parse_sign_fun5103(kk_function_t _fself, kk_box_t _b_3995, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  kk_string_t _x5104;
  kk_define_string_literal(, _s5105, 2, "+-")
  _x5104 = kk_string_dup(_s5105); /*string*/
  kk_std_core_types__maybe _x5106 = kk_std_core_types__maybe_unbox(_b_3995, _ctx); /*maybe<char>*/
  return kk_std_text_parse__mlift2547_satisfy_fail(_x5104, _x5106, _ctx);
}
static kk_char_t kk_std_text_parse_sign_fun5086(kk_function_t _fself, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  kk_std_core_types__maybe x_2754;
  kk_std_core_hnd__ev ev_2574;
  size_t _x5087 = ((size_t)0); /*size_t*/
  ev_2574 = kk_evv_at(_x5087,kk_context()); /*std/core/hnd/ev<std/text/parse/.hnd-parse>*/
  kk_box_t _x5088;
  struct kk_std_core_hnd_Ev* _con5089 = kk_std_core_hnd__as_Ev(ev_2574);
  kk_std_core_hnd__marker m0 = _con5089->marker;
  kk_box_t _box_x3965 = _con5089->hnd;
  kk_std_text_parse__hnd_parse h0 = kk_std_text_parse__hnd_parse_unbox(_box_x3965, NULL);
  kk_std_text_parse__hnd_parse_dup(h0);
  kk_std_core_hnd__clause1 _match_4357;
  struct kk_std_text_parse__Hnd_parse* _con5091 = kk_std_text_parse__as_Hnd_parse(h0);
  kk_std_core_hnd__clause0 _pat04 = _con5091->fun_current_input;
  kk_std_core_hnd__clause1 _pat13 = _con5091->control_fail;
  kk_std_core_hnd__clause0 _pat23 = _con5091->control_pick;
  kk_std_core_hnd__clause1 fun_satisfy = _con5091->fun_satisfy;
  if (kk_std_text_parse__hnd_parse_is_unique(h0)) {
    kk_std_core_hnd__clause0_drop(_pat23, _ctx);
    kk_std_core_hnd__clause1_drop(_pat13, _ctx);
    kk_std_core_hnd__clause0_drop(_pat04, _ctx);
  ...
  _x5088 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x3972, (_fun_unbox_x3972, m0, ev_2574, kk_function_box(kk_std_text_parse_new_sign_fun5092(_ctx)), _ctx)); /*53*/
  x_2754 = kk_std_core_types__maybe_unbox(_x5088, _ctx); /*maybe<char>*/
  if (kk_yielding(kk_context())) {
    kk_std_core_types__maybe_drop(x_2754, _ctx);
    kk_box_t _x5102 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_sign_fun5103(_ctx), _ctx); /*3991*/
    return kk_char_unbox(_x5102, _ctx);
  }
  if (kk_std_core_types__is_Nothing(x_2754)) {
    kk_box_t _x5107;
    kk_string_t _x5108;
    kk_define_string_literal(, _s5109, 2, "+-")
    _x5108 = kk_string_dup(_s5109); /*string*/
    _x5107 = kk_std_text_parse_fail(_x5108, _ctx); /*492*/
    return kk_char_unbox(_x5107, _ctx);
  }
...
static kk_box_t kk_std_text_parse_sign_fun5117(kk_function_t _fself, kk_function_t _b_4016, kk_box_t _b_4017, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_sign_fun5117(size_t i_2666, kk_context_t* _ctx) {
  struct kk_std_text_parse_sign_fun5117__t* _self = kk_function_alloc_as(struct kk_std_text_parse_sign_fun5117__t, 1, _ctx);
...
// lift anonymous function
struct kk_std_text_parse_sign_fun5119__t {
  struct kk_function_s _base;
  kk_function_t p1_2922;
};
static kk_box_t kk_std_text_parse_sign_fun5119(kk_function_t _fself, kk_box_t _b_4030, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_sign_fun5119(kk_function_t p1_2922, kk_context_t* _ctx) {
  struct kk_std_text_parse_sign_fun5119__t* _self = kk_function_alloc_as(struct kk_std_text_parse_sign_fun5119__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_text_parse_sign_fun5119, kk_context());
...
static kk_function_t kk_std_text_parse_new_sign_fun5120(kk_function_t p1_2922, kk_context_t* _ctx) {
  struct kk_std_text_parse_sign_fun5120__t* _self = kk_function_alloc_as(struct kk_std_text_parse_sign_fun5120__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_text_parse_sign_fun5120, kk_context());
  _self->p1_2922 = p1_2922;
  return &_self->_base;
}

static kk_box_t kk_std_text_parse_sign_fun5120(kk_function_t _fself, kk_context_t* _ctx) {
  struct kk_std_text_parse_sign_fun5120__t* _self = kk_function_as(struct kk_std_text_parse_sign_fun5120__t*, _fself);
  kk_function_t p1_2922 = _self->p1_2922; /* std/text/parse/parser<(<>),char> */
  kk_drop_match(_self, {kk_function_dup(p1_2922);}, {}, _ctx)
  kk_char_t _x5121 = kk_function_call(kk_char_t, (kk_function_t, kk_context_t*), p1_2922, (p1_2922, _ctx)); /*char*/
  return kk_char_box(_x5121, _ctx);
}


// lift anonymous function
struct kk_std_text_parse_sign_fun5122__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_text_parse_sign_fun5122(kk_function_t _fself, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_sign_fun5122(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_text_parse_sign_fun5122, _ctx)
  return kk_function_dup(_fself);
}
...
static kk_box_t kk_std_text_parse_sign_fun5119(kk_function_t _fself, kk_box_t _b_4030, kk_context_t* _ctx) {
  struct kk_std_text_parse_sign_fun5119__t* _self = kk_function_as(struct kk_std_text_parse_sign_fun5119__t*, _fself);
  kk_function_t p1_2922 = _self->p1_2922; /* std/text/parse/parser<(<>),char> */
  kk_drop_match(_self, {kk_function_dup(p1_2922);}, {}, _ctx)
  bool _x5123 = kk_bool_unbox(_b_4030); /*bool*/
  return kk_std_text_parse__mlift2551_op(kk_std_text_parse_new_sign_fun5120(p1_2922, _ctx), kk_std_text_parse_new_sign_fun5122(_ctx), _x5123, _ctx);
}


// lift anonymous function
struct kk_std_text_parse_sign_fun5125__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_text_parse_sign_fun5125(kk_function_t _fself, kk_box_t _b_4037, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_sign_fun5125(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_text_parse_sign_fun5125, _ctx)
  return kk_function_dup(_fself);
}
...
static kk_box_t kk_std_text_parse_sign_fun5125(kk_function_t _fself, kk_box_t _b_4037, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  bool _x5126;
  kk_char_t _x5127 = kk_char_unbox(_b_4037, _ctx); /*char*/
  _x5126 = kk_std_text_parse__mlift2567_sign(_x5127, _ctx); /*bool*/
  return kk_bool_box(_x5126);
}

bool kk_std_text_parse_sign(kk_context_t* _ctx) { /* () -> parse bool */ 
  kk_char_t x_2802;
  kk_function_t p1_2922 = kk_std_text_parse_new_sign_fun5086(_ctx); /*std/text/parse/parser<(<>),char>*/;
  bool x_2663;
  size_t i_2666 = ((size_t)0); /*std/core/hnd/ev-index*/;
  kk_evv_t w = kk_evv_swap_create1(i_2666,kk_context()); /*std/core/hnd/evv<std/text/parse/parse>*/;
  bool y;
  kk_std_core_hnd__ev ev_2668;
  size_t _x5111 = ((size_t)0); /*size_t*/
  ev_2668 = kk_evv_at(_x5111,kk_context()); /*std/core/hnd/ev<std/text/parse/.hnd-parse>*/
  kk_box_t _x5112;
  struct kk_std_core_hnd_Ev* _con5113 = kk_std_core_hnd__as_Ev(ev_2668);
  kk_std_core_hnd__marker m = _con5113->marker;
  kk_box_t _box_x4003 = _con5113->hnd;
  kk_std_text_parse__hnd_parse h = kk_std_text_parse__hnd_parse_unbox(_box_x4003, NULL);
  kk_std_text_parse__hnd_parse_dup(h);
  kk_std_core_hnd__clause0 _match_4355;
  struct kk_std_text_parse__Hnd_parse* _con5115 = kk_std_text_parse__as_Hnd_parse(h);
  kk_std_core_hnd__clause0 _pat0 = _con5115->fun_current_input;
  kk_std_core_hnd__clause1 _pat1 = _con5115->control_fail;
  kk_std_core_hnd__clause0 control_pick = _con5115->control_pick;
  kk_std_core_hnd__clause1 _pat21 = _con5115->fun_satisfy;
  if (kk_std_text_parse__hnd_parse_is_unique(h)) {
    kk_std_core_hnd__clause1_drop(_pat21, _ctx);
    kk_std_core_hnd__clause1_drop(_pat1, _ctx);
    kk_std_core_hnd__clause0_drop(_pat0, _ctx);
  ...
  _x5112 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_context_t*), _fun_unbox_x4006, (_fun_unbox_x4006, m, ev_2668, _ctx)); /*37*/
  y = kk_bool_unbox(_x5112); /*bool*/
  kk_unit_t __ = kk_Unit;
  kk_evv_set(w,kk_context());
  if (kk_yielding(kk_context())) {
    kk_box_t _x5116 = kk_std_core_hnd_yield_cont(kk_std_text_parse_new_sign_fun5117(i_2666, _ctx), _ctx); /*3820*/
    x_2663 = kk_bool_unbox(_x5116); /*bool*/
  }
  else {
    x_2663 = y; /*bool*/
  }
  if (kk_yielding(kk_context())) {
    kk_box_t _x5118 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_sign_fun5119(p1_2922, _ctx), _ctx); /*3991*/
    x_2802 = kk_char_unbox(_x5118, _ctx); /*char*/
  }
  else {
    if (x_2663) {
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x5124 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_sign_fun5125(_ctx), _ctx); /*3991*/
    return kk_bool_unbox(_x5124);
  }
  return (x_2802 == ('-'));
}
...
// lift anonymous function
struct kk_std_text_parse__mlift2569_pint_fun5129__t {
  struct kk_function_s _base;
  bool neg;
};
static kk_box_t kk_std_text_parse__mlift2569_pint_fun5129(kk_function_t _fself, kk_box_t _b_4040, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse__new_mlift2569_pint_fun5129(bool neg, kk_context_t* _ctx) {
  struct kk_std_text_parse__mlift2569_pint_fun5129__t* _self = kk_function_alloc_as(struct kk_std_text_parse__mlift2569_pint_fun5129__t, 1, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_text_parse__mlift2569_pint_fun5129, kk_context());
  _self->neg = neg;
  return &_self->_base;
}

static kk_box_t kk_std_text_parse__mlift2569_pint_fun5129(kk_function_t _fself, kk_box_t _b_4040, kk_context_t* _ctx) {
  struct kk_std_text_parse__mlift2569_pint_fun5129__t* _self = kk_function_as(struct kk_std_text_parse__mlift2569_pint_fun5129__t*, _fself);
  bool neg = _self->neg; /* bool */
  kk_drop_match(_self, {;}, {}, _ctx)
  kk_integer_t _x5130;
  kk_integer_t _x5131 = kk_integer_unbox(_b_4040); /*int*/
  _x5130 = kk_std_text_parse__mlift2568_pint(neg, _x5131, _ctx); /*int*/
  return kk_integer_box(_x5130);
}
...
kk_integer_t kk_std_text_parse__mlift2569_pint(bool neg, kk_context_t* _ctx) { /* (neg : bool) -> parse int */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x5128 = kk_std_core_hnd_yield_extend(kk_std_text_parse__new_mlift2569_pint_fun5129(neg, _ctx), _ctx); /*3991*/
    return kk_integer_unbox(_x5128);
  }
...
// lift anonymous function
struct kk_std_text_parse_pint_fun5133__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_text_parse_pint_fun5133(kk_function_t _fself, kk_box_t _b_4044, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_pint_fun5133(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_text_parse_pint_fun5133, _ctx)
  return kk_function_dup(_fself);
}
...
static kk_box_t kk_std_text_parse_pint_fun5133(kk_function_t _fself, kk_box_t _b_4044, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  kk_integer_t _x5134;
  bool _x5135 = kk_bool_unbox(_b_4044); /*bool*/
  _x5134 = kk_std_text_parse__mlift2569_pint(_x5135, _ctx); /*int*/
  return kk_integer_box(_x5134);
}


// lift anonymous function
struct kk_std_text_parse_pint_fun5137__t {
  struct kk_function_s _base;
  bool x_2812;
};
static kk_box_t kk_std_text_parse_pint_fun5137(kk_function_t _fself, kk_box_t _b_4046, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_pint_fun5137(bool x_2812, kk_context_t* _ctx) {
  struct kk_std_text_parse_pint_fun5137__t* _self = kk_function_alloc_as(struct kk_std_text_parse_pint_fun5137__t, 1, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_text_parse_pint_fun5137, kk_context());
  _self->x_2812 = x_2812;
  return &_self->_base;
}

static kk_box_t kk_std_text_parse_pint_fun5137(kk_function_t _fself, kk_box_t _b_4046, kk_context_t* _ctx) {
  struct kk_std_text_parse_pint_fun5137__t* _self = kk_function_as(struct kk_std_text_parse_pint_fun5137__t*, _fself);
  bool x_2812 = _self->x_2812; /* bool */
  kk_drop_match(_self, {;}, {}, _ctx)
  kk_integer_t _x5138;
  kk_integer_t _x5139 = kk_integer_unbox(_b_4046); /*int*/
  _x5138 = kk_std_text_parse__mlift2568_pint(x_2812, _x5139, _ctx); /*int*/
  return kk_integer_box(_x5138);
}

kk_integer_t kk_std_text_parse_pint(kk_context_t* _ctx) { /* () -> parse int */ 
  bool x_2812 = kk_std_text_parse_sign(_ctx); /*bool*/;
  if (kk_yielding(kk_context())) {
    kk_box_t _x5132 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_pint_fun5133(_ctx), _ctx); /*3991*/
    return kk_integer_unbox(_x5132);
  }
  kk_integer_t x0_2816 = kk_std_text_parse_pnat(_ctx); /*int*/;
  if (kk_yielding(kk_context())) {
    kk_integer_drop(x0_2816, _ctx);
    kk_box_t _x5136 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_pint_fun5137(x_2812, _ctx), _ctx); /*3991*/
    return kk_integer_unbox(_x5136);
  }
  if (x_2812) {
...
// lift anonymous function
struct kk_std_text_parse_pstring_fun5147__t {
  struct kk_function_s _base;
  kk_string_t s;
};
static kk_box_t kk_std_text_parse_pstring_fun5147(kk_function_t _fself, kk_box_t _b_4063, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_pstring_fun5147(kk_string_t s, kk_context_t* _ctx) {
  struct kk_std_text_parse_pstring_fun5147__t* _self = kk_function_alloc_as(struct kk_std_text_parse_pstring_fun5147__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_text_parse_pstring_fun5147, kk_context());
  _self->s = s;
  return &_self->_base;
}

static kk_box_t kk_std_text_parse_pstring_fun5147(kk_function_t _fself, kk_box_t _b_4063, kk_context_t* _ctx) {
  struct kk_std_text_parse_pstring_fun5147__t* _self = kk_function_as(struct kk_std_text_parse_pstring_fun5147__t*, _fself);
  kk_string_t s = _self->s; /* string */
  kk_drop_match(_self, {kk_string_dup(s);}, {}, _ctx)
  kk_std_core_types__maybe _x5148;
  kk_std_core_types__maybe _match_4348;
  kk_std_core__sslice _x5149 = kk_std_core__sslice_unbox(_b_4063, _ctx); /*sslice*/
  kk_std_core__list _x5150;
  kk_string_t _x5151 = kk_string_dup(s); /*string*/
  _x5150 = kk_std_core_list_4(_x5151, _ctx); /*list<char>*/
  _match_4348 = kk_std_text_parse_next_match(_x5149, _x5150, _ctx); /*maybe<sslice>*/
  if (kk_std_core_types__is_Just(_match_4348)) {
    ...
    _x5148 = kk_std_core_types__new_Just(kk_std_core_types__tuple2__box(_b_4072_4067, _ctx), _ctx); /*maybe<103>*/
    goto _match5152;
  }
  kk_string_drop(s, _ctx);
  _x5148 = kk_std_core_types__new_Nothing(_ctx); /*maybe<103>*/
  _match5152: ;
  return kk_std_core_types__maybe_box(_x5148, _ctx);
}


// lift anonymous function
struct kk_std_text_parse_pstring_fun5155__t {
  struct kk_function_s _base;
  kk_string_t s;
};
static kk_box_t kk_std_text_parse_pstring_fun5155(kk_function_t _fself, kk_box_t _b_4078, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_pstring_fun5155(kk_string_t s, kk_context_t* _ctx) {
  struct kk_std_text_parse_pstring_fun5155__t* _self = kk_function_alloc_as(struct kk_std_text_parse_pstring_fun5155__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_text_parse_pstring_fun5155, kk_context());
  _self->s = s;
  return &_self->_base;
}

static kk_box_t kk_std_text_parse_pstring_fun5155(kk_function_t _fself, kk_box_t _b_4078, kk_context_t* _ctx) {
  struct kk_std_text_parse_pstring_fun5155__t* _self = kk_function_as(struct kk_std_text_parse_pstring_fun5155__t*, _fself);
  kk_string_t s = _self->s; /* string */
  kk_drop_match(_self, {kk_string_dup(s);}, {}, _ctx)
  kk_std_core_types__maybe _x5156 = kk_std_core_types__maybe_unbox(_b_4078, _ctx); /*maybe<string>*/
  return kk_std_text_parse__mlift2547_satisfy_fail(s, _x5156, _ctx);
}
...
kk_string_t kk_std_text_parse_pstring(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> parse string */ 
  ...
  kk_std_core_hnd__ev ev_2574;
  size_t _x5140 = ((size_t)0); /*size_t*/
  ev_2574 = kk_evv_at(_x5140,kk_context()); /*std/core/hnd/ev<std/text/parse/.hnd-parse>*/
  kk_box_t _x5141;
  struct kk_std_core_hnd_Ev* _con5142 = kk_std_core_hnd__as_Ev(ev_2574);
  kk_std_core_hnd__marker m = _con5142->marker;
  kk_box_t _box_x4050 = _con5142->hnd;
  kk_std_text_parse__hnd_parse h = kk_std_text_parse__hnd_parse_unbox(_box_x4050, NULL);
  kk_std_text_parse__hnd_parse_dup(h);
  kk_std_core_hnd__clause1 _match_4347;
  struct kk_std_text_parse__Hnd_parse* _con5144 = kk_std_text_parse__as_Hnd_parse(h);
  kk_std_core_hnd__clause0 _pat00 = _con5144->fun_current_input;
  kk_std_core_hnd__clause1 _pat10 = _con5144->control_fail;
  kk_std_core_hnd__clause0 _pat20 = _con5144->control_pick;
  kk_std_core_hnd__clause1 fun_satisfy = _con5144->fun_satisfy;
  if (kk_std_text_parse__hnd_parse_is_unique(h)) {
    kk_std_core_hnd__clause0_drop(_pat20, _ctx);
    kk_std_core_hnd__clause1_drop(_pat10, _ctx);
    kk_std_core_hnd__clause0_drop(_pat00, _ctx);
  ...
  kk_box_t _x5145;
  kk_function_t _x5146;
  kk_string_dup(s);
  _x5146 = kk_std_text_parse_new_pstring_fun5147(s, _ctx); /*(4061) -> total 4062*/
  _x5145 = kk_function_box(_x5146); /*52*/
  _x5141 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x4057, (_fun_unbox_x4057, m, ev_2574, _x5145, _ctx)); /*53*/
  x_2822 = kk_std_core_types__maybe_unbox(_x5141, _ctx); /*maybe<string>*/
  if (kk_yielding(kk_context())) {
    kk_std_core_types__maybe_drop(x_2822, _ctx);
    kk_box_t _x5154 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_pstring_fun5155(s, _ctx), _ctx); /*3991*/
    return kk_string_unbox(_x5154);
  }
  if (kk_std_core_types__is_Nothing(x_2822)) {
    kk_box_t _x5157 = kk_std_text_parse_fail(s, _ctx); /*492*/
    return kk_string_unbox(_x5157);
  }
...
kk_std_core_types__maybe kk_std_text_parse_starts_with(kk_string_t s, kk_function_t p, kk_context_t* _ctx) { /* forall<a> (s : string, p : () -> parse a) -> maybe<(a, sslice)> */ 
  ...
  kk_std_core__sslice _x5159 = kk_std_core_slice(s, _ctx); /*sslice*/
  _match_4345 = kk_std_text_parse_parse(_x5159, p, _ctx); /*std/text/parse/parse-error<2282>*/
  if (kk_std_text_parse__is_ParseOk(_match_4345)) {
    struct kk_std_text_parse_ParseOk* _con5160 = kk_std_text_parse__as_ParseOk(_match_4345);
    kk_box_t x = _con5160->result;
    kk_std_core__sslice rest0 = _con5160->rest;
...
// lift anonymous function
struct kk_std_text_parse_white_fun5166__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_text_parse_white_fun5166(kk_function_t _fself, kk_box_t _b_4105, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_white_fun5166(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_text_parse_white_fun5166, _ctx)
  return kk_function_dup(_fself);
}

static kk_box_t kk_std_text_parse_white_fun5166(kk_function_t _fself, kk_box_t _b_4105, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  kk_std_core_types__maybe _x5167;
  kk_std_core_types__maybe _match_4344;
  kk_std_core__sslice _x5168 = kk_std_core__sslice_unbox(_b_4105, _ctx); /*sslice*/
  _match_4344 = kk_std_core_next(_x5168, _ctx); /*maybe<(char, sslice)>*/
  if (kk_std_core_types__is_Just(_match_4344)) {
    ...
    if (kk_std_core_types__is_dash__lp__comma__rp_(_pat01)) {
      ...
      if (kk_std_core_is_white(c, _ctx)) {
        ...
        _x5167 = kk_std_core_types__new_Just(kk_std_core_types__tuple2__box(_b_4116_4111, _ctx), _ctx); /*maybe<103>*/
        goto _match5169;
      }
    }
  }
  kk_std_core_types__maybe_drop(_match_4344, _ctx);
  _x5167 = kk_std_core_types__new_Nothing(_ctx); /*maybe<103>*/
  _match5169: ;
  return kk_std_core_types__maybe_box(_x5167, _ctx);
}


// lift anonymous function
struct kk_std_text_parse_white_fun5174__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_text_parse_white_fun5174(kk_function_t _fself, kk_box_t _b_4122, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_white_fun5174(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_text_parse_white_fun5174, _ctx)
  return kk_function_dup(_fself);
}

static kk_box_t kk_std_text_parse_white_fun5174(kk_function_t _fself, kk_box_t _b_4122, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  kk_string_t _x5175 = kk_string_empty(); /*string*/
  kk_std_core_types__maybe _x5177 = kk_std_core_types__maybe_unbox(_b_4122, _ctx); /*maybe<char>*/
  return kk_std_text_parse__mlift2547_satisfy_fail(_x5175, _x5177, _ctx);
}

kk_char_t kk_std_text_parse_white(kk_context_t* _ctx) { /* () -> parse char */ 
  kk_std_core_types__maybe x_2830;
  kk_std_core_hnd__ev ev_2574;
  size_t _x5161 = ((size_t)0); /*size_t*/
  ev_2574 = kk_evv_at(_x5161,kk_context()); /*std/core/hnd/ev<std/text/parse/.hnd-parse>*/
  kk_box_t _x5162;
  struct kk_std_core_hnd_Ev* _con5163 = kk_std_core_hnd__as_Ev(ev_2574);
  kk_std_core_hnd__marker m = _con5163->marker;
  kk_box_t _box_x4092 = _con5163->hnd;
  kk_std_text_parse__hnd_parse h = kk_std_text_parse__hnd_parse_unbox(_box_x4092, NULL);
  kk_std_text_parse__hnd_parse_dup(h);
  kk_std_core_hnd__clause1 _match_4343;
  struct kk_std_text_parse__Hnd_parse* _con5165 = kk_std_text_parse__as_Hnd_parse(h);
  kk_std_core_hnd__clause0 _pat00 = _con5165->fun_current_input;
  kk_std_core_hnd__clause1 _pat10 = _con5165->control_fail;
  kk_std_core_hnd__clause0 _pat20 = _con5165->control_pick;
  kk_std_core_hnd__clause1 fun_satisfy = _con5165->fun_satisfy;
  if (kk_std_text_parse__hnd_parse_is_unique(h)) {
    kk_std_core_hnd__clause0_drop(_pat20, _ctx);
    kk_std_core_hnd__clause1_drop(_pat10, _ctx);
    kk_std_core_hnd__clause0_drop(_pat00, _ctx);
  ...
  _x5162 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x4099, (_fun_unbox_x4099, m, ev_2574, kk_function_box(kk_std_text_parse_new_white_fun5166(_ctx)), _ctx)); /*53*/
  x_2830 = kk_std_core_types__maybe_unbox(_x5162, _ctx); /*maybe<char>*/
  if (kk_yielding(kk_context())) {
    kk_std_core_types__maybe_drop(x_2830, _ctx);
    kk_box_t _x5173 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_white_fun5174(_ctx), _ctx); /*3991*/
    return kk_char_unbox(_x5173, _ctx);
  }
  if (kk_std_core_types__is_Nothing(x_2830)) {
    kk_box_t _x5178;
    kk_string_t _x5179 = kk_string_empty(); /*string*/
    _x5178 = kk_std_text_parse_fail(_x5179, _ctx); /*492*/
    return kk_char_unbox(_x5178, _ctx);
  }
...
// lift anonymous function
struct kk_std_text_parse_whitespace_fun5187__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_text_parse_whitespace_fun5187(kk_function_t _fself, kk_box_t _b_4143, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_whitespace_fun5187(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_text_parse_whitespace_fun5187, _ctx)
  return kk_function_dup(_fself);
}
...
// lift anonymous function
struct kk_std_text_parse_whitespace_fun5191__t {
  struct kk_function_s _base;
};
static bool kk_std_text_parse_whitespace_fun5191(kk_function_t _fself, kk_char_t _x15190, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_whitespace_fun5191(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_text_parse_whitespace_fun5191, _ctx)
  return kk_function_dup(_fself);
}

static bool kk_std_text_parse_whitespace_fun5191(kk_function_t _fself, kk_char_t _x15190, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  return kk_std_core_is_white(_x15190, _ctx);
}
static kk_box_t kk_std_text_parse_whitespace_fun5187(kk_function_t _fself, kk_box_t _b_4143, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  kk_std_core_types__maybe _x5188;
  kk_std_core_types__tuple2_ _match_4341;
  kk_std_core__sslice _x5189 = kk_std_core__sslice_unbox(_b_4143, _ctx); /*sslice*/
  _match_4341 = kk_std_text_parse_next_while0(_x5189, kk_std_text_parse_new_whitespace_fun5191(_ctx), kk_std_core__new_Nil(_ctx), _ctx); /*(list<char>, sslice)*/
  ...
  if (kk_std_core__is_Nil(_pat02)) {
    ...
    _x5188 = kk_std_core_types__new_Nothing(_ctx); /*forall<a> maybe<a>*/
    goto _match5192;
  }
  ...
  _x5188 = kk_std_core_types__new_Just(kk_std_core_types__tuple2__box(_b_4155_4150, _ctx), _ctx); /*forall<a> maybe<a>*/
  _match5192: ;
  return kk_std_core_types__maybe_box(_x5188, _ctx);
}


// lift anonymous function
struct kk_std_text_parse_whitespace_fun5198__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_text_parse_whitespace_fun5198(kk_function_t _fself, kk_box_t _b_4161, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_whitespace_fun5198(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_text_parse_whitespace_fun5198, _ctx)
  return kk_function_dup(_fself);
}

static kk_box_t kk_std_text_parse_whitespace_fun5198(kk_function_t _fself, kk_box_t _b_4161, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  kk_string_t _x5199 = kk_string_empty(); /*string*/
  kk_std_core_types__maybe _x5201 = kk_std_core_types__maybe_unbox(_b_4161, _ctx); /*maybe<list<char>>*/
  return kk_std_text_parse__mlift2547_satisfy_fail(_x5199, _x5201, _ctx);
}


// lift anonymous function
struct kk_std_text_parse_whitespace_fun5207__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_text_parse_whitespace_fun5207(kk_function_t _fself, kk_box_t _b_4170, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_whitespace_fun5207(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_text_parse_whitespace_fun5207, _ctx)
  return kk_function_dup(_fself);
}
...
static kk_box_t kk_std_text_parse_whitespace_fun5207(kk_function_t _fself, kk_box_t _b_4170, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  kk_string_t _x5208;
  kk_std_core__list _x5209 = kk_std_core__list_unbox(_b_4170, _ctx); /*list<char>*/
  _x5208 = kk_std_core_string_2(_x5209, _ctx); /*string*/
  return kk_string_box(_x5208);
}
...
kk_string_t kk_std_text_parse_whitespace(kk_context_t* _ctx) { /* () -> parse string */ 
  ...
  kk_std_core_hnd__ev ev_2574;
  size_t _x5182 = ((size_t)0); /*size_t*/
  ev_2574 = kk_evv_at(_x5182,kk_context()); /*std/core/hnd/ev<std/text/parse/.hnd-parse>*/
  kk_box_t _x5183;
  struct kk_std_core_hnd_Ev* _con5184 = kk_std_core_hnd__as_Ev(ev_2574);
  kk_std_core_hnd__marker m = _con5184->marker;
  kk_box_t _box_x4130 = _con5184->hnd;
  kk_std_text_parse__hnd_parse h = kk_std_text_parse__hnd_parse_unbox(_box_x4130, NULL);
  kk_std_text_parse__hnd_parse_dup(h);
  kk_std_core_hnd__clause1 _match_4340;
  struct kk_std_text_parse__Hnd_parse* _con5186 = kk_std_text_parse__as_Hnd_parse(h);
  kk_std_core_hnd__clause0 _pat00 = _con5186->fun_current_input;
  kk_std_core_hnd__clause1 _pat10 = _con5186->control_fail;
  kk_std_core_hnd__clause0 _pat20 = _con5186->control_pick;
  kk_std_core_hnd__clause1 fun_satisfy = _con5186->fun_satisfy;
  if (kk_std_text_parse__hnd_parse_is_unique(h)) {
    kk_std_core_hnd__clause0_drop(_pat20, _ctx);
    kk_std_core_hnd__clause1_drop(_pat10, _ctx);
    kk_std_core_hnd__clause0_drop(_pat00, _ctx);
  ...
  _x5183 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x4137, (_fun_unbox_x4137, m, ev_2574, kk_function_box(kk_std_text_parse_new_whitespace_fun5187(_ctx)), _ctx)); /*53*/
  x0_2840 = kk_std_core_types__maybe_unbox(_x5183, _ctx); /*maybe<list<char>>*/
  if (kk_yielding(kk_context())) {
    kk_std_core_types__maybe_drop(x0_2840, _ctx);
    kk_box_t _x5197 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_whitespace_fun5198(_ctx), _ctx); /*3991*/
    x_2834 = kk_std_core__list_unbox(_x5197, _ctx); /*list<char>*/
  }
  else {
    if (kk_std_core_types__is_Nothing(x0_2840)) {
      kk_box_t _x5202;
      kk_string_t _x5203 = kk_string_empty(); /*string*/
      _x5202 = kk_std_text_parse_fail(_x5203, _ctx); /*492*/
      x_2834 = kk_std_core__list_unbox(_x5202, _ctx); /*list<char>*/
    }
    else {
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x5206 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_whitespace_fun5207(_ctx), _ctx); /*3991*/
    return kk_string_unbox(_x5206);
  }
...
// lift anonymous function
struct kk_std_text_parse_whitespace0_fun5210__t {
  struct kk_function_s _base;
};
static kk_string_t kk_std_text_parse_whitespace0_fun5210(kk_function_t _fself, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_whitespace0_fun5210(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_text_parse_whitespace0_fun5210, _ctx)
  return kk_function_dup(_fself);
}
...
// lift anonymous function
struct kk_std_text_parse_whitespace0_fun5216__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_text_parse_whitespace0_fun5216(kk_function_t _fself, kk_box_t _b_4185, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_whitespace0_fun5216(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_text_parse_whitespace0_fun5216, _ctx)
  return kk_function_dup(_fself);
}
...
// lift anonymous function
struct kk_std_text_parse_whitespace0_fun5220__t {
  struct kk_function_s _base;
};
static bool kk_std_text_parse_whitespace0_fun5220(kk_function_t _fself, kk_char_t _x15219, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_whitespace0_fun5220(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_text_parse_whitespace0_fun5220, _ctx)
  return kk_function_dup(_fself);
}

static bool kk_std_text_parse_whitespace0_fun5220(kk_function_t _fself, kk_char_t _x15219, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  return kk_std_core_is_white(_x15219, _ctx);
}
static kk_box_t kk_std_text_parse_whitespace0_fun5216(kk_function_t _fself, kk_box_t _b_4185, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  kk_std_core_types__maybe _x5217;
  kk_std_core_types__tuple2_ _match_4337;
  kk_std_core__sslice _x5218 = kk_std_core__sslice_unbox(_b_4185, _ctx); /*sslice*/
  _match_4337 = kk_std_text_parse_next_while0(_x5218, kk_std_text_parse_new_whitespace0_fun5220(_ctx), kk_std_core__new_Nil(_ctx), _ctx); /*(list<char>, sslice)*/
  ...
  if (kk_std_core__is_Nil(_pat021)) {
    ...
    _x5217 = kk_std_core_types__new_Nothing(_ctx); /*forall<a> maybe<a>*/
    goto _match5221;
  }
  ...
  _x5217 = kk_std_core_types__new_Just(kk_std_core_types__tuple2__box(_b_4197_4192, _ctx), _ctx); /*forall<a> maybe<a>*/
  _match5221: ;
  return kk_std_core_types__maybe_box(_x5217, _ctx);
}


// lift anonymous function
struct kk_std_text_parse_whitespace0_fun5227__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_text_parse_whitespace0_fun5227(kk_function_t _fself, kk_box_t _b_4203, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_whitespace0_fun5227(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_text_parse_whitespace0_fun5227, _ctx)
  return kk_function_dup(_fself);
}

static kk_box_t kk_std_text_parse_whitespace0_fun5227(kk_function_t _fself, kk_box_t _b_4203, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  kk_string_t _x5228 = kk_string_empty(); /*string*/
  kk_std_core_types__maybe _x5230 = kk_std_core_types__maybe_unbox(_b_4203, _ctx); /*maybe<list<char>>*/
  return kk_std_text_parse__mlift2547_satisfy_fail(_x5228, _x5230, _ctx);
}


// lift anonymous function
struct kk_std_text_parse_whitespace0_fun5236__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_text_parse_whitespace0_fun5236(kk_function_t _fself, kk_box_t _b_4212, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_whitespace0_fun5236(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_text_parse_whitespace0_fun5236, _ctx)
  return kk_function_dup(_fself);
}
...
static kk_box_t kk_std_text_parse_whitespace0_fun5236(kk_function_t _fself, kk_box_t _b_4212, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  kk_string_t _x5237;
  kk_std_core__list _x5238 = kk_std_core__list_unbox(_b_4212, _ctx); /*list<char>*/
  _x5237 = kk_std_core_string_2(_x5238, _ctx); /*string*/
  return kk_string_box(_x5237);
}
static kk_string_t kk_std_text_parse_whitespace0_fun5210(kk_function_t _fself, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  ...
  kk_std_core_hnd__ev ev_2574;
  size_t _x5211 = ((size_t)0); /*size_t*/
  ev_2574 = kk_evv_at(_x5211,kk_context()); /*std/core/hnd/ev<std/text/parse/.hnd-parse>*/
  kk_box_t _x5212;
  struct kk_std_core_hnd_Ev* _con5213 = kk_std_core_hnd__as_Ev(ev_2574);
  kk_std_core_hnd__marker m0 = _con5213->marker;
  kk_box_t _box_x4172 = _con5213->hnd;
  kk_std_text_parse__hnd_parse h0 = kk_std_text_parse__hnd_parse_unbox(_box_x4172, NULL);
  kk_std_text_parse__hnd_parse_dup(h0);
  kk_std_core_hnd__clause1 _match_4336;
  struct kk_std_text_parse__Hnd_parse* _con5215 = kk_std_text_parse__as_Hnd_parse(h0);
  kk_std_core_hnd__clause0 _pat04 = _con5215->fun_current_input;
  kk_std_core_hnd__clause1 _pat13 = _con5215->control_fail;
  kk_std_core_hnd__clause0 _pat23 = _con5215->control_pick;
  ...
  _x5212 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x4179, (_fun_unbox_x4179, m0, ev_2574, kk_function_box(kk_std_text_parse_new_whitespace0_fun5216(_ctx)), _ctx)); /*53*/
  x0_2852 = kk_std_core_types__maybe_unbox(_x5212, _ctx); /*maybe<list<char>>*/
  if (kk_yielding(kk_context())) {
    kk_std_core_types__maybe_drop(x0_2852, _ctx);
    kk_box_t _x5226 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_whitespace0_fun5227(_ctx), _ctx); /*3991*/
    x_2846 = kk_std_core__list_unbox(_x5226, _ctx); /*list<char>*/
  }
  else {
    if (kk_std_core_types__is_Nothing(x0_2852)) {
      kk_box_t _x5231;
      kk_string_t _x5232 = kk_string_empty(); /*string*/
      _x5231 = kk_std_text_parse_fail(_x5232, _ctx); /*492*/
      x_2846 = kk_std_core__list_unbox(_x5231, _ctx); /*list<char>*/
    }
    else {
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x5235 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_whitespace0_fun5236(_ctx), _ctx); /*3991*/
    return kk_string_unbox(_x5235);
  }
...
static kk_box_t kk_std_text_parse_whitespace0_fun5245(kk_function_t _fself, kk_function_t _b_4227, kk_box_t _b_4228, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_whitespace0_fun5245(size_t i_2666, kk_context_t* _ctx) {
  struct kk_std_text_parse_whitespace0_fun5245__t* _self = kk_function_alloc_as(struct kk_std_text_parse_whitespace0_fun5245__t, 1, _ctx);
...
// lift anonymous function
struct kk_std_text_parse_whitespace0_fun5247__t {
  struct kk_function_s _base;
  kk_function_t p1_2935;
};
static kk_box_t kk_std_text_parse_whitespace0_fun5247(kk_function_t _fself, kk_box_t _b_4241, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_whitespace0_fun5247(kk_function_t p1_2935, kk_context_t* _ctx) {
  struct kk_std_text_parse_whitespace0_fun5247__t* _self = kk_function_alloc_as(struct kk_std_text_parse_whitespace0_fun5247__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_text_parse_whitespace0_fun5247, kk_context());
...
static kk_function_t kk_std_text_parse_new_whitespace0_fun5248(kk_function_t p1_2935, kk_context_t* _ctx) {
  struct kk_std_text_parse_whitespace0_fun5248__t* _self = kk_function_alloc_as(struct kk_std_text_parse_whitespace0_fun5248__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_text_parse_whitespace0_fun5248, kk_context());
  _self->p1_2935 = p1_2935;
  return &_self->_base;
}

static kk_box_t kk_std_text_parse_whitespace0_fun5248(kk_function_t _fself, kk_context_t* _ctx) {
  struct kk_std_text_parse_whitespace0_fun5248__t* _self = kk_function_as(struct kk_std_text_parse_whitespace0_fun5248__t*, _fself);
  kk_function_t p1_2935 = _self->p1_2935; /* std/text/parse/parser<(<>),string> */
  kk_drop_match(_self, {kk_function_dup(p1_2935);}, {}, _ctx)
  kk_string_t _x5249 = kk_function_call(kk_string_t, (kk_function_t, kk_context_t*), p1_2935, (p1_2935, _ctx)); /*string*/
  return kk_string_box(_x5249);
}


// lift anonymous function
struct kk_std_text_parse_whitespace0_fun5250__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_text_parse_whitespace0_fun5250(kk_function_t _fself, kk_context_t* _ctx);
static kk_function_t kk_std_text_parse_new_whitespace0_fun5250(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_text_parse_whitespace0_fun5250, _ctx)
  return kk_function_dup(_fself);
}

static kk_box_t kk_std_text_parse_whitespace0_fun5250(kk_function_t _fself, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  kk_string_t _x5251 = kk_string_empty(); /*string*/
  return kk_string_box(_x5251);
}
static kk_box_t kk_std_text_parse_whitespace0_fun5247(kk_function_t _fself, kk_box_t _b_4241, kk_context_t* _ctx) {
  struct kk_std_text_parse_whitespace0_fun5247__t* _self = kk_function_as(struct kk_std_text_parse_whitespace0_fun5247__t*, _fself);
  kk_function_t p1_2935 = _self->p1_2935; /* std/text/parse/parser<(<>),string> */
  kk_drop_match(_self, {kk_function_dup(p1_2935);}, {}, _ctx)
  bool _x5253 = kk_bool_unbox(_b_4241); /*bool*/
  return kk_std_text_parse__mlift2551_op(kk_std_text_parse_new_whitespace0_fun5248(p1_2935, _ctx), kk_std_text_parse_new_whitespace0_fun5250(_ctx), _x5253, _ctx);
}

kk_string_t kk_std_text_parse_whitespace0(kk_context_t* _ctx) { /* () -> parse string */ 
  kk_function_t p1_2935 = kk_std_text_parse_new_whitespace0_fun5210(_ctx); /*std/text/parse/parser<(<>),string>*/;
  bool x_2663;
  size_t i_2666 = ((size_t)0); /*std/core/hnd/ev-index*/;
  kk_evv_t w = kk_evv_swap_create1(i_2666,kk_context()); /*std/core/hnd/evv<std/text/parse/parse>*/;
  bool y;
  kk_std_core_hnd__ev ev_2668;
  size_t _x5239 = ((size_t)0); /*size_t*/
  ev_2668 = kk_evv_at(_x5239,kk_context()); /*std/core/hnd/ev<std/text/parse/.hnd-parse>*/
  kk_box_t _x5240;
  struct kk_std_core_hnd_Ev* _con5241 = kk_std_core_hnd__as_Ev(ev_2668);
  kk_std_core_hnd__marker m = _con5241->marker;
  kk_box_t _box_x4214 = _con5241->hnd;
  kk_std_text_parse__hnd_parse h = kk_std_text_parse__hnd_parse_unbox(_box_x4214, NULL);
  kk_std_text_parse__hnd_parse_dup(h);
  kk_std_core_hnd__clause0 _match_4333;
  struct kk_std_text_parse__Hnd_parse* _con5243 = kk_std_text_parse__as_Hnd_parse(h);
  kk_std_core_hnd__clause0 _pat0 = _con5243->fun_current_input;
  kk_std_core_hnd__clause1 _pat1 = _con5243->control_fail;
  kk_std_core_hnd__clause0 control_pick = _con5243->control_pick;
  kk_std_core_hnd__clause1 _pat21 = _con5243->fun_satisfy;
  if (kk_std_text_parse__hnd_parse_is_unique(h)) {
    kk_std_core_hnd__clause1_drop(_pat21, _ctx);
    kk_std_core_hnd__clause1_drop(_pat1, _ctx);
    kk_std_core_hnd__clause0_drop(_pat0, _ctx);
  ...
  _x5240 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_context_t*), _fun_unbox_x4217, (_fun_unbox_x4217, m, ev_2668, _ctx)); /*37*/
  y = kk_bool_unbox(_x5240); /*bool*/
  kk_unit_t __ = kk_Unit;
  kk_evv_set(w,kk_context());
  if (kk_yielding(kk_context())) {
    kk_box_t _x5244 = kk_std_core_hnd_yield_cont(kk_std_text_parse_new_whitespace0_fun5245(i_2666, _ctx), _ctx); /*3820*/
    x_2663 = kk_bool_unbox(_x5244); /*bool*/
  }
  else {
    x_2663 = y; /*bool*/
  }
  if (kk_yielding(kk_context())) {
    kk_box_t _x5246 = kk_std_core_hnd_yield_extend(kk_std_text_parse_new_whitespace0_fun5247(p1_2935, _ctx), _ctx); /*3991*/
    return kk_string_unbox(_x5246);
  }
  if (x_2663) {
