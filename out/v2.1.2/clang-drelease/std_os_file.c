...
kk_string_t kk_std_os_file_read_text_file(kk_std_os_path__path path, kk_context_t* _ctx) { /* (path : std/os/path/path) -> <exn,fsys> string */ 
  ...
  _x596 = kk_std_os_path__path_box(_x597, _ctx); /*1*/
  _x592 = kk_std_core_hnd__open_none1(kk_std_os_file_new_read_text_file_fun593(_ctx), _x596, _ctx); /*2*/
  _x1 = kk_string_unbox(_x592); /*string*/
  kk_box_t _x598 = kk_std_core_hnd__open_none1(kk_std_os_file_new_read_text_file_fun599(_ctx), kk_string_box(_x1), _ctx); /*2*/
  ...
  if (kk_std_core__is_Error(_match_585)) {
    ...
    kk_string_t _x605;
    kk_box_t _x606 = kk_std_core_hnd__open_none1(kk_std_os_file_new_read_text_file_fun607(_ctx), kk_std_os_path__path_box(path, _ctx), _ctx); /*2*/
    _x605 = kk_string_unbox(_x606); /*string*/
    _x2 = kk_std_core__lp__plus__plus__1_rp_(_x603, _x605, _ctx); /*string*/
    kk_box_t _x610 = kk_std_core_hnd__open_none2(kk_std_os_file_new_read_text_file_fun611(_ctx), kk_std_core__exception_box(exn, _ctx), kk_string_box(_x2), _ctx); /*3*/
    ...
    if (kk_std_core__is_Error(err_479)) {
      ...
      kk_box_t _x615 = kk_std_core_throw_exn(exn0, _ctx); /*1*/
...
kk_unit_t kk_std_os_file__mlift476_write_text_file(kk_string_t content, kk_std_os_path__path path, kk_unit_t _c_3, kk_context_t* _ctx) { /* (content : string, path : std/os/path/path, ()) -> () */ 
  ...
  _x622 = kk_std_os_path__path_box(_x623, _ctx); /*1*/
  _x618 = kk_std_core_hnd__open_none1(kk_std_os_file__new_mlift476_write_text_file_fun619(_ctx), _x622, _ctx); /*2*/
  _x10 = kk_string_unbox(_x618); /*string*/
  kk_box_t _x624 = kk_std_core_hnd__open_none2(kk_std_os_file__new_mlift476_write_text_file_fun625(_ctx), kk_string_box(_x10), kk_string_box(content), _ctx); /*3*/
  ...
  if (kk_std_core__is_Error(_match_584)) {
    ...
    kk_string_t _x632;
    kk_box_t _x633 = kk_std_core_hnd__open_none1(kk_std_os_file__new_mlift476_write_text_file_fun634(_ctx), kk_std_os_path__path_box(path, _ctx), _ctx); /*2*/
    _x632 = kk_string_unbox(_x633); /*string*/
    _x20 = kk_std_core__lp__plus__plus__1_rp_(_x630, _x632, _ctx); /*string*/
    kk_box_t _x637 = kk_std_core_hnd__open_none2(kk_std_os_file__new_mlift476_write_text_file_fun638(_ctx), kk_std_core__exception_box(exn, _ctx), kk_string_box(_x20), _ctx); /*3*/
    ...
    if (kk_std_core__is_Error(err_480)) {
      ...
      kk_box_t _x642 = kk_std_core_throw_exn(exn0, _ctx); /*1*/
...
kk_unit_t kk_std_os_file_write_text_file(kk_std_os_path__path path, kk_string_t content, kk_std_core_types__optional create_dir, kk_context_t* _ctx) { /* (path : std/os/path/path, content : string, create-dir : optional<bool>) -> <exn,fsys> () */ 
  ...
  if (_match_583) {
    ...
    _x651 = kk_std_os_path__path_box(_x652, _ctx); /*1*/
    _x647 = kk_std_core_hnd__open_none1(kk_std_os_file_new_write_text_file_fun648(_ctx), _x651, _ctx); /*2*/
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x653 = kk_std_core_hnd_yield_extend(kk_std_os_file_new_write_text_file_fun654(content, path, _ctx), _ctx); /*2*/
  ...
  _x661 = kk_std_os_path__path_box(_x662, _ctx); /*1*/
  _x657 = kk_std_core_hnd__open_none1(kk_std_os_file_new_write_text_file_fun658(_ctx), _x661, _ctx); /*2*/
  _x10 = kk_string_unbox(_x657); /*string*/
  kk_box_t _x663 = kk_std_core_hnd__open_none2(kk_std_os_file_new_write_text_file_fun664(_ctx), kk_string_box(_x10), kk_string_box(content), _ctx); /*3*/
  ...
  if (kk_std_core__is_Error(_match_582)) {
    ...
    kk_string_t _x671;
    kk_box_t _x672 = kk_std_core_hnd__open_none1(kk_std_os_file_new_write_text_file_fun673(_ctx), kk_std_os_path__path_box(path, _ctx), _ctx); /*2*/
    _x671 = kk_string_unbox(_x672); /*string*/
    _x20 = kk_std_core__lp__plus__plus__1_rp_(_x669, _x671, _ctx); /*string*/
    kk_box_t _x676 = kk_std_core_hnd__open_none2(kk_std_os_file_new_write_text_file_fun677(_ctx), kk_std_core__exception_box(exn, _ctx), kk_string_box(_x20), _ctx); /*3*/
    ...
    if (kk_std_core__is_Error(err_485)) {
      ...
      kk_box_t _x681 = kk_std_core_throw_exn(exn0, _ctx); /*1*/
