// Koka generated module: "std/num/double", koka version: 2.1.2
...
static kk_box_t kk_std_num_double_abs_max_fun6355_1(kk_function_t _fself, kk_box_t _b_5820, kk_box_t _b_5821, kk_context_t* _ctx) {
  ...
  bool _match_6352;
  double _x6358;
  kk_box_t _x6359 = kk_box_dup(_b_5820); /*15010*/
...
double kk_std_num_double_abs_max_1(kk_std_core__list xs, kk_context_t* _ctx) { /* (xs : list<double>) -> double */ 
  kk_box_t _x6354 = kk_std_core_foldl(xs, kk_double_box(0x0p+0, _ctx), kk_std_num_double_new_abs_max_fun6355_1(_ctx), _ctx); /*15010*/
...
static kk_unit_t kk_std_num_double_sum_fun6363(kk_function_t _fself, kk_box_t _b_5849, kk_context_t* _ctx) {
  ...
  _x6365 = (kk_ref_get(_x6366,kk_context())); /*228*/
  _x6364 = kk_double_unbox(_x6365, _ctx); /*double*/
  double _x6367;
  kk_box_t _x6368 = kk_box_dup(_b_5849); /*13452*/
  ...
  _x6371 = (kk_ref_get(_x6372,kk_context())); /*228*/
  _x6370 = kk_double_unbox(_x6371, _ctx); /*double*/
  _x6369 = kk_double_abs(_x6370); /*double*/
  double _x6373;
  double _x6374;
  kk_box_t _x6375 = kk_box_dup(_b_5849); /*13452*/
  ...
  if (_match_6349) {
    ...
    _x6378 = (kk_ref_get(_x6379,kk_context())); /*228*/
    ...
    _x6384 = (kk_ref_get(_x6385,kk_context())); /*228*/
  ...
  _x6387 = (kk_ref_get(_x6388,kk_context())); /*228*/
...
double kk_std_num_double_sum(kk_std_core__list xs, kk_context_t* _ctx) { /* (xs : list<double>) -> double */ 
  ...
  kk_ref_dup(loc);
  kk_ref_dup(loc0);
  _x6362 = kk_std_num_double_new_sum_fun6363(loc, loc0, _ctx); /*(13452) -> 13453 ()*/
  kk_std_core_foreach(xs, _x6362, _ctx);
  double _x6389;
  kk_box_t _x6390;
  kk_ref_t _x6391 = kk_ref_dup(loc); /*local-var<global,double>*/
  _x6390 = (kk_ref_get(_x6391,kk_context())); /*228*/
  _x6389 = kk_double_unbox(_x6390, _ctx); /*double*/
  double _x6392;
  kk_box_t _x6393;
  kk_ref_t _x6394 = kk_ref_dup(loc0); /*local-var<global,double>*/
  _x6393 = (kk_ref_get(_x6394,kk_context())); /*228*/
  _x6392 = kk_double_unbox(_x6393, _ctx); /*double*/
  res0 = (_x6389 + _x6392); /*double*/
  kk_box_t _x6395 = kk_std_core_hnd_prompt_local_var(loc0, kk_double_box(res0, _ctx), _ctx); /*9788*/
  res = kk_double_unbox(_x6395, _ctx); /*double*/
  kk_box_t _x6396 = kk_std_core_hnd_prompt_local_var(loc, kk_double_box(res, _ctx), _ctx); /*9788*/
...
kk_std_core_types__tuple2_ kk_std_num_double_decode(double d, kk_context_t* _ctx) { /* (d : double) -> (int, int) */ 
  ...
  if (_match_6344) {
    ...
    kk_std_core_types__optional _x6414 = kk_std_core_types__new_Optional(kk_integer_box(kk_integer_from_small(-54)), _ctx); /*optional<108>*/
    return kk_std_num_double_decode_normalized(_x6413, _x6414, _ctx);
  }
  kk_std_core_types__optional _x6415 = kk_std_core_types__new_Optional(kk_integer_box(kk_integer_from_small(0)), _ctx); /*optional<108>*/
...
double kk_std_num_double_hypot_2(kk_std_core__list xs, kk_context_t* _ctx) { /* (xs : list<double>) -> double */ 
  ...
  double _x6453;
  double _x6454;
  kk_std_core__list _x6455 = kk_std_core_map_5(xs, kk_std_num_double_new_hypot_fun6456_2(hi, _ctx), _ctx); /*list<7320>*/
...
double kk_std_num_double__mlift5657_pdecdouble(kk_std_core__sslice cur, kk_integer_t exp, kk_context_t* _ctx) { /* (cur : sslice, exp : int) -> std/text/parse/parse double */ 
  ...
  kk_box_t _x6481 = kk_std_core_hnd__open_none1(kk_std_num_double__new_mlift5657_pdecdouble_fun6482(_ctx), kk_string_box(_x1), _ctx); /*3239*/
...
static kk_box_t kk_std_num_double__mlift5659_pdecdouble_fun6488(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x6492 = kk_std_core_hnd_yield_extend(kk_std_num_double__new_mlift5659_pdecdouble_fun6493(_ctx), _ctx); /*3991*/
...
double kk_std_num_double__mlift5659_pdecdouble(kk_std_core__sslice cur, kk_string_t _y_4, kk_context_t* _ctx) { /* (cur : sslice, string) -> std/text/parse/parse double */ 
  ...
  kk_integer_t x_5703;
  kk_box_t _x6487 = kk_std_text_parse_optional(kk_integer_box(kk_integer_from_small(0)), kk_std_num_double__new_mlift5659_pdecdouble_fun6488(_ctx), _ctx); /*1080*/
  x_5703 = kk_integer_unbox(_x6487); /*int*/
  if (kk_yielding(kk_context())) {
    kk_integer_drop(x_5703, _ctx);
    kk_box_t _x6496 = kk_std_core_hnd_yield_extend(kk_std_num_double__new_mlift5659_pdecdouble_fun6497(cur, _ctx), _ctx); /*3991*/
...
static kk_box_t kk_std_num_double__mlift5660_pdecdouble_fun6504(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x6506 = kk_std_core_hnd_yield_extend(kk_std_num_double__new_mlift5660_pdecdouble_fun6507(_ctx), _ctx); /*3991*/
...
double kk_std_num_double__mlift5660_pdecdouble(kk_std_core__sslice cur, kk_string_t man, kk_context_t* _ctx) { /* (cur : sslice, man : string) -> std/text/parse/parse double */ 
  ...
  _x6501 = kk_string_box(_x6502); /*1080*/
  _x6500 = kk_std_text_parse_optional(_x6501, kk_std_num_double__new_mlift5660_pdecdouble_fun6504(_ctx), _ctx); /*1080*/
  x_5707 = kk_string_unbox(_x6500); /*string*/
  if (kk_yielding(kk_context())) {
    kk_string_drop(x_5707, _ctx);
    kk_box_t _x6510 = kk_std_core_hnd_yield_extend(kk_std_num_double__new_mlift5660_pdecdouble_fun6511(cur, _ctx), _ctx); /*3991*/
...
double kk_std_num_double__mlift5661_pdecdouble(kk_std_core__sslice cur, kk_context_t* _ctx) { /* (cur : sslice) -> std/text/parse/parse double */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x6514 = kk_std_core_hnd_yield_extend(kk_std_num_double__new_mlift5661_pdecdouble_fun6515(cur, _ctx), _ctx); /*3991*/
...
static kk_box_t kk_std_num_double_pdecdouble_fun6530(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x6532 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_pdecdouble_fun6533(_ctx), _ctx); /*3991*/
...
static kk_box_t kk_std_num_double_pdecdouble_fun6543(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x6547 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_pdecdouble_fun6548(_ctx), _ctx); /*3991*/
...
double kk_std_num_double_pdecdouble(kk_context_t* _ctx) { /* () -> std/text/parse/parse double */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x6518 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_pdecdouble_fun6519(_ctx), _ctx); /*3991*/
    return kk_double_unbox(_x6518, _ctx);
  }
  kk_string_t x0_5717 = kk_std_text_parse_digits(_ctx); /*string*/;
  kk_string_drop(x0_5717, _ctx);
  if (kk_yielding(kk_context())) {
    kk_box_t _x6522 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_pdecdouble_fun6523(x_5713, _ctx), _ctx); /*3991*/
  ...
  _x6527 = kk_string_box(_x6528); /*1080*/
  _x6526 = kk_std_text_parse_optional(_x6527, kk_std_num_double_new_pdecdouble_fun6530(_ctx), _ctx); /*1080*/
  x1_5721 = kk_string_unbox(_x6526); /*string*/
  if (kk_yielding(kk_context())) {
    kk_string_drop(x1_5721, _ctx);
    kk_box_t _x6536 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_pdecdouble_fun6537(x_5713, _ctx), _ctx); /*3991*/
  ...
  kk_box_t _x6542 = kk_std_text_parse_optional(kk_integer_box(kk_integer_from_small(0)), kk_std_num_double_new_pdecdouble_fun6543(_ctx), _ctx); /*1080*/
  x3_5727 = kk_integer_unbox(_x6542); /*int*/
  kk_integer_drop(x3_5727, _ctx);
  if (kk_yielding(kk_context())) {
    kk_box_t _x6551 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_pdecdouble_fun6552(x_5713, _ctx), _ctx); /*3991*/
    return kk_double_unbox(_x6551, _ctx);
  }
  kk_string_t _x1 = kk_std_core_string_3(x_5713, _ctx); /*string*/;
  kk_box_t _x6555 = kk_std_core_hnd__open_none1(kk_std_num_double_new_pdecdouble_fun6556(_ctx), kk_string_box(_x1), _ctx); /*3239*/
...
double kk_std_num_double__mlift5663_phexdouble(kk_string_t frac, kk_string_t man, kk_integer_t exp, kk_context_t* _ctx) { /* (frac : string, man : string, exp : int) -> std/text/parse/parse double */ 
  ...
  kk_box_t _x6567 = kk_std_core_hnd__open_none2(kk_std_num_double__new_mlift5663_phexdouble_fun6568(_ctx), kk_integer_box(m0), kk_integer_box(e), _ctx); /*3333*/
...
static kk_box_t kk_std_num_double__mlift5665_phexdouble_fun6575(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x6579 = kk_std_core_hnd_yield_extend(kk_std_num_double__new_mlift5665_phexdouble_fun6580(_ctx), _ctx); /*3991*/
...
double kk_std_num_double__mlift5665_phexdouble(kk_string_t man, kk_string_t _y_13, kk_context_t* _ctx) { /* (man : string, string) -> std/text/parse/parse double */ 
  ...
  kk_integer_t x_5737;
  kk_box_t _x6574 = kk_std_text_parse_optional(kk_integer_box(kk_integer_from_small(0)), kk_std_num_double__new_mlift5665_phexdouble_fun6575(_ctx), _ctx); /*1080*/
  x_5737 = kk_integer_unbox(_x6574); /*int*/
  if (kk_yielding(kk_context())) {
    kk_integer_drop(x_5737, _ctx);
    kk_box_t _x6583 = kk_std_core_hnd_yield_extend(kk_std_num_double__new_mlift5665_phexdouble_fun6584(frac, man, _ctx), _ctx); /*3991*/
...
static kk_box_t kk_std_num_double__mlift5666_phexdouble_fun6591(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x6593 = kk_std_core_hnd_yield_extend(kk_std_num_double__new_mlift5666_phexdouble_fun6594(_ctx), _ctx); /*3991*/
...
double kk_std_num_double__mlift5666_phexdouble(kk_string_t man, kk_context_t* _ctx) { /* (man : string) -> std/text/parse/parse double */ 
  ...
  _x6588 = kk_string_box(_x6589); /*1080*/
  _x6587 = kk_std_text_parse_optional(_x6588, kk_std_num_double__new_mlift5666_phexdouble_fun6591(_ctx), _ctx); /*1080*/
  x_5741 = kk_string_unbox(_x6587); /*string*/
  if (kk_yielding(kk_context())) {
    kk_string_drop(x_5741, _ctx);
    kk_box_t _x6597 = kk_std_core_hnd_yield_extend(kk_std_num_double__new_mlift5666_phexdouble_fun6598(man, _ctx), _ctx); /*3991*/
...
double kk_std_num_double__mlift5667_phexdouble(kk_char_t wild__0, kk_context_t* _ctx) { /* (wild_0 : char) -> std/text/parse/parse double */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x6601 = kk_std_core_hnd_yield_extend(kk_std_num_double__new_mlift5667_phexdouble_fun6602(_ctx), _ctx); /*3991*/
...
double kk_std_num_double__mlift5668_phexdouble(kk_char_t wild__, kk_context_t* _ctx) { /* (wild_ : char) -> std/text/parse/parse double */ 
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x6607 = kk_std_core_hnd_yield_extend(kk_std_num_double__new_mlift5668_phexdouble_fun6608(_ctx), _ctx); /*3991*/
...
static kk_box_t kk_std_num_double_phexdouble_fun6629(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x6631 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_phexdouble_fun6632(_ctx), _ctx); /*3991*/
...
static kk_box_t kk_std_num_double_phexdouble_fun6642(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x6646 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_phexdouble_fun6647(_ctx), _ctx); /*3991*/
...
double kk_std_num_double_phexdouble(kk_context_t* _ctx) { /* () -> std/text/parse/parse double */ 
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x6611 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_phexdouble_fun6612(_ctx), _ctx); /*3991*/
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x6617 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_phexdouble_fun6618(_ctx), _ctx); /*3991*/
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x6621 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_phexdouble_fun6622(_ctx), _ctx); /*3991*/
  ...
  _x6626 = kk_string_box(_x6627); /*1080*/
  _x6625 = kk_std_text_parse_optional(_x6626, kk_std_num_double_new_phexdouble_fun6629(_ctx), _ctx); /*1080*/
  x2_5761 = kk_string_unbox(_x6625); /*string*/
  if (kk_yielding(kk_context())) {
    kk_string_drop(x2_5761, _ctx);
    kk_box_t _x6635 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_phexdouble_fun6636(x1_5757, _ctx), _ctx); /*3991*/
  ...
  kk_box_t _x6641 = kk_std_text_parse_optional(kk_integer_box(kk_integer_from_small(0)), kk_std_num_double_new_phexdouble_fun6642(_ctx), _ctx); /*1080*/
  x4_5767 = kk_integer_unbox(_x6641); /*int*/
  if (kk_yielding(kk_context())) {
    kk_integer_drop(x4_5767, _ctx);
    kk_box_t _x6650 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_phexdouble_fun6651(frac, x1_5757, _ctx), _ctx); /*3991*/
  ...
  kk_box_t _x6662 = kk_std_core_hnd__open_none2(kk_std_num_double_new_phexdouble_fun6663(_ctx), kk_integer_box(m0), kk_integer_box(e), _ctx); /*3333*/
...
static kk_box_t kk_std_num_double_pspecial_fun6667(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x6671 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_pspecial_fun6672(_ctx), _ctx); /*3991*/
...
static kk_box_t kk_std_num_double_pspecial_fun6675(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x6679 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_pspecial_fun6680(_ctx), _ctx); /*3991*/
...
static kk_box_t kk_std_num_double_pspecial_fun6683(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x6687 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_pspecial_fun6688(_ctx), _ctx); /*3991*/
...
double kk_std_num_double_pspecial(kk_context_t* _ctx) { /* () -> std/text/parse/parse double */ 
  ...
  kk_box_t _x6691 = kk_std_text_parse_choose(_b_6063_6062, _ctx); /*808*/
...
static kk_box_t kk_std_num_double__mlift5673_pdouble_fun6695(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_string_drop(x1_5781, _ctx);
    kk_box_t _x6699 = kk_std_core_hnd_yield_extend(kk_std_num_double__new_mlift5673_pdouble_fun6700(_ctx), _ctx); /*3991*/
...
static kk_box_t kk_std_num_double__mlift5673_pdouble_fun6703(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_string_drop(x0_5779, _ctx);
    kk_box_t _x6707 = kk_std_core_hnd_yield_extend(kk_std_num_double__new_mlift5673_pdouble_fun6708(_ctx), _ctx); /*3991*/
...
static kk_box_t kk_std_num_double__mlift5673_pdouble_fun6711(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_string_drop(x_5777, _ctx);
    kk_box_t _x6715 = kk_std_core_hnd_yield_extend(kk_std_num_double__new_mlift5673_pdouble_fun6716(_ctx), _ctx); /*3991*/
...
static kk_box_t kk_std_num_double__mlift5673_pdouble_fun6693(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_box_t _x6719 = kk_std_text_parse_choose(_b_6111_6088, _ctx); /*808*/
...
double kk_std_num_double__mlift5673_pdouble(bool neg, kk_context_t* _ctx) { /* (neg : bool) -> std/text/parse/parse double */ 
  ...
  kk_box_t _x6724 = kk_std_text_parse_choose(_b_6102_6101, _ctx); /*808*/
  x_5783 = kk_double_unbox(_x6724, _ctx); /*double*/
  if (kk_yielding(kk_context())) {
    kk_box_t _x6725 = kk_std_core_hnd_yield_extend(kk_std_num_double__new_mlift5673_pdouble_fun6726(neg, _ctx), _ctx); /*3991*/
...
static kk_box_t kk_std_num_double_pdouble_fun6736(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_string_drop(x1_5781, _ctx);
    kk_box_t _x6740 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_pdouble_fun6741(_ctx), _ctx); /*3991*/
...
static kk_box_t kk_std_num_double_pdouble_fun6744(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_string_drop(x0_5779, _ctx);
    kk_box_t _x6748 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_pdouble_fun6749(_ctx), _ctx); /*3991*/
...
static kk_box_t kk_std_num_double_pdouble_fun6752(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_string_drop(x_5777, _ctx);
    kk_box_t _x6756 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_pdouble_fun6757(_ctx), _ctx); /*3991*/
...
static kk_box_t kk_std_num_double_pdouble_fun6734(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_box_t _x6760 = kk_std_text_parse_choose(_b_6165_6142, _ctx); /*808*/
...
double kk_std_num_double_pdouble(kk_context_t* _ctx) { /* () -> std/text/parse/parse double */ 
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x6729 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_pdouble_fun6730(_ctx), _ctx); /*3991*/
  ...
  kk_box_t _x6765 = kk_std_text_parse_choose(_b_6156_6155, _ctx); /*808*/
  x0_5789 = kk_double_unbox(_x6765, _ctx); /*double*/
  if (kk_yielding(kk_context())) {
    kk_box_t _x6766 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_pdouble_fun6767(x_5785, _ctx), _ctx); /*3991*/
...
static kk_box_t kk_std_num_double_parse_double_fun6783(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_string_drop(x1_5781, _ctx);
    kk_box_t _x6787 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_parse_double_fun6788(_ctx), _ctx); /*3991*/
...
static kk_box_t kk_std_num_double_parse_double_fun6791(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_string_drop(x0_5779, _ctx);
    kk_box_t _x6795 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_parse_double_fun6796(_ctx), _ctx); /*3991*/
...
static kk_box_t kk_std_num_double_parse_double_fun6799(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_string_drop(x_5777, _ctx);
    kk_box_t _x6803 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_parse_double_fun6804(_ctx), _ctx); /*3991*/
...
static kk_box_t kk_std_num_double_parse_double_fun6781(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_box_t _x6807 = kk_std_text_parse_choose(_b_6220_6197, _ctx); /*808*/
...
static kk_box_t kk_std_num_double_parse_double_fun6774(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x6776 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_parse_double_fun6777(_ctx), _ctx); /*3991*/
    ...
    kk_box_t _x6812 = kk_std_text_parse_choose(_b_6211_6210, _ctx); /*808*/
    x2_5801 = kk_double_unbox(_x6812, _ctx); /*double*/
    if (kk_yielding(kk_context())) {
      kk_box_t _x6813 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_parse_double_fun6814(x1_5797, _ctx), _ctx); /*3991*/
  ...
  kk_box_t _x6817;
  if (kk_yielding(kk_context())) {
    _x6817 = kk_std_core_hnd_yield_extend(kk_std_num_double_new_parse_double_fun6819(_ctx), _ctx); /*3991*/
  }
  else {
    _x6817 = kk_std_text_parse__mlift2565_parse_eof(kk_double_box(x_2790, _ctx), _ctx); /*3991*/
  }
...
kk_string_t kk_std_num_double_show_hex(double d, kk_std_core_types__optional width, kk_std_core_types__optional use_capitals, kk_std_core_types__optional pre, kk_context_t* _ctx) { /* (d : double, width : optional<int>, use-capitals : optional<bool>, pre : optional<string>) -> string */ 
  ...
  kk_std_core_types__optional _x6830 = kk_std_core_types__new_Optional(kk_integer_box(kk_integer_from_small(1)), _ctx); /*optional<108>*/
  ...
  _x6833 = true; /*bool*/
  _match6834: ;
  _x6832 = kk_bool_box(_x6833); /*108*/
  _x6831 = kk_std_core_types__new_Optional(_x6832, _ctx); /*optional<108>*/
  kk_std_core_types__optional _x6836;
  kk_box_t _x6837;
  kk_string_t _x6838 = kk_string_empty(); /*string*/
  _x6837 = kk_string_box(_x6838); /*108*/
  _x6836 = kk_std_core_types__new_Optional(_x6837, _ctx); /*optional<108>*/
