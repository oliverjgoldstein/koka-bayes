// Koka generated module: "std/num/int32", koka version: 2.1.2
...
kk_string_t kk_std_num_int32_show_hex(int32_t i, kk_std_core_types__optional width, kk_std_core_types__optional use_capitals, kk_std_core_types__optional pre, kk_context_t* _ctx) { /* (i : int32, width : optional<int>, use-capitals : optional<bool>, pre : optional<string>) -> string */ 
  ...
  _match2126: ;
  _x2124 = kk_integer_box(_x2125); /*108*/
  _x2123 = kk_std_core_types__new_Optional(_x2124, _ctx); /*optional<108>*/
  ...
  _x2130 = true; /*bool*/
  _match2131: ;
  _x2129 = kk_bool_box(_x2130); /*108*/
  _x2128 = kk_std_core_types__new_Optional(_x2129, _ctx); /*optional<108>*/
  ...
  _match2136: ;
  _x2134 = kk_string_box(_x2135); /*108*/
  _x2133 = kk_std_core_types__new_Optional(_x2134, _ctx); /*optional<108>*/
...
int32_t kk_std_num_int32_abs(int32_t i, kk_context_t* _ctx) { /* (i : int32) -> exn int32 */ 
  ...
  if (_match_2106) {
    kk_box_t _x2144 = kk_std_core_hnd__open_none1(kk_std_num_int32_new_abs_fun2145(_ctx), kk_int32_box(i, _ctx), _ctx); /*3239*/
  ...
  kk_std_core_types__optional _x2151 = kk_std_core_types__new_None(_ctx); /*forall<a> optional<a>*/
  if (kk_std_core_types__is_Optional(_x2151)) {
    kk_box_t _box_x2055 = _x2151._cons.Optional.value;
  ...
  _match2152: ;
  exn_21565 = kk_std_core__new_Exception(_x2148, _x2150, _ctx); /*exception*/
  kk_std_core_hnd__ev ev_21566;
  size_t _x2154 = ((size_t)0); /*size_t*/
  ev_21566 = kk_evv_at(_x2154,kk_context()); /*std/core/hnd/ev<.hnd-exn>*/
  kk_box_t _x2155;
  struct kk_std_core_hnd_Ev* _con2156 = kk_std_core_hnd__as_Ev(ev_21566);
  kk_std_core_hnd__marker m = _con2156->marker;
  kk_box_t _box_x2056 = _con2156->hnd;
  ...
  struct kk_std_core__Hnd_exn* _con2158 = kk_std_core__as_Hnd_exn(h);
  kk_std_core_hnd__clause1 except_throw_exn = _con2158->except_throw_exn;
  ...
  _match_2107 = except_throw_exn; /*forall<a> std/core/hnd/clause1<exception,a,.hnd-exn,3528,3529>*/
  kk_function_t _fun_unbox_x2060 = _match_2107.clause;
  _x2155 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x2060, (_fun_unbox_x2060, m, ev_21566, kk_std_core__exception_box(exn_21565, _ctx), _ctx)); /*53*/
  return kk_int32_unbox(_x2155, _ctx);
}
...
int32_t kk_std_num_int32_abs0(int32_t i, kk_context_t* _ctx) { /* (i : int32) -> int32 */ 
  bool _match_2103;
  bool _x2159 = (i)<0; /*bool*/
  _match_2103 = !(_x2159); /*bool*/
  if (_match_2103) {
    return i;
  }
  bool _match_2104;
  int32_t _x2160;
  kk_integer_t _x2161 = kk_integer_neg((kk_integer_from_str("2147483648", _ctx)),kk_context()); /*int*/
  _x2160 = kk_std_core_int32(_x2161, _ctx); /*int32*/
  _match_2104 = (i > _x2160); /*bool*/
  if (_match_2104) {
...
kk_std_core_types__tuple2_ kk_std_num_int32_divmod(int32_t x, int32_t y, kk_context_t* _ctx) { /* (x : int32, y : int32) -> (int32, int32) */ 
  ...
  int32_t r = (x % y); /*int32*/;
  bool _match_2101;
  bool _x2162 = (r)<0; /*bool*/
  _match_2101 = !(_x2162); /*bool*/
  if (_match_2101) {
...
kk_box_t kk_std_num_int32_fold_int32(int32_t start, int32_t end, kk_box_t init, kk_function_t f, kk_context_t* _ctx) { /* forall<a> (start : int32, end : int32, init : a, f : (int32, a) -> a) -> a */ 
  ...
  kk_box_t x;
  kk_function_t _x2163 = kk_function_dup(f); /*(int32, 1536) -> 1536*/
  x = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_box_t, kk_context_t*), _x2163, (_x2163, start, init, _ctx)); /*1536*/
  { // tailcall
    int32_t _x2164 = kk_std_num_int32_inc(start, _ctx); /*int32*/
    start = _x2164;
    init = x;
    goto kk__tailcall;
  }
...
int32_t kk_std_num_int32_rotl(int32_t i, int32_t n, kk_context_t* _ctx) { /* (i : int32, n : int32) -> int32 */ 
  ...
  _x2167 = (i0_2041 - (((int32_t)1))); /*int32*/
  r = (n & _x2167); /*int32*/
  int32_t _x2168 = (i << r); /*int32*/
  int32_t _x2169;
  int32_t _x2170 = ((((int32_t)32)) - r); /*int32*/
  _x2169 = ((int32_t)((uint32_t)i >> _x2170)); /*int32*/
  return (_x2168 | _x2169);
}
...
int32_t kk_std_num_int32_rotr(int32_t i, int32_t n, kk_context_t* _ctx) { /* (i : int32, n : int32) -> int32 */ 
  ...
  _x2171 = (i0_2042 - (((int32_t)1))); /*int32*/
  r = (n & _x2171); /*int32*/
  int32_t _x2172 = ((int32_t)((uint32_t)i >> r)); /*int32*/
  int32_t _x2173;
  int32_t _x2174 = ((((int32_t)32)) - r); /*int32*/
  _x2173 = (i << _x2174); /*int32*/
  return (_x2172 | _x2173);
}
...
kk_string_t kk_std_num_int32_show_hex32(int32_t i, kk_std_core_types__optional width, kk_std_core_types__optional use_capitals, kk_std_core_types__optional pre, kk_context_t* _ctx) { /* (i : int32, width : optional<int>, use-capitals : optional<bool>, pre : optional<string>) -> string */ 
  kk_integer_t _x2176 = kk_std_num_int32_uint(i, _ctx); /*int*/
  kk_std_core_types__optional _x2177;
  kk_box_t _x2178;
  kk_integer_t _x2179;
  if (kk_std_core_types__is_Optional(width)) {
    kk_box_t _box_x2085 = width._cons.Optional.value;
    kk_integer_t _width_1913 = kk_integer_unbox(_box_x2085);
    _x2179 = _width_1913; /*int*/
    goto _match2180;
  }
  _x2179 = kk_integer_from_small(8); /*int*/
  _match2180: ;
  _x2178 = kk_integer_box(_x2179); /*108*/
  _x2177 = kk_std_core_types__new_Optional(_x2178, _ctx); /*optional<108>*/
  kk_std_core_types__optional _x2182;
  kk_box_t _x2183;
  bool _x2184;
  if (kk_std_core_types__is_Optional(use_capitals)) {
    kk_box_t _box_x2087 = use_capitals._cons.Optional.value;
    bool _use_capitals_1917 = kk_bool_unbox(_box_x2087);
    _x2184 = _use_capitals_1917; /*bool*/
    goto _match2185;
  }
  _x2184 = true; /*bool*/
  _match2185: ;
  _x2183 = kk_bool_box(_x2184); /*108*/
  _x2182 = kk_std_core_types__new_Optional(_x2183, _ctx); /*optional<108>*/
  kk_std_core_types__optional _x2187;
  kk_box_t _x2188;
  kk_string_t _x2189;
  if (kk_std_core_types__is_Optional(pre)) {
    kk_box_t _box_x2089 = pre._cons.Optional.value;
    kk_string_t _pre_1921 = kk_string_unbox(_box_x2089);
    _x2189 = _pre_1921; /*string*/
    goto _match2190;
  }
  kk_define_string_literal(, _s2192, 2, "0x")
  _x2189 = kk_string_dup(_s2192); /*string*/
  _match2190: ;
  _x2188 = kk_string_box(_x2189); /*108*/
  _x2187 = kk_std_core_types__new_Optional(_x2188, _ctx); /*optional<108>*/
  return kk_std_core_show_hex(_x2176, _x2177, _x2182, _x2187, _ctx);
}
