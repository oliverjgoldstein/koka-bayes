...
static inline kk_std_os_path__path kk_std_os_path__path_unbox(kk_box_t _x, kk_context_t* _ctx) {
  ...
  else { kk_std_os_path__path_dup(_unbox); }
  return _unbox;
}
...
static inline kk_std_core__list kk_std_os_path_dirparts(kk_std_os_path__path p, kk_context_t* _ctx) { /* (p : path) -> list<string> */ 
  ...
  _x3365 = _x; /*list<string>*/
  return kk_std_core__lift21047_reverse_append(kk_std_core__new_Nil(_ctx), _x3365, _ctx);
}
...
static inline kk_std_os_path__path kk_std_os_path__lp__bar__bar__rp_(kk_std_os_path__path p1, kk_std_os_path__path p2, kk_context_t* _ctx) { /* (p1 : path, p2 : path) -> path */ 
  bool _match_3317;
  kk_std_os_path__path _x3385 = kk_std_os_path__path_dup(p1); /*std/os/path/path*/
  _match_3317 = kk_std_os_path_is_empty(_x3385, _ctx); /*bool*/
  if (_match_3317) {
...
static inline kk_std_os_path__path kk_std_os_path__create_Path(kk_std_core_types__optional root0, kk_std_core_types__optional parts0, kk_context_t* _ctx) { /* (root : optional<string>, parts : optional<list<string>>) -> path */ 
  ...
  if (kk_std_core_types__is_Optional(root0)) {
    kk_box_t _box_x2976 = root0._cons.Optional.value;
    kk_string_t _root_1093 = kk_string_unbox(_box_x2976);
    _x3463 = _root_1093; /*string*/
    goto _match3464;
  }
  _x3463 = kk_string_empty(); /*string*/
  _match3464: ;
  kk_std_core__list _x3467;
  if (kk_std_core_types__is_Optional(parts0)) {
    kk_box_t _box_x2977 = parts0._cons.Optional.value;
    kk_std_core__list _parts_1098 = kk_std_core__list_unbox(_box_x2977, NULL);
    _x3467 = _parts_1098; /*list<string>*/
    goto _match3468;
  }
  _x3467 = kk_std_core__new_Nil(_ctx); /*list<string>*/
  _match3468: ;
  return kk_std_os_path__new_Path(_x3463, _x3467, _ctx);
}
...
static inline kk_std_os_path__path kk_std_os_path_path_parts(kk_string_t root0, kk_string_t s, kk_std_core_types__optional dirs, kk_context_t* _ctx) { /* (root : string, s : string, dirs : optional<list<string>>) -> path */ 
  ...
  kk_std_core__list _x3470;
  kk_vector_t v_21693;
  kk_string_t _x3471;
  kk_define_string_literal(, _s3472, 1, "/")
  _x3471 = kk_string_dup(_s3472); /*string*/
  v_21693 = kk_string_splitv(s,_x3471,kk_context()); /*vector<string>*/
  _x3470 = kk_std_core_vlist(v_21693, kk_std_core_types__new_None(_ctx), _ctx); /*list<2154>*/
  kk_std_core__list _x3473;
  if (kk_std_core_types__is_Optional(dirs)) {
    kk_box_t _box_x2978 = dirs._cons.Optional.value;
    kk_std_core__list _dirs_1291 = kk_std_core__list_unbox(_box_x2978, NULL);
    _x3473 = _dirs_1291; /*list<string>*/
    goto _match3474;
  }
  _x3473 = kk_std_core__new_Nil(_ctx); /*list<string>*/
  _match3474: ;
  parts0 = kk_std_os_path_push_parts(_x3470, _x3473, _ctx); /*list<string>*/
...
static inline bool kk_std_os_path_is_relative(kk_std_os_path__path p, kk_context_t* _ctx) { /* (p : path) -> bool */ 
  ...
  kk_std_os_path__path_drop(p, _ctx);
  _x3769 = _x; /*string*/
  kk_string_t _x3770 = kk_string_empty(); /*string*/
  return kk_string_is_eq(_x3769,_x3770,kk_context());
}
 
// Is a path absolute?

static inline bool kk_std_os_path_is_absolute(kk_std_os_path__path p, kk_context_t* _ctx) { /* (p : path) -> bool */ 
  bool _x3772 = kk_std_os_path_is_relative(p, _ctx); /*bool*/
  return !(_x3772);
}
...
static inline kk_std_os_path__path kk_std_os_path_noext(kk_std_os_path__path p, kk_context_t* _ctx) { /* (p : path) -> path */ 
  kk_string_t _x3773 = kk_string_empty(); /*string*/
  return kk_std_os_path_change_ext(p, _x3773, _ctx);
}
...
static inline kk_std_core__list kk_std_os_path_paths(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> list<path> */ 
  kk_std_core__list _x3803;
  kk_string_t s0_2890;
  kk_string_t _x3804;
  kk_define_string_literal(, _s3805, 1, ";")
  _x3804 = kk_string_dup(_s3805); /*string*/
  kk_string_t _x3806;
  kk_define_string_literal(, _s3807, 1, ":")
  _x3806 = kk_string_dup(_s3807); /*string*/
  s0_2890 = kk_string_replace_all(s,_x3804,_x3806,kk_context()); /*string*/
  kk_vector_t v_21693;
  kk_string_t _x3808;
  kk_define_string_literal(, _s3809, 1, ":")
  _x3808 = kk_string_dup(_s3809); /*string*/
  v_21693 = kk_string_splitv(s0_2890,_x3808,kk_context()); /*vector<string>*/
  _x3803 = kk_std_core_vlist(v_21693, kk_std_core_types__new_None(_ctx), _ctx); /*list<2154>*/
  return kk_std_os_path_paths_collect(_x3803, _ctx);
}
