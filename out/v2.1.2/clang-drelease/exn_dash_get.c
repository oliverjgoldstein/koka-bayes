...
kk_box_t kk_exn_dash_get_exn_get(kk_std_core__list xs, kk_integer_t index, kk_context_t* _ctx) { /* forall<a> (xs : list<a>, index : int) -> exn a */ 
  ...
  if (kk_std_core_types__is_Nothing(_match_222)) {
    ...
    kk_std_core_types__optional _x230 = kk_std_core_types__new_None(_ctx); /*forall<a> optional<a>*/
    if (kk_std_core_types__is_Optional(_x230)) {
      kk_box_t _box_x207 = _x230._cons.Optional.value;
    ...
    _match231: ;
    exn_21565 = kk_std_core__new_Exception(message_205, _x229, _ctx); /*exception*/
    kk_std_core_hnd__ev ev_21566;
    size_t _x233 = ((size_t)0); /*size_t*/
    ev_21566 = kk_evv_at(_x233,kk_context()); /*std/core/hnd/ev<.hnd-exn>*/
    struct kk_std_core_hnd_Ev* _con234 = kk_std_core_hnd__as_Ev(ev_21566);
    kk_std_core_hnd__marker m = _con234->marker;
    kk_box_t _box_x208 = _con234->hnd;
    ...
    struct kk_std_core__Hnd_exn* _con236 = kk_std_core__as_Hnd_exn(h);
    kk_std_core_hnd__clause1 except_throw_exn = _con236->except_throw_exn;
    ...
    return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x212, (_fun_unbox_x212, m, ev_21566, kk_std_core__exception_box(exn_21565, _ctx), _ctx));
  }
