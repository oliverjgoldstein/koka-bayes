...
static inline kk_std_time_duration__duration kk_std_time_duration__lp__plus__rp_(kk_std_time_duration__duration d, kk_std_time_duration__duration e, kk_context_t* _ctx) { /* (d : duration, e : duration) -> duration */ 
  ...
  kk_std_num_ddouble__ddouble _x = d.secs;
  _x2486 = _x; /*std/time/timestamp/timespan*/
  kk_std_num_ddouble__ddouble _x2487;
  kk_std_num_ddouble__ddouble _x0 = e.secs;
  _x2487 = _x0; /*std/time/timestamp/timespan*/
  _x2485 = kk_std_num_ddouble__lp__plus__rp_(_x2486, _x2487, _ctx); /*std/num/ddouble/ddouble*/
  return kk_std_time_duration__new_Duration(_x2485, _ctx);
}
...
static inline kk_std_time_duration__duration kk_std_time_duration__lp__tilde__rp_(kk_std_time_duration__duration d, kk_context_t* _ctx) { /* (d : duration) -> duration */ 
  kk_std_num_ddouble__ddouble _x2488;
  double _x2489;
  double _x2490;
  ...
  _x2492 = _x0; /*double*/
  _x2491 = (-_x2492); /*double*/
  _x2488 = kk_std_num_ddouble__new_Ddouble(_x2489, _x2491, _ctx); /*std/num/ddouble/ddouble*/
  return kk_std_time_duration__new_Duration(_x2488, _ctx);
}
...
static inline kk_std_time_duration__duration kk_std_time_duration__lp__dash__rp_(kk_std_time_duration__duration d, kk_std_time_duration__duration e, kk_context_t* _ctx) { /* (d : duration, e : duration) -> duration */ 
  ...
  kk_std_num_ddouble__ddouble _x = d.secs;
  _x2494 = _x; /*std/time/timestamp/timespan*/
  kk_std_num_ddouble__ddouble _x2495;
  kk_std_num_ddouble__ddouble _x0 = e0_2276.secs;
  _x2495 = _x0; /*std/time/timestamp/timespan*/
  _x2493 = kk_std_num_ddouble__lp__plus__rp_(_x2494, _x2495, _ctx); /*std/num/ddouble/ddouble*/
  return kk_std_time_duration__new_Duration(_x2493, _ctx);
}
...
static inline double kk_std_time_duration_fraction(kk_std_time_duration__duration d, kk_context_t* _ctx) { /* (d : duration) -> double */ 
  ...
  kk_std_num_ddouble__ddouble _x2531;
  kk_std_num_ddouble__ddouble _x0 = d.secs;
  _x2531 = _x0; /*std/time/timestamp/timespan*/
  y_21009 = kk_std_num_ddouble_truncate(_x2531, _ctx); /*std/num/ddouble/ddouble*/
  kk_std_num_ddouble__ddouble _x2532;
  kk_std_num_ddouble__ddouble _x00 = d.secs;
  _x2532 = _x00; /*std/time/timestamp/timespan*/
  kk_std_num_ddouble__ddouble _x2533 = kk_std_num_ddouble__lp__tilde__rp_(y_21009, _ctx); /*std/num/ddouble/ddouble*/
  x_2293 = kk_std_num_ddouble__lp__plus__rp_(_x2532, _x2533, _ctx); /*std/num/ddouble/ddouble*/
  double _x = x_2293.hi;
  return _x;
}
...
static inline kk_std_time_timestamp__timestamp kk_std_time_duration_timestamp(kk_std_time_duration__duration d, kk_context_t* _ctx) { /* (d : duration) -> std/time/timestamp/timestamp */ 
  kk_std_num_ddouble__ddouble _x2623;
  kk_std_num_ddouble__ddouble _x = d.secs;
  _x2623 = _x; /*std/time/timestamp/timespan*/
  int32_t _x2624;
  kk_integer_t _x2625;
  kk_std_core_types__optional _x2626 = kk_std_core_types__new_None(_ctx); /*forall<a> optional<a>*/
  if (kk_std_core_types__is_Optional(_x2626)) {
    kk_box_t _box_x2378 = _x2626._cons.Optional.value;
    kk_integer_t _leap_492 = kk_integer_unbox(_box_x2378);
    _x2625 = _leap_492; /*int*/
    goto _match2627;
  }
  _x2625 = kk_integer_from_small(0); /*int*/
  _match2627: ;
  _x2624 = kk_std_core_int32(_x2625, _ctx); /*int32*/
  return kk_std_time_timestamp__new_Timestamp(_x2623, _x2624, _ctx);
}
...
static inline kk_integer_t kk_std_time_duration_truncate(kk_std_time_duration__duration d, kk_context_t* _ctx) { /* (d : duration) -> int */ 
  kk_std_num_ddouble__ddouble _x2629;
  bool _match_2393;
  kk_std_num_ddouble__ddouble _x2630;
  kk_std_num_ddouble__ddouble _x = d.secs;
  _x2630 = _x; /*std/time/timestamp/timespan*/
  _match_2393 = kk_std_num_ddouble_is_neg(_x2630, _ctx); /*bool*/
  if (_match_2393) {
    kk_std_num_ddouble__ddouble _x2631;
    kk_std_num_ddouble__ddouble _x0 = d.secs;
    _x2631 = _x0; /*std/time/timestamp/timespan*/
    _x2629 = kk_std_num_ddouble_ceiling(_x2631, _ctx); /*std/num/ddouble/ddouble*/
  }
  else {
    kk_std_num_ddouble__ddouble _x2632;
    kk_std_num_ddouble__ddouble _x1 = d.secs;
    _x2632 = _x1; /*std/time/timestamp/timespan*/
    _x2629 = kk_std_num_ddouble_floor(_x2632, _ctx); /*std/num/ddouble/ddouble*/
  }
  return kk_std_num_ddouble_int(_x2629, kk_std_core_types__new_None(_ctx), _ctx);
}
...
static inline kk_std_time_duration__duration kk_std_time_duration_unsafe_duration(kk_std_time_timestamp__timestamp t, kk_context_t* _ctx) { /* (t : std/time/timestamp/timestamp) -> duration */ 
  kk_std_num_ddouble__ddouble _x2633 = kk_std_time_timestamp_unsafe_timespan_withleap(t, _ctx); /*std/time/timestamp/timespan*/
  return kk_std_time_duration__new_Duration(_x2633, _ctx);
}
