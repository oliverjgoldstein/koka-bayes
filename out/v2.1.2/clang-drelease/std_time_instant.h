...
static inline kk_std_time_instant__timescale kk_std_time_instant__create_Timescale(kk_string_t name0, kk_string_t unit0, kk_function_t from_tai0, kk_function_t to_tai0, kk_std_core_types__optional mb_seconds_in_day0, kk_std_core_types__optional mb_to_mjd20000, kk_std_core_types__optional mb_from_mjd20000, kk_context_t* _ctx) { /* (name : string, unit : string, from-tai : (std/time/duration/duration) -> std/time/timestamp/timestamp, to-tai : (std/time/timestamp/timestamp) -> std/time/duration/duration, mb-seconds-in-day : optional<maybe<(t : std/time/timestamp/timestamp) -> std/time/timestamp/timespan>>, mb-to-mjd2000 : optional<maybe<(t : std/time/timestamp/timestamp, tzdelta : std/time/timestamp/timespan) -> std/num/ddouble/ddouble>>, mb-from-mjd2000 : optional<maybe<(days : int, frac : std/num/ddouble/ddouble) -> std/time/timestamp/timestamp>>) -> timescale */ 
  kk_std_core_types__maybe _x5408;
  if (kk_std_core_types__is_Optional(mb_seconds_in_day0)) {
    ...
    _x5408 = _mb_seconds_in_day_410; /*maybe<(t : std/time/timestamp/timestamp) -> std/time/timestamp/timespan>*/
    goto _match5409;
  }
  _x5408 = kk_std_core_types__new_Nothing(_ctx); /*maybe<(t : std/time/timestamp/timestamp) -> std/time/timestamp/timespan>*/
  _match5409: ;
  kk_std_core_types__maybe _x5411;
  if (kk_std_core_types__is_Optional(mb_to_mjd20000)) {
    ...
    _x5411 = _mb_to_mjd2000_415; /*maybe<(t : std/time/timestamp/timestamp, tzdelta : std/time/timestamp/timespan) -> std/num/ddouble/ddouble>*/
    goto _match5412;
  }
  _x5411 = kk_std_core_types__new_Nothing(_ctx); /*maybe<(t : std/time/timestamp/timestamp, tzdelta : std/time/timestamp/timespan) -> std/num/ddouble/ddouble>*/
  _match5412: ;
  kk_std_core_types__maybe _x5414;
  if (kk_std_core_types__is_Optional(mb_from_mjd20000)) {
    ...
    _x5414 = _mb_from_mjd2000_420; /*maybe<(days : int, frac : std/num/ddouble/ddouble) -> std/time/timestamp/timestamp>*/
    goto _match5415;
  }
  _x5414 = kk_std_core_types__new_Nothing(_ctx); /*maybe<(days : int, frac : std/num/ddouble/ddouble) -> std/time/timestamp/timestamp>*/
  _match5415: ;
  return kk_std_time_instant__new_Timescale(kk_reuse_null, name0, unit0, from_tai0, to_tai0, _x5408, _x5411, _x5414, _ctx);
}
...
static inline kk_std_time_instant__timescale kk_std_time_instant_timescale(kk_std_time_instant__instant i, kk_context_t* _ctx) { /* (i : instant) -> timescale */ 
  struct kk_std_time_instant_Instant* _con5417 = kk_std_time_instant__as_Instant(i);
  kk_std_time_timestamp__timestamp _pat0 = _con5417->since;
  kk_std_time_instant__timescale _x = _con5417->ts;
  struct kk_std_time_instant_Timescale* _con5418 = kk_std_time_instant__as_Timescale(_x);
...
static inline kk_std_time_duration__duration kk_std_time_instant_duration(kk_std_time_instant__instant i, kk_context_t* _ctx) { /* (i : instant) -> std/time/duration/duration */ 
  ...
  kk_std_time_instant__timescale _x5658 = kk_std_time_instant__timescale_dup(kk_std_time_instant_ts_tai); /*std/time/instant/timescale*/
  t_4540 = kk_std_time_instant_timestamp_in(i, _x5658, _ctx); /*std/time/timestamp/timestamp*/
  kk_std_num_ddouble__ddouble _x5659 = kk_std_time_timestamp_unsafe_timespan_withleap(t_4540, _ctx); /*std/time/timestamp/timespan*/
  return kk_std_time_duration__new_Duration(_x5659, _ctx);
}
...
static inline kk_std_time_duration__duration kk_std_time_instant__lp__dash__1_rp_(kk_std_time_instant__instant i, kk_std_time_instant__instant j, kk_context_t* _ctx) { /* (i : instant, j : instant) -> std/time/duration/duration */ 
  ...
  kk_std_num_ddouble__ddouble _x5660;
  kk_std_num_ddouble__ddouble _x5661;
  kk_std_num_ddouble__ddouble _x = d_4541.secs;
  _x5661 = _x; /*std/time/timestamp/timespan*/
  kk_std_num_ddouble__ddouble _x5662;
  kk_std_num_ddouble__ddouble _x0 = e0_2276.secs;
  _x5662 = _x0; /*std/time/timestamp/timespan*/
  _x5660 = kk_std_num_ddouble__lp__plus__rp_(_x5661, _x5662, _ctx); /*std/num/ddouble/ddouble*/
  return kk_std_time_duration__new_Duration(_x5660, _ctx);
}
...
static inline kk_std_time_instant__instant kk_std_time_instant_instant_1(kk_std_time_duration__duration d, kk_context_t* _ctx) { /* (d : std/time/duration/duration) -> instant */ 
  ...
  kk_std_time_instant__timescale _x5711 = kk_std_time_instant__timescale_dup(kk_std_time_instant_ts_tai); /*std/time/instant/timescale*/
  return kk_std_time_instant__new_Instant(kk_reuse_null, t_4564, _x5711, _ctx);
}
...
static inline kk_std_time_duration__duration kk_std_time_instant_to_tai_1(kk_std_time_instant__timescale ts0, kk_std_time_timestamp__timestamp t, kk_context_t* _ctx) { /* (ts : timescale, t : std/time/timestamp/timestamp) -> std/time/duration/duration */ 
  ...
  kk_std_time_instant__timescale _x5718 = kk_std_time_instant__timescale_dup(kk_std_time_instant_ts_tai); /*std/time/instant/timescale*/
  t0_4567 = kk_std_time_instant_convert(t, ts0, _x5718, _ctx); /*std/time/timestamp/timestamp*/
  kk_std_num_ddouble__ddouble _x5719 = kk_std_time_timestamp_unsafe_timespan_withleap(t0_4567, _ctx); /*std/time/timestamp/timespan*/
  return kk_std_time_duration__new_Duration(_x5719, _ctx);
}
