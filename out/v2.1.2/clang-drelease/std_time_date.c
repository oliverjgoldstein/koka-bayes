// Koka generated module: "std/time/date", koka version: 2.1.2
...
kk_string_t kk_std_time_date_show_seconds(kk_std_num_ddouble__ddouble secs, kk_std_core_types__optional max_prec, kk_std_core_types__optional secs_width, kk_std_core_types__optional unit, kk_context_t* _ctx) { /* (secs : std/num/ddouble/ddouble, max-prec : optional<int>, secs-width : optional<int>, unit : optional<string>) -> string */ 
  ...
  _x10373 = kk_std_core_types__new_Optional(kk_integer_box(_b_9889_9888), _ctx); /*optional<108>*/
...
kk_string_t kk_std_time_date_show_year(kk_integer_t year0, kk_context_t* _ctx) { /* (year : int) -> string */ 
  ...
  if (_match_10003) {
    ...
    _x10442 = kk_string_box(_x10443); /*6*/
    _match_10001 = kk_std_core_types__new_dash__lp__comma__rp_(_x10442, kk_integer_box(kk_integer_from_small(5)), _ctx); /*(6, 7)*/
  }
  else {
    bool _match_10004;
    ...
    if (_match_10004) {
      ...
      _x10446 = kk_string_box(_x10447); /*6*/
      _match_10001 = kk_std_core_types__new_dash__lp__comma__rp_(_x10446, kk_integer_box(kk_integer_from_small(5)), _ctx); /*(6, 7)*/
    }
    else {
      kk_box_t _x10449;
      kk_string_t _x10450 = kk_string_empty(); /*string*/
      _x10449 = kk_string_box(_x10450); /*6*/
      _match_10001 = kk_std_core_types__new_dash__lp__comma__rp_(_x10449, kk_integer_box(kk_integer_from_small(4)), _ctx); /*(6, 7)*/
    }
  }
...
kk_string_t kk_std_time_date_show(kk_std_time_date__date d, kk_std_core_types__optional month_prefix, kk_context_t* _ctx) { /* (d : date, month-prefix : optional<string>) -> string */ 
  ...
  kk_std_core_types__optional _x10485 = kk_std_core_types__new_None(_ctx); /*forall<a> optional<a>*/
  if (kk_std_core_types__is_Optional(_x10485)) {
    kk_box_t _box_x9933 = _x10485._cons.Optional.value;
  ...
  size_t n;
  kk_string_t _x10488 = kk_string_dup(s_9808); /*string*/
  n = kk_string_len(_x10488,kk_context()); /*size_t*/
  ...
  if (_match_9998) {
    ...
    if (kk_std_core_types__is_Optional(fill_9810)) {
      ...
      _x10491 = _fill_8417; /*char*/
      goto _match10492;
    }
    _x10491 = ' '; /*char*/
    _match10492: ;
    _x10490 = kk_std_core_string(_x10491, _ctx); /*string*/
    size_t _x10494 = (w - n); /*size_t*/
    _x10489 = kk_std_core_repeatz(_x10490, _x10494, _ctx); /*string*/
    _x10482 = kk_std_core__lp__plus__plus__1_rp_(_x10489, s_9808, _ctx); /*string*/
  }
  kk_string_t _x10495;
  kk_string_t _x10496;
  kk_define_string_literal(, _s10497, 1, "-")
  _x10496 = kk_string_dup(_s10497); /*string*/
  kk_string_t _x10498;
  ...
  if (kk_std_core_types__is_Optional(width1_9812)) {
    ...
    _x10500 = _width_92380; /*int*/
    goto _match10501;
  }
  _x10500 = kk_integer_from_small(2); /*int*/
  _match10501: ;
  w0 = kk_std_core_size__t(_x10500, _ctx); /*size_t*/
  size_t n0;
  kk_string_t _x10503 = kk_string_dup(s0_9814); /*string*/
  n0 = kk_string_len(_x10503,kk_context()); /*size_t*/
  bool _match_9997 = (w0 <= n0); /*bool*/;
  if (_match_9997) {
    kk_std_core_types__optional_drop(fill0_9816, _ctx);
    _x10498 = s0_9814; /*string*/
  }
  else {
    kk_string_t _x10504;
    kk_string_t _x10505;
    ...
    if (kk_std_core_types__is_Optional(fill0_9816)) {
      ...
      _x10506 = _fill_84170; /*char*/
      goto _match10507;
    }
    _x10506 = ' '; /*char*/
    _match10507: ;
    _x10505 = kk_std_core_string(_x10506, _ctx); /*string*/
    size_t _x10509 = (w0 - n0); /*size_t*/
    _x10504 = kk_std_core_repeatz(_x10505, _x10509, _ctx); /*string*/
    _x10498 = kk_std_core__lp__plus__plus__1_rp_(_x10504, s0_9814, _ctx); /*string*/
  }
  _x10495 = kk_std_core__lp__plus__plus__1_rp_(_x10496, _x10498, _ctx); /*string*/
  _x10481 = kk_std_core__lp__plus__plus__1_rp_(_x10482, _x10495, _ctx); /*string*/
...
kk_string_t kk_std_time_date_show_1(kk_std_time_date__clock c, kk_std_core_types__optional prec, kk_context_t* _ctx) { /* (c : clock, prec : optional<int>) -> string */ 
  kk_string_t _x10510;
  kk_string_t s_9820;
  kk_integer_t _x10511;
  struct kk_std_time_date_Clock* _con10512 = kk_std_time_date__as_Clock(c);
  kk_integer_t _x = _con10512->hours;
  kk_std_num_ddouble__ddouble _pat10 = _con10512->seconds;
  kk_integer_dup(_x);
  _x10511 = _x; /*int*/
  s_9820 = kk_std_core_show(_x10511, _ctx); /*string*/
  kk_std_core_types__optional fill_9822 = kk_std_core_types__new_Optional(kk_char_box('0', _ctx), _ctx); /*optional<char>*/;
  size_t w;
  kk_integer_t _x10513;
  kk_std_core_types__optional _x10514 = kk_std_core_types__new_None(_ctx); /*forall<a> optional<a>*/
  if (kk_std_core_types__is_Optional(_x10514)) {
    kk_box_t _box_x9943 = _x10514._cons.Optional.value;
    kk_integer_t _width_9238 = kk_integer_unbox(_box_x9943);
    _x10513 = _width_9238; /*int*/
    goto _match10515;
  }
  _x10513 = kk_integer_from_small(2); /*int*/
  _match10515: ;
  w = kk_std_core_size__t(_x10513, _ctx); /*size_t*/
  size_t n;
  kk_string_t _x10517 = kk_string_dup(s_9820); /*string*/
  n = kk_string_len(_x10517,kk_context()); /*size_t*/
  bool _match_9995 = (w <= n); /*bool*/;
  if (_match_9995) {
    kk_std_core_types__optional_drop(fill_9822, _ctx);
    _x10510 = s_9820; /*string*/
  }
  else {
    kk_string_t _x10518;
    kk_string_t _x10519;
    ...
    if (kk_std_core_types__is_Optional(fill_9822)) {
      ...
      _x10520 = _fill_8417; /*char*/
      goto _match10521;
    }
    _x10520 = ' '; /*char*/
    _match10521: ;
    _x10519 = kk_std_core_string(_x10520, _ctx); /*string*/
    size_t _x10523 = (w - n); /*size_t*/
    _x10518 = kk_std_core_repeatz(_x10519, _x10523, _ctx); /*string*/
    _x10510 = kk_std_core__lp__plus__plus__1_rp_(_x10518, s_9820, _ctx); /*string*/
  }
  kk_string_t _x10524;
  kk_string_t _x10525;
  kk_define_string_literal(, _s10526, 1, ":")
  _x10525 = kk_string_dup(_s10526); /*string*/
  kk_string_t _x10527;
  kk_string_t _x10528;
  kk_string_t s0_9826;
  kk_integer_t _x10529;
  struct kk_std_time_date_Clock* _con10530 = kk_std_time_date__as_Clock(c);
  kk_integer_t _x0 = _con10530->minutes;
  kk_std_num_ddouble__ddouble _pat12 = _con10530->seconds;
  kk_integer_dup(_x0);
  _x10529 = _x0; /*int*/
  s0_9826 = kk_std_core_show(_x10529, _ctx); /*string*/
  kk_std_core_types__optional fill0_9828 = kk_std_core_types__new_Optional(kk_char_box('0', _ctx), _ctx); /*optional<char>*/;
  size_t w0;
  kk_integer_t _x10531;
  kk_std_core_types__optional _x10532 = kk_std_core_types__new_None(_ctx); /*forall<a> optional<a>*/
  if (kk_std_core_types__is_Optional(_x10532)) {
    kk_box_t _box_x9947 = _x10532._cons.Optional.value;
    kk_integer_t _width_92380 = kk_integer_unbox(_box_x9947);
    _x10531 = _width_92380; /*int*/
    goto _match10533;
  }
  _x10531 = kk_integer_from_small(2); /*int*/
  _match10533: ;
  w0 = kk_std_core_size__t(_x10531, _ctx); /*size_t*/
  size_t n0;
  kk_string_t _x10535 = kk_string_dup(s0_9826); /*string*/
  n0 = kk_string_len(_x10535,kk_context()); /*size_t*/
  bool _match_9993 = (w0 <= n0); /*bool*/;
  if (_match_9993) {
    kk_std_core_types__optional_drop(fill0_9828, _ctx);
    _x10528 = s0_9826; /*string*/
  }
  else {
    kk_string_t _x10536;
    kk_string_t _x10537;
    ...
    if (kk_std_core_types__is_Optional(fill0_9828)) {
      ...
      _x10538 = _fill_84170; /*char*/
      goto _match10539;
    }
    _x10538 = ' '; /*char*/
    _match10539: ;
    _x10537 = kk_std_core_string(_x10538, _ctx); /*string*/
    size_t _x10541 = (w0 - n0); /*size_t*/
    _x10536 = kk_std_core_repeatz(_x10537, _x10541, _ctx); /*string*/
    _x10528 = kk_std_core__lp__plus__plus__1_rp_(_x10536, s0_9826, _ctx); /*string*/
  }
  kk_string_t _x10542;
  kk_string_t _x10543;
  kk_define_string_literal(, _s10544, 1, ":")
  _x10543 = kk_string_dup(_s10544); /*string*/
  kk_string_t _x10545;
  kk_std_num_ddouble__ddouble _x10546;
  struct kk_std_time_date_Clock* _con10547 = kk_std_time_date__as_Clock(c);
  kk_integer_t _pat05 = _con10547->hours;
  kk_integer_t _pat13 = _con10547->minutes;
  kk_std_num_ddouble__ddouble _x1 = _con10547->seconds;
  if (kk_std_time_date__clock_is_unique(c)) {
    kk_integer_drop(_pat13, _ctx);
  ...
  _x10546 = _x1; /*std/num/ddouble/ddouble*/
  kk_std_core_types__optional _x10548;
  kk_box_t _x10549;
  kk_integer_t _x10550;
  if (kk_std_core_types__is_Optional(prec)) {
    kk_box_t _box_x9949 = prec._cons.Optional.value;
    kk_integer_t _prec_9115 = kk_integer_unbox(_box_x9949);
    _x10550 = _prec_9115; /*int*/
    goto _match10551;
  }
  _x10550 = kk_integer_from_small(9); /*int*/
  _match10551: ;
  _x10549 = kk_integer_box(_x10550); /*108*/
  _x10548 = kk_std_core_types__new_Optional(_x10549, _ctx); /*optional<108>*/
  kk_std_core_types__optional _x10553 = kk_std_core_types__new_Optional(kk_integer_box(kk_integer_from_small(2)), _ctx); /*optional<108>*/
  _x10545 = kk_std_time_date_show_seconds(_x10546, _x10548, _x10553, kk_std_core_types__new_None(_ctx), _ctx); /*string*/
  _x10542 = kk_std_core__lp__plus__plus__1_rp_(_x10543, _x10545, _ctx); /*string*/
  _x10527 = kk_std_core__lp__plus__plus__1_rp_(_x10528, _x10542, _ctx); /*string*/
  _x10524 = kk_std_core__lp__plus__plus__1_rp_(_x10525, _x10527, _ctx); /*string*/
  return kk_std_core__lp__plus__plus__1_rp_(_x10510, _x10524, _ctx);
}
...
kk_string_t kk_std_time_date_show_2(kk_std_time_date__weekday wd, kk_context_t* _ctx) { /* (wd : weekday) -> string */ 
  if (kk_std_time_date__is_Mon(wd)) {
    kk_define_string_literal(, _s10554, 6, "Monday")
    return kk_string_dup(_s10554);
  }
  if (kk_std_time_date__is_Tue(wd)) {
    kk_define_string_literal(, _s10555, 7, "Tuesday")
    return kk_string_dup(_s10555);
  }
  if (kk_std_time_date__is_Wed(wd)) {
    kk_define_string_literal(, _s10556, 9, "Wednesday")
    return kk_string_dup(_s10556);
  }
  if (kk_std_time_date__is_Thu(wd)) {
    kk_define_string_literal(, _s10557, 8, "Thursday")
    return kk_string_dup(_s10557);
  }
  if (kk_std_time_date__is_Fri(wd)) {
    kk_define_string_literal(, _s10558, 6, "Friday")
    return kk_string_dup(_s10558);
  }
  if (kk_std_time_date__is_Sat(wd)) {
    kk_define_string_literal(, _s10559, 8, "Saturday")
    return kk_string_dup(_s10559);
  }
  kk_define_string_literal(, _s10560, 6, "Sunday")
  return kk_string_dup(_s10560);
}
...
kk_string_t kk_std_time_date_show_short(kk_std_time_date__weekday wd, kk_context_t* _ctx) { /* (wd : weekday) -> string */ 
  ...
  if (kk_std_core_types__is_Optional(n_9831)) {
    ...
    _x10562 = _n_12425; /*int*/
    goto _match10563;
  }
  _x10562 = kk_integer_from_small(1); /*int*/
  _match10563: ;
  _match_9992 = kk_integer_eq(_x10562,(kk_integer_from_small(1)),kk_context()); /*bool*/
  if (_match_9992) {
    kk_std_core_types__optional_drop(n_9831, _ctx);
    _x10561 = slice; /*sslice*/
  }
  else {
    kk_integer_t _x10565;
    kk_integer_t _x10566;
    if (kk_std_core_types__is_Optional(n_9831)) {
      kk_box_t _box_x9957 = n_9831._cons.Optional.value;
      kk_integer_t _n_124250 = kk_integer_unbox(_box_x9957);
      _x10566 = _n_124250; /*int*/
      goto _match10567;
    }
    _x10566 = kk_integer_from_small(1); /*int*/
    _match10567: ;
    _x10565 = kk_integer_sub(_x10566,(kk_integer_from_small(1)),kk_context()); /*int*/
    _x10561 = kk_std_core_extend(slice, _x10565, _ctx); /*sslice*/
  }
  return kk_std_core_string_3(_x10561, _ctx);
}
...
kk_integer_t kk_std_time_date_whole_seconds(kk_std_time_date__clock c, kk_context_t* _ctx) { /* (c : clock) -> int */ 
  ...
  bool _match_9991;
  kk_std_num_ddouble__ddouble _x10571;
  struct kk_std_time_date_Clock* _con10572 = kk_std_time_date__as_Clock(c);
  kk_std_num_ddouble__ddouble _x = _con10572->seconds;
  _x10571 = _x; /*std/num/ddouble/ddouble*/
  _match_9991 = kk_std_num_ddouble_is_neg(_x10571, _ctx); /*bool*/
  if (_match_9991) {
    kk_std_num_ddouble__ddouble _x10573;
    struct kk_std_time_date_Clock* _con10574 = kk_std_time_date__as_Clock(c);
    kk_integer_t _pat000 = _con10574->hours;
    kk_integer_t _pat100 = _con10574->minutes;
    kk_std_num_ddouble__ddouble _x0 = _con10574->seconds;
    if (kk_std_time_date__clock_is_unique(c)) {
      kk_integer_drop(_pat100, _ctx);
    ...
    _x10573 = _x0; /*std/num/ddouble/ddouble*/
    _x10570 = kk_std_num_ddouble_ceiling(_x10573, _ctx); /*std/num/ddouble/ddouble*/
  }
  else {
    kk_std_num_ddouble__ddouble _x10575;
    struct kk_std_time_date_Clock* _con10576 = kk_std_time_date__as_Clock(c);
    kk_integer_t _pat001 = _con10576->hours;
    kk_integer_t _pat101 = _con10576->minutes;
    kk_std_num_ddouble__ddouble _x1 = _con10576->seconds;
    if (kk_std_time_date__clock_is_unique(c)) {
    ...
    _x10575 = _x1; /*std/num/ddouble/ddouble*/
    _x10570 = kk_std_num_ddouble_floor(_x10575, _ctx); /*std/num/ddouble/ddouble*/
  }
  return kk_std_num_ddouble_int(_x10570, kk_std_core_types__new_None(_ctx), _ctx);
}
