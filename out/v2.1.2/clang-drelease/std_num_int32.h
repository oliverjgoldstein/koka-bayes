...
static inline bool kk_std_num_int32_is_odd(int32_t i, kk_context_t* _ctx) { /* (i : int32) -> bool */ 
  int32_t _x2166 = (i & (((int32_t)1))); /*int32*/
  return (_x2166 == (((int32_t)1)));
}
...
static inline kk_string_t kk_std_num_int32_show(int32_t i, kk_context_t* _ctx) { /* (i : int32) -> string */ 
  kk_integer_t _x2175 = kk_integer_from_int(i,kk_context()); /*int*/
  return kk_std_core_show(_x2175, _ctx);
}
...
static inline int32_t kk_std_num_int32_uint32(kk_integer_t i, kk_context_t* _ctx) { /* (i : int) -> int32 */ 
  kk_integer_t _x2193;
  bool _match_2096;
  kk_integer_t _x2194 = kk_integer_dup(i); /*int*/
  _match_2096 = kk_integer_gt(_x2194,(kk_integer_from_int(2147483647, _ctx)),kk_context()); /*bool*/
  if (_match_2096) {
    _x2193 = kk_integer_sub(i,(kk_integer_from_str("4294967296", _ctx)),kk_context()); /*int*/
  }
  else {
    _x2193 = i; /*int*/
  }
  return kk_std_core_int32(_x2193, _ctx);
}
