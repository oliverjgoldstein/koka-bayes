...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble__copy(kk_std_num_ddouble__ddouble _this, kk_std_core_types__optional hi0, kk_std_core_types__optional lo0, kk_context_t* _ctx) { /* (ddouble, hi : optional<double>, lo : optional<double>) -> ddouble */ 
  ...
  if (kk_std_core_types__is_Optional(hi0)) {
    ...
    kk_std_core_types__optional_drop(hi0, _ctx);
  ...
  if (kk_std_core_types__is_Optional(lo0)) {
    ...
    kk_std_core_types__optional_drop(lo0, _ctx);
...
static inline kk_std_num_ddouble__edouble kk_std_num_ddouble__copy_1(kk_std_num_ddouble__edouble _this, kk_std_core_types__optional num0, kk_std_core_types__optional err0, kk_context_t* _ctx) { /* (edouble, num : optional<double>, err : optional<double>) -> edouble */ 
  ...
  if (kk_std_core_types__is_Optional(err0)) {
    ...
    kk_std_core_types__optional_drop(err0, _ctx);
...
static inline kk_std_core_types__tuple2_ kk_std_num_ddouble_decode(kk_std_num_ddouble__ddouble d, kk_context_t* _ctx) { /* (d : ddouble) -> (double, double) */ 
  ...
  double _x = d.hi;
  _x22027 = _x; /*double*/
  _x22026 = kk_double_box(_x22027, _ctx); /*4*/
  kk_box_t _x22028;
  double _x22029;
  double _x0 = d.lo;
  _x22029 = _x0; /*double*/
  _x22028 = kk_double_box(_x22029, _ctx); /*5*/
...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble_ddouble_2(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> ddouble */ 
  ...
  kk_std_core_types__maybe_drop(m_20742, _ctx);
  return x;
}
...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble_dec(kk_std_num_ddouble__ddouble x, kk_context_t* _ctx) { /* (x : ddouble) -> ddouble */ 
  kk_std_num_ddouble__ddouble _x22416 = kk_std_num_ddouble__new_Ddouble(0x1p0, 0x0p+0, _ctx); /*std/num/ddouble/ddouble*/
  return kk_std_num_ddouble__lp__dash__rp_(x, _x22416, _ctx);
}
...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble__lp__perc__rp_(kk_std_num_ddouble__ddouble x, kk_std_num_ddouble__ddouble y, kk_context_t* _ctx) { /* (x : ddouble, y : ddouble) -> ddouble */ 
  ...
  kk_std_num_ddouble__ddouble _x22462 = kk_std_num_ddouble__lp__fs__rp_(x, y, _ctx); /*std/num/ddouble/ddouble*/
  n = kk_std_num_ddouble_round(_x22462, _ctx); /*std/num/ddouble/ddouble*/
  kk_std_num_ddouble__ddouble y0_20772 = kk_std_num_ddouble__lp__star__rp_(n, y, _ctx); /*std/num/ddouble/ddouble*/;
  kk_std_num_ddouble__ddouble _x22463 = kk_std_num_ddouble__lp__tilde__rp_(y0_20772, _ctx); /*std/num/ddouble/ddouble*/
  return kk_std_num_ddouble__lp__plus__rp_(x, _x22463, _ctx);
}
...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble_sin16(kk_integer_t i, kk_context_t* _ctx) { /* (i : int) -> ddouble */ 
  ...
  kk_vector_t _x22521 = kk_vector_dup(kk_std_num_ddouble_sin16_table); /*vector<std/num/ddouble/ddouble>*/
  m_20797 = kk_std_core_at(_x22521, i, _ctx); /*maybe<std/num/ddouble/ddouble>*/
  ...
  kk_std_core_types__maybe_drop(m_20797, _ctx);
  return x;
}
...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble_mul_pwr2(kk_std_num_ddouble__ddouble x, double p, kk_context_t* _ctx) { /* (x : ddouble, p : double) -> ddouble */ 
  ...
  double _x = x.hi;
  _x22895 = _x; /*double*/
  _x22894 = (_x22895 * p); /*double*/
  double _x22896;
  double _x22897;
  double _x0 = x.lo;
  _x22897 = _x0; /*double*/
  _x22896 = (_x22897 * p); /*double*/
  return kk_std_num_ddouble__new_Ddouble(_x22894, _x22896, _ctx);
}
...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble_half(kk_std_num_ddouble__ddouble x, kk_context_t* _ctx) { /* (x : ddouble) -> ddouble */ 
  ...
  double _x = x.hi;
  _x22899 = _x; /*double*/
  _x22898 = (_x22899 * (0x1p-1)); /*double*/
  double _x22900;
  double _x22901;
  double _x0 = x.lo;
  _x22901 = _x0; /*double*/
  _x22900 = (_x22901 * (0x1p-1)); /*double*/
...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble_ldexp(kk_std_num_ddouble__ddouble x, kk_integer_t exp0, kk_context_t* _ctx) { /* (x : ddouble, exp : int) -> ddouble */ 
  ...
  double _x = x.hi;
  _x22903 = _x; /*double*/
  kk_integer_t _x22904 = kk_integer_dup(exp0); /*int*/
  _x22902 = kk_std_num_double_ldexp(_x22903, _x22904, _ctx); /*double*/
  double _x22905;
  double _x22906;
  double _x0 = x.lo;
  _x22906 = _x0; /*double*/
  _x22905 = kk_std_num_double_ldexp(_x22906, exp0, _ctx); /*double*/
  return kk_std_num_ddouble__new_Ddouble(_x22902, _x22905, _ctx);
}
...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble_twice(kk_std_num_ddouble__ddouble x, kk_context_t* _ctx) { /* (x : ddouble) -> ddouble */ 
  ...
  double _x = x.hi;
  _x22908 = _x; /*double*/
  _x22907 = (_x22908 * 0x1p1); /*double*/
  double _x22909;
  double _x22910;
  double _x0 = x.lo;
  _x22910 = _x0; /*double*/
  _x22909 = (_x22910 * 0x1p1); /*double*/
  return kk_std_num_ddouble__new_Ddouble(_x22907, _x22909, _ctx);
}
...
static inline bool kk_std_num_ddouble_is_posinf(kk_std_num_ddouble__ddouble x, kk_context_t* _ctx) { /* (x : ddouble) -> bool */ 
  ...
  double _x = x.hi;
  _x22995 = _x; /*double*/
  return (isinf(_x22995) && !signbit(_x22995));
}
...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble_atan(kk_std_num_ddouble__ddouble x, kk_context_t* _ctx) { /* (x : ddouble) -> ddouble */ 
  kk_std_num_ddouble__ddouble _x23127 = kk_std_num_ddouble__new_Ddouble(0x1p0, 0x0p+0, _ctx); /*std/num/ddouble/ddouble*/
  return kk_std_num_ddouble_atan2(x, _x23127, _ctx);
}
...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble_encode(double hi0, double lo0, kk_context_t* _ctx) { /* (hi : double, lo : double) -> ddouble */ 
  kk_std_num_ddouble__ddouble _x23308 = kk_std_num_ddouble_ddouble(hi0, _ctx); /*std/num/ddouble/ddouble*/
  kk_std_num_ddouble__ddouble _x23309 = kk_std_num_ddouble_ddouble(lo0, _ctx); /*std/num/ddouble/ddouble*/
  return kk_std_num_ddouble__lp__plus__rp_(_x23308, _x23309, _ctx);
}
...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble_exp10(kk_std_num_ddouble__ddouble exp0, kk_context_t* _ctx) { /* (exp : ddouble) -> ddouble */ 
  kk_std_num_ddouble__ddouble _x23331 = kk_std_num_ddouble__new_Ddouble(0x1.4p3, 0x0p+0, _ctx); /*std/num/ddouble/ddouble*/
  return kk_std_num_ddouble_pow(_x23331, exp0, _ctx);
}
...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble_exp2(kk_std_num_ddouble__ddouble exp0, kk_context_t* _ctx) { /* (exp : ddouble) -> ddouble */ 
  kk_std_num_ddouble__ddouble _x23332 = kk_std_num_ddouble__new_Ddouble(0x1p1, 0x0p+0, _ctx); /*std/num/ddouble/ddouble*/
  return kk_std_num_ddouble_pow(_x23332, exp0, _ctx);
}
...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble_ffraction(kk_std_num_ddouble__ddouble x, kk_context_t* _ctx) { /* (x : ddouble) -> ddouble */ 
  ...
  kk_std_num_ddouble__ddouble _x23411 = kk_std_num_ddouble__lp__tilde__rp_(y_21007, _ctx); /*std/num/ddouble/ddouble*/
  return kk_std_num_ddouble__lp__plus__rp_(x, _x23411, _ctx);
}
...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble_fraction(kk_std_num_ddouble__ddouble x, kk_context_t* _ctx) { /* (x : ddouble) -> ddouble */ 
  ...
  kk_std_num_ddouble__ddouble _x23412 = kk_std_num_ddouble__lp__tilde__rp_(y_21009, _ctx); /*std/num/ddouble/ddouble*/
  return kk_std_num_ddouble__lp__plus__rp_(x, _x23412, _ctx);
}
...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble_inc(kk_std_num_ddouble__ddouble x, kk_context_t* _ctx) { /* (x : ddouble) -> ddouble */ 
  kk_std_num_ddouble__ddouble _x23649 = kk_std_num_ddouble__new_Ddouble(0x1p0, 0x0p+0, _ctx); /*std/num/ddouble/ddouble*/
  return kk_std_num_ddouble__lp__plus__rp_(x, _x23649, _ctx);
}
...
static inline bool kk_std_num_ddouble_is_inf(kk_std_num_ddouble__ddouble x, kk_context_t* _ctx) { /* (x : ddouble) -> bool */ 
  ...
  double _x = x.hi;
  _x23650 = _x; /*double*/
  return kk_std_num_double_is_inf(_x23650, _ctx);
}
...
static inline bool kk_std_num_ddouble_is_nan(kk_std_num_ddouble__ddouble x, kk_context_t* _ctx) { /* (x : ddouble) -> bool */ 
  ...
  double _x = x.hi;
  _x23651 = _x; /*double*/
  _match_21753 = isnan(_x23651); /*bool*/
  if (_match_21753) {
    return true;
  }
  double _x23652;
...
static inline bool kk_std_num_ddouble_is_neginf(kk_std_num_ddouble__ddouble x, kk_context_t* _ctx) { /* (x : ddouble) -> bool */ 
  ...
  double _x = x.hi;
  _x23653 = _x; /*double*/
  return (isinf(_x23653) && signbit(_x23653));
}
...
static inline kk_std_core_types__order kk_std_num_ddouble_is_sign(kk_std_num_ddouble__ddouble x, kk_context_t* _ctx) { /* (x : ddouble) -> order */ 
  ...
  double _x = x.hi;
  _x23654 = _x; /*double*/
  _match_21751 = (_x23654 == (0x0p+0)); /*bool*/
  if (_match_21751) {
  ...
  double _x0 = x.hi;
  _x23655 = _x0; /*double*/
  _match_21752 = (_x23655 < (0x0p+0)); /*bool*/
  if (_match_21752) {
...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble_log10(kk_std_num_ddouble__ddouble x, kk_context_t* _ctx) { /* (x : ddouble) -> ddouble */ 
  kk_std_num_ddouble__ddouble _x23656 = kk_std_num_ddouble_log(x, _ctx); /*std/num/ddouble/ddouble*/
  kk_std_num_ddouble__ddouble _x23657 = kk_std_num_ddouble__new_Ddouble(0x1.26bb1bbb55516p1, -0x1.f48ad494ea3e9p-53, _ctx); /*std/num/ddouble/ddouble*/
  return kk_std_num_ddouble__lp__fs__rp_(_x23656, _x23657, _ctx);
}
...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble_log2(kk_std_num_ddouble__ddouble x, kk_context_t* _ctx) { /* (x : ddouble) -> ddouble */ 
  kk_std_num_ddouble__ddouble _x23680 = kk_std_num_ddouble_log(x, _ctx); /*std/num/ddouble/ddouble*/
  kk_std_num_ddouble__ddouble _x23681 = kk_std_num_ddouble__new_Ddouble(0x1.62e42fefa39efp-1, 0x1.abc9e3b39803fp-56, _ctx); /*std/num/ddouble/ddouble*/
  return kk_std_num_ddouble__lp__fs__rp_(_x23680, _x23681, _ctx);
}
...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble_tan(kk_std_num_ddouble__ddouble rad, kk_context_t* _ctx) { /* (rad : ddouble) -> ddouble */ 
  ...
  kk_std_core_types__tuple2__drop(_match_21686, _ctx);
