...
kk_unit_t kk_std_os_dir_copy_file(kk_std_os_path__path from, kk_std_os_path__path to, kk_std_core_types__optional preserve_mtime, kk_context_t* _ctx) { /* (from : std/os/path/path, to : std/os/path/path, preserve-mtime : optional<bool>) -> <exn,fsys> () */ 
  ...
  _x1831 = kk_std_os_path__path_box(_x1832, _ctx); /*1*/
  _x1827 = kk_std_core_hnd__open_none1(kk_std_os_dir_new_copy_file_fun1828(_ctx), _x1831, _ctx); /*2*/
  _x1 = kk_string_unbox(_x1827); /*string*/
  kk_string_t _x2;
  kk_box_t _x1833;
  kk_box_t _x1837;
  kk_std_os_path__path _x1838 = kk_std_os_path__path_dup(to); /*std/os/path/path*/
  _x1837 = kk_std_os_path__path_box(_x1838, _ctx); /*1*/
  _x1833 = kk_std_core_hnd__open_none1(kk_std_os_dir_new_copy_file_fun1834(_ctx), _x1837, _ctx); /*2*/
  ...
  if (kk_std_core__is_Error(_match_1820)) {
    ...
    kk_string_t _x1845;
    kk_string_t _x1846;
    kk_box_t _x1847 = kk_std_core_hnd__open_none1(kk_std_os_dir_new_copy_file_fun1848(_ctx), kk_std_os_path__path_box(from, _ctx), _ctx); /*2*/
    ...
    kk_string_t _x1854;
    kk_box_t _x1855 = kk_std_core_hnd__open_none1(kk_std_os_dir_new_copy_file_fun1856(_ctx), kk_std_os_path__path_box(to, _ctx), _ctx); /*2*/
    ...
    kk_box_t _x1859 = kk_std_core_hnd__open_none2(kk_std_os_dir_new_copy_file_fun1860(_ctx), kk_std_core__exception_box(exn, _ctx), kk_string_box(_x20), _ctx); /*3*/
    ...
    if (kk_std_core__is_Error(err_1416)) {
      ...
      kk_box_t _x1864 = kk_std_core_throw_exn(exn0, _ctx); /*1*/
...
kk_unit_t kk_std_os_dir_ensure_dir(kk_std_os_path__path dir, kk_context_t* _ctx) { /* (dir : std/os/path/path) -> <exn,fsys> () */ 
  ...
  _x1870 = kk_std_os_path__path_box(_x1871, _ctx); /*1*/
  _x1866 = kk_std_core_hnd__open_none1(kk_std_os_dir_new_ensure_dir_fun1867(_ctx), _x1870, _ctx); /*2*/
  ...
  if (kk_std_core__is_Error(_match_1819)) {
    ...
    kk_string_t _x1875;
    kk_box_t _x1876 = kk_std_core_hnd__open_none1(kk_std_os_dir_new_ensure_dir_fun1877(_ctx), kk_std_os_path__path_box(dir, _ctx), _ctx); /*2*/
    _x1875 = kk_string_unbox(_x1876); /*string*/
    _x20 = kk_std_core__lp__plus__plus__1_rp_(_x1873, _x1875, _ctx); /*string*/
    kk_box_t _x1880 = kk_std_core_hnd__open_none2(kk_std_os_dir_new_ensure_dir_fun1881(_ctx), kk_std_core__exception_box(exn, _ctx), kk_string_box(_x20), _ctx); /*3*/
    ...
    if (kk_std_core__is_Error(err_1420)) {
      ...
      kk_box_t _x1885 = kk_std_core_throw_exn(exn0, _ctx); /*1*/
...
static kk_box_t kk_std_os_dir_list_directory_fun1892(kk_function_t _fself, kk_box_t _b_1536, kk_context_t* _ctx) {
  ...
  kk_string_dup(_x);
  _x1896 = _x; /*string*/
  _x1895 = kk_string_box(_x1896); /*35*/
  ...
  _x1897 = kk_std_core__lift21047_reverse_append(kk_std_core__new_Nil(_ctx), _x1898, _ctx); /*list<1>*/
...
static kk_unit_t kk_std_os_dir__mlift1407_copy_directory_fun1907(kk_function_t _fself, kk_box_t _b_1552, kk_context_t* _ctx) {
  ...
  kk_box_t _x1909 = kk_box_dup(_b_1552); /*1*/
  _x1908 = kk_std_os_path__path_unbox(_x1909, _ctx); /*std/os/path/path*/
  kk_std_os_path__path _x1910;
  kk_std_os_path__path _x20;
  kk_box_t _x1911 = kk_std_core_hnd__open_none1(kk_std_os_dir__new_mlift1407_copy_directory_fun1912(_ctx), _b_1552, _ctx); /*2*/
  _x20 = kk_std_os_path__path_unbox(_x1911, _ctx); /*std/os/path/path*/
  kk_box_t _x1915 = kk_std_core_hnd__open_none2(kk_std_os_dir__new_mlift1407_copy_directory_fun1916(_ctx), kk_std_os_path__path_box(to, _ctx), kk_std_os_path__path_box(_x20, _ctx), _ctx); /*3*/
...
static kk_unit_t kk_std_os_dir__mlift1408_copy_directory_fun1923(kk_function_t _fself, kk_box_t _b_1607, kk_context_t* _ctx) {
  ...
  kk_box_t _x1924;
  kk_box_t _x1928 = kk_box_dup(_b_1607); /*1*/
  _x1924 = kk_std_core_hnd__open_none1(kk_std_os_dir__new_mlift1408_copy_directory_fun1925(_ctx), _x1928, _ctx); /*2*/
  _x21 = kk_std_os_path__path_unbox(_x1924, _ctx); /*std/os/path/path*/
  kk_box_t _x1929 = kk_std_core_hnd__open_none2(kk_std_os_dir__new_mlift1408_copy_directory_fun1930(_ctx), kk_std_os_path__path_box(to0, _ctx), kk_std_os_path__path_box(_x21, _ctx), _ctx); /*3*/
  to0_1426 = kk_std_os_path__path_unbox(_x1929, _ctx); /*std/os/path/path*/
  kk_std_core__error _match_1816;
  kk_string_t _x1;
  kk_box_t _x1934;
  kk_box_t _x1938 = kk_box_dup(_b_1607); /*1*/
  _x1934 = kk_std_core_hnd__open_none1(kk_std_os_dir__new_mlift1408_copy_directory_fun1935(_ctx), _x1938, _ctx); /*2*/
  _x1 = kk_string_unbox(_x1934); /*string*/
  kk_string_t _x2;
  kk_box_t _x1939;
  kk_box_t _x1943;
  kk_std_os_path__path _x1944 = kk_std_os_path__path_dup(to0_1426); /*std/os/path/path*/
  _x1943 = kk_std_os_path__path_box(_x1944, _ctx); /*1*/
  _x1939 = kk_std_core_hnd__open_none1(kk_std_os_dir__new_mlift1408_copy_directory_fun1940(_ctx), _x1943, _ctx); /*2*/
  ...
  if (kk_std_core__is_Error(_match_1816)) {
    ...
    kk_string_t _x1951;
    kk_string_t _x1952;
    kk_box_t _x1953 = kk_std_core_hnd__open_none1(kk_std_os_dir__new_mlift1408_copy_directory_fun1954(_ctx), _b_1607, _ctx); /*2*/
    ...
    kk_string_t _x1960;
    kk_box_t _x1961 = kk_std_core_hnd__open_none1(kk_std_os_dir__new_mlift1408_copy_directory_fun1962(_ctx), kk_std_os_path__path_box(to0_1426, _ctx), _ctx); /*2*/
    ...
    kk_box_t _x1965 = kk_std_core_hnd__open_none2(kk_std_os_dir__new_mlift1408_copy_directory_fun1966(_ctx), kk_std_core__exception_box(exn, _ctx), kk_string_box(_x200), _ctx); /*3*/
    ...
    if (kk_std_core__is_Error(err_1432)) {
      ...
      kk_box_t _x1970 = kk_std_core_throw_exn(exn0, _ctx); /*1*/
...
kk_unit_t kk_std_os_dir__mlift1408_copy_directory(kk_std_os_path__path to0, kk_std_core_types__tuple2_ _y_5, kk_context_t* _ctx) { /* (to : std/os/path/path, (list<std/os/path/path>, list<std/os/path/path>)) -> <fsys,div,exn> () */ 
  ...
  _x1922 = kk_std_os_dir__new_mlift1408_copy_directory_fun1923(to0, _ctx); /*(1) -> 2 ()*/
  kk_std_core_foreach(files, _x1922, _ctx);
  if (kk_yielding(kk_context())) {
    kk_box_t _x1972 = kk_std_core_hnd_yield_extend(kk_std_os_dir__new_mlift1408_copy_directory_fun1973(dirs0, to0, _ctx), _ctx); /*2*/
...
static bool kk_std_os_dir__mlift1409_copy_directory_fun1980(kk_function_t _fself, kk_box_t _b_1628, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  kk_box_t _x1981 = kk_std_core_hnd__open_none1(kk_std_os_dir__new_mlift1409_copy_directory_fun1982(_ctx), _b_1628, _ctx); /*2*/
...
kk_unit_t kk_std_os_dir__mlift1409_copy_directory(kk_std_os_path__path dir, kk_std_os_path__path to1, kk_unit_t wild__, kk_context_t* _ctx) { /* (dir : std/os/path/path, to : std/os/path/path, wild_ : ()) -> <exn,fsys> () */ 
  ...
  kk_box_t _x1976 = kk_std_core_hnd__open_none1(kk_std_os_dir__new_mlift1409_copy_directory_fun1977(_ctx), kk_std_os_path__path_box(dir, _ctx), _ctx); /*2*/
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x1985 = kk_std_core_hnd_yield_extend(kk_std_os_dir__new_mlift1409_copy_directory_fun1986(to1, _ctx), _ctx); /*2*/
...
static bool kk_std_os_dir_copy_directory_fun1998(kk_function_t _fself, kk_box_t _b_1654, kk_context_t* _ctx) {
  KK_UNUSED(_fself);
  kk_box_t _x1999 = kk_std_core_hnd__open_none1(kk_std_os_dir_new_copy_directory_fun2000(_ctx), _b_1654, _ctx); /*2*/
...
static kk_unit_t kk_std_os_dir_copy_directory_fun2010(kk_function_t _fself, kk_box_t _b_1712, kk_context_t* _ctx) {
  ...
  kk_box_t _x2011;
  kk_box_t _x2015 = kk_box_dup(_b_1712); /*1*/
  _x2011 = kk_std_core_hnd__open_none1(kk_std_os_dir_new_copy_directory_fun2012(_ctx), _x2015, _ctx); /*2*/
  _x210 = kk_std_os_path__path_unbox(_x2011, _ctx); /*std/os/path/path*/
  kk_box_t _x2016 = kk_std_core_hnd__open_none2(kk_std_os_dir_new_copy_directory_fun2017(_ctx), kk_std_os_path__path_box(to2, _ctx), kk_std_os_path__path_box(_x210, _ctx), _ctx); /*3*/
  to0_1451 = kk_std_os_path__path_unbox(_x2016, _ctx); /*std/os/path/path*/
  kk_std_core__error _match_1812;
  kk_string_t _x11;
  kk_box_t _x2021;
  kk_box_t _x2025 = kk_box_dup(_b_1712); /*1*/
  _x2021 = kk_std_core_hnd__open_none1(kk_std_os_dir_new_copy_directory_fun2022(_ctx), _x2025, _ctx); /*2*/
  _x11 = kk_string_unbox(_x2021); /*string*/
  kk_string_t _x22;
  kk_box_t _x2026;
  kk_box_t _x2030;
  kk_std_os_path__path _x2031 = kk_std_os_path__path_dup(to0_1451); /*std/os/path/path*/
  _x2030 = kk_std_os_path__path_box(_x2031, _ctx); /*1*/
  _x2026 = kk_std_core_hnd__open_none1(kk_std_os_dir_new_copy_directory_fun2027(_ctx), _x2030, _ctx); /*2*/
  ...
  if (kk_std_core__is_Error(_match_1812)) {
    ...
    kk_string_t _x2038;
    kk_string_t _x2039;
    kk_box_t _x2040 = kk_std_core_hnd__open_none1(kk_std_os_dir_new_copy_directory_fun2041(_ctx), _b_1712, _ctx); /*2*/
    ...
    kk_string_t _x2047;
    kk_box_t _x2048 = kk_std_core_hnd__open_none1(kk_std_os_dir_new_copy_directory_fun2049(_ctx), kk_std_os_path__path_box(to0_1451, _ctx), _ctx); /*2*/
    ...
    kk_box_t _x2052 = kk_std_core_hnd__open_none2(kk_std_os_dir_new_copy_directory_fun2053(_ctx), kk_std_core__exception_box(exn1, _ctx), kk_string_box(_x201), _ctx); /*3*/
    ...
    if (kk_std_core__is_Error(err_1457)) {
      ...
      kk_box_t _x2057 = kk_std_core_throw_exn(exn00, _ctx); /*1*/
...
static kk_unit_t kk_std_os_dir_copy_directory_fun2063(kk_function_t _fself, kk_box_t _b_1731, kk_context_t* _ctx) {
  ...
  kk_box_t _x2065 = kk_box_dup(_b_1731); /*1*/
  _x2064 = kk_std_os_path__path_unbox(_x2065, _ctx); /*std/os/path/path*/
  kk_std_os_path__path _x2066;
  kk_std_os_path__path _x2000;
  kk_box_t _x2067 = kk_std_core_hnd__open_none1(kk_std_os_dir_new_copy_directory_fun2068(_ctx), _b_1731, _ctx); /*2*/
  _x2000 = kk_std_os_path__path_unbox(_x2067, _ctx); /*std/os/path/path*/
  kk_box_t _x2071 = kk_std_core_hnd__open_none2(kk_std_os_dir_new_copy_directory_fun2072(_ctx), kk_std_os_path__path_box(to2, _ctx), kk_std_os_path__path_box(_x2000, _ctx), _ctx); /*3*/
...
kk_unit_t kk_std_os_dir_copy_directory(kk_std_os_path__path dir0, kk_std_os_path__path to2, kk_context_t* _ctx) { /* (dir : std/os/path/path, to : std/os/path/path) -> <pure,fsys> () */ 
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x1990 = kk_std_core_hnd_yield_extend(kk_std_os_dir_new_copy_directory_fun1991(dir0, to2, _ctx), _ctx); /*2*/
    kk_unit_unbox(_x1990); return kk_Unit;
  }
  kk_std_core__list all0;
  kk_box_t _x1994 = kk_std_core_hnd__open_none1(kk_std_os_dir_new_copy_directory_fun1995(_ctx), kk_std_os_path__path_box(dir0, _ctx), _ctx); /*2*/
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x2003 = kk_std_core_hnd_yield_extend(kk_std_os_dir_new_copy_directory_fun2004(to2, _ctx), _ctx); /*2*/
  ...
  _x2009 = kk_std_os_dir_new_copy_directory_fun2010(to2, _ctx); /*(1) -> 2 ()*/
  kk_std_core_foreach(files0, _x2009, _ctx);
  if (kk_yielding(kk_context())) {
    kk_box_t _x2059 = kk_std_core_hnd_yield_extend(kk_std_os_dir_new_copy_directory_fun2060(dirs1, to2, _ctx), _ctx); /*2*/
...
kk_unit_t kk_std_os_dir_copy_file_to_dir(kk_std_os_path__path from, kk_std_os_path__path dir, kk_context_t* _ctx) { /* (from : std/os/path/path, dir : std/os/path/path) -> <exn,fsys> () */ 
  ...
  _x2080 = kk_std_os_path__path_box(_x2081, _ctx); /*1*/
  _x2076 = kk_std_core_hnd__open_none1(kk_std_os_dir_new_copy_file_to_dir_fun2077(_ctx), _x2080, _ctx); /*2*/
  _x21 = kk_std_os_path__path_unbox(_x2076, _ctx); /*std/os/path/path*/
  kk_box_t _x2082 = kk_std_core_hnd__open_none2(kk_std_os_dir_new_copy_file_to_dir_fun2083(_ctx), kk_std_os_path__path_box(dir, _ctx), kk_std_os_path__path_box(_x21, _ctx), _ctx); /*3*/
  ...
  _x2091 = kk_std_os_path__path_box(_x2092, _ctx); /*1*/
  _x2087 = kk_std_core_hnd__open_none1(kk_std_os_dir_new_copy_file_to_dir_fun2088(_ctx), _x2091, _ctx); /*2*/
  _x1 = kk_string_unbox(_x2087); /*string*/
  kk_string_t _x2;
  kk_box_t _x2093;
  kk_box_t _x2097;
  kk_std_os_path__path _x2098 = kk_std_os_path__path_dup(to_1460); /*std/os/path/path*/
  _x2097 = kk_std_os_path__path_box(_x2098, _ctx); /*1*/
  _x2093 = kk_std_core_hnd__open_none1(kk_std_os_dir_new_copy_file_to_dir_fun2094(_ctx), _x2097, _ctx); /*2*/
  ...
  if (kk_std_core__is_Error(_match_1807)) {
    ...
    kk_string_t _x2105;
    kk_string_t _x2106;
    kk_box_t _x2107 = kk_std_core_hnd__open_none1(kk_std_os_dir_new_copy_file_to_dir_fun2108(_ctx), kk_std_os_path__path_box(from, _ctx), _ctx); /*2*/
    ...
    kk_string_t _x2114;
    kk_box_t _x2115 = kk_std_core_hnd__open_none1(kk_std_os_dir_new_copy_file_to_dir_fun2116(_ctx), kk_std_os_path__path_box(to_1460, _ctx), _ctx); /*2*/
    ...
    kk_box_t _x2119 = kk_std_core_hnd__open_none2(kk_std_os_dir_new_copy_file_to_dir_fun2120(_ctx), kk_std_core__exception_box(exn, _ctx), kk_string_box(_x20), _ctx); /*3*/
    ...
    if (kk_std_core__is_Error(err_1466)) {
      ...
      kk_box_t _x2124 = kk_std_core_throw_exn(exn0, _ctx); /*1*/
...
static kk_std_core__list kk_std_os_dir_list_directory_recursive_fun2133(kk_function_t _fself, kk_box_t _b_1800, kk_context_t* _ctx) {
  ...
  _x2135 = kk_std_core_types__new_Optional(kk_integer_box(_b_1805_1796), _ctx); /*optional<35>*/
