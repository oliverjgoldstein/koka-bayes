...
static inline double kk_effects_dash_and_dash_types_sample(kk_context_t* _ctx) { /* () -> sample double */ 
  ...
  _match_483 = fun_sample; /*std/core/hnd/clause0<double,effects-and-types/.hnd-sample,6,7>*/
  kk_function_t _fun_unbox_x448 = _match_483.clause;
  _x500 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_context_t*), _fun_unbox_x448, (_fun_unbox_x448, m, ev_404, _ctx)); /*6*/
...
static inline kk_unit_t kk_effects_dash_and_dash_types_score(kk_effects_dash_and_dash_types__exp s, kk_context_t* _ctx) { /* (s : exp) -> score () */ 
  ...
  _match_482 = fun_score; /*std/core/hnd/clause1<effects-and-types/exp,(),effects-and-types/.hnd-score,8,9>*/
  kk_function_t _fun_unbox_x457 = _match_482.clause;
  _x505 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x457, (_fun_unbox_x457, m, ev_406, kk_effects_dash_and_dash_types__exp_box(s, _ctx), _ctx)); /*11*/
...
static inline kk_unit_t kk_effects_dash_and_dash_types_yield(kk_context_t* _ctx) { /* () -> yield () */ 
  ...
  _match_481 = control_yield; /*std/core/hnd/clause0<(),effects-and-types/.hnd-yield,6,7>*/
  kk_function_t _fun_unbox_x467 = _match_481.clause;
  _x510 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_context_t*), _fun_unbox_x467, (_fun_unbox_x467, m, ev_409, _ctx)); /*6*/
