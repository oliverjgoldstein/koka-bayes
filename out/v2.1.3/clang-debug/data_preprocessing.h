...
struct kk_data_preprocessing_get__thunk_fun2896__t {
...
static inline kk_function_t kk_data_preprocessing_new_get__thunk_fun2896(kk_integer_t index, kk_context_t* _ctx) {
  struct kk_data_preprocessing_get__thunk_fun2896__t* _self = kk_function_alloc_as(struct kk_data_preprocessing_get__thunk_fun2896__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_data_preprocessing_get__thunk_fun2896, kk_context());
  _self->index = index;
  return &_self->_base;
}
...
static inline kk_function_t kk_data_preprocessing_get__thunk(kk_integer_t index, kk_context_t* _ctx) { /* (index : int) -> ((list : list<double>) -> maybe<double>) */ 
  return kk_data_preprocessing_new_get__thunk_fun2896(index, _ctx);
}
...
// lift anonymous function
struct kk_data_preprocessing_list__of__lists__thunk_fun2944__t {
  struct kk_function_s _base;
  kk_integer_t length;
};
...
static inline kk_function_t kk_data_preprocessing_new_list__of__lists__thunk_fun2944(kk_integer_t length, kk_context_t* _ctx) {
  struct kk_data_preprocessing_list__of__lists__thunk_fun2944__t* _self = kk_function_alloc_as(struct kk_data_preprocessing_list__of__lists__thunk_fun2944__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_data_preprocessing_list__of__lists__thunk_fun2944, kk_context());
  _self->length = length;
  return &_self->_base;
}
...
static inline kk_function_t kk_data_preprocessing_list__of__lists__thunk(kk_integer_t length, kk_context_t* _ctx) { /* forall<e> (length : int) -> ((list : list<double>) -> <div|e> list<list<double>>) */ 
  return kk_data_preprocessing_new_list__of__lists__thunk_fun2944(length, _ctx);
}


// lift anonymous function
struct kk_data_preprocessing_convert__to__groups_fun2945__t {
  struct kk_function_s _base;
  kk_function_t _b_2290_2287;
};
...
static inline kk_function_t kk_data_preprocessing_new_convert__to__groups_fun2945(kk_function_t _b_2290_2287, kk_context_t* _ctx) {
  struct kk_data_preprocessing_convert__to__groups_fun2945__t* _self = kk_function_alloc_as(struct kk_data_preprocessing_convert__to__groups_fun2945__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_data_preprocessing_convert__to__groups_fun2945, kk_context());
  _self->_b_2290_2287 = _b_2290_2287;
  return &_self->_base;
}
...
static inline kk_std_core__list kk_data_preprocessing_convert__to__groups(kk_std_core__list months0, kk_integer_t group__size, kk_context_t* _ctx) { /* (months : list<list<double>>, group_size : int) -> div list<list<list<double>>> */ 
  kk_function_t _b_2290_2287 = kk_data_preprocessing_list__of__lists__thunk(group__size, _ctx); /*(list : list<double>) -> div list<list<double>>*/;
  return kk_std_core_map_5(months0, kk_data_preprocessing_new_convert__to__groups_fun2945(_b_2290_2287, _ctx), _ctx);
}
