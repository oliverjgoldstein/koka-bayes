...
struct kk_climate_dash_change_mult__thunk_fun3411__t {
  struct kk_function_s _base;
  double x;
};
extern double kk_climate_dash_change_mult__thunk_fun3411(kk_function_t _fself, double v, kk_context_t* _ctx);
static inline kk_function_t kk_climate_dash_change_new_mult__thunk_fun3411(double x, kk_context_t* _ctx) {
  struct kk_climate_dash_change_mult__thunk_fun3411__t* _self = kk_function_alloc_as(struct kk_climate_dash_change_mult__thunk_fun3411__t, 1, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_climate_dash_change_mult__thunk_fun3411, kk_context());
  _self->x = x;
  return &_self->_base;
}
...
static inline kk_function_t kk_climate_dash_change_mult__thunk(double x, kk_context_t* _ctx) { /* forall<e> (x : double) -> ((v : double) -> e double) */ 
  return kk_climate_dash_change_new_mult__thunk_fun3411(x, _ctx);
}


// lift anonymous function
struct kk_climate_dash_change_multivariate__gaussian_fun3412__t {
  struct kk_function_s _base;
  double mean;
  double std__dev;
};
...
static inline kk_function_t kk_climate_dash_change_new_multivariate__gaussian_fun3412(double mean, double std__dev, kk_context_t* _ctx) {
  struct kk_climate_dash_change_multivariate__gaussian_fun3412__t* _self = kk_function_alloc_as(struct kk_climate_dash_change_multivariate__gaussian_fun3412__t, 1, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_climate_dash_change_multivariate__gaussian_fun3412, kk_context());
  _self->mean = mean;
...
static inline kk_std_core__list kk_climate_dash_change_multivariate__gaussian(kk_integer_t dimension, double mean, double std__dev, kk_context_t* _ctx) { /* (dimension : int, mean : double, std_dev : double) -> effects-and-types/sample list<double> */ 
  return kk_std_core__lift21054_list_1(kk_climate_dash_change_new_multivariate__gaussian_fun3412(mean, std__dev, _ctx), kk_integer_from_small(1), dimension, kk_std_core__new_Nil(_ctx), _ctx);
}
...
// lift anonymous function
struct kk_climate_dash_change_mult_fun3450__t {
  struct kk_function_s _base;
  kk_function_t _b_2953_2950;
};
extern kk_box_t kk_climate_dash_change_mult_fun3450(kk_function_t _fself, kk_box_t _b_2951, kk_context_t* _ctx);
static inline kk_function_t kk_climate_dash_change_new_mult_fun3450(kk_function_t _b_2953_2950, kk_context_t* _ctx) {
  struct kk_climate_dash_change_mult_fun3450__t* _self = kk_function_alloc_as(struct kk_climate_dash_change_mult_fun3450__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_climate_dash_change_mult_fun3450, kk_context());
  _self->_b_2953_2950 = _b_2953_2950;
  return &_self->_base;
}
...
static inline kk_std_core__list kk_climate_dash_change_mult(double x, kk_std_core__list ys, kk_context_t* _ctx) { /* (x : double, ys : effects-and-types/row_vector) -> effects-and-types/row_vector */ 
  kk_function_t _b_2953_2950 = kk_climate_dash_change_mult__thunk(x, _ctx); /*(v : double) -> double*/;
  return kk_std_core_map_5(ys, kk_climate_dash_change_new_mult_fun3450(_b_2953_2950, _ctx), _ctx);
}
