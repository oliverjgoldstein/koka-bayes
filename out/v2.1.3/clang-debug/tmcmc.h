...
static inline kk_function_t kk_tmcmc_m(kk_tmcmc__trace trace, kk_context_t* _ctx) { /* forall<a,e> (trace : trace<a,e>) -> (() -> e a) */ 
  struct kk_tmcmc_Trace* _con2388 = kk_tmcmc__as_Trace(trace);
  kk_function_t _x = _con2388->m;
  kk_effects_dash_and_dash_types__exp _pat0 = _con2388->p;
  kk_std_core__list _pat2 = _con2388->l;
  kk_box_t _pat3 = _con2388->a;
...
static inline kk_effects_dash_and_dash_types__exp kk_tmcmc_p(kk_tmcmc__trace trace, kk_context_t* _ctx) { /* forall<a,e> (trace : trace<a,e>) -> effects-and-types/exp */ 
  struct kk_tmcmc_Trace* _con2389 = kk_tmcmc__as_Trace(trace);
  kk_function_t _pat0 = _con2389->m;
  kk_effects_dash_and_dash_types__exp _x = _con2389->p;
  kk_std_core__list _pat2 = _con2389->l;
  kk_box_t _pat3 = _con2389->a;
  if (kk_tmcmc__trace_is_unique(trace)) {
    kk_box_drop(_pat3, _ctx);
    kk_std_core__list_drop(_pat2, _ctx);
...
static inline kk_std_core__list kk_tmcmc_l(kk_tmcmc__trace trace, kk_context_t* _ctx) { /* forall<a,e> (trace : trace<a,e>) -> effects-and-types/trace_values */ 
  struct kk_tmcmc_Trace* _con2390 = kk_tmcmc__as_Trace(trace);
  kk_function_t _pat0 = _con2390->m;
  kk_effects_dash_and_dash_types__exp _pat1 = _con2390->p;
  kk_std_core__list _x = _con2390->l;
  kk_box_t _pat3 = _con2390->a;
  if (kk_tmcmc__trace_is_unique(trace)) {
    kk_box_drop(_pat3, _ctx);
    kk_function_drop(_pat0, _ctx);
    kk_tmcmc__trace_free(trace);
...
static inline kk_box_t kk_tmcmc_a(kk_tmcmc__trace trace, kk_context_t* _ctx) { /* forall<a,e> (trace : trace<a,e>) -> a */ 
  struct kk_tmcmc_Trace* _con2391 = kk_tmcmc__as_Trace(trace);
  kk_function_t _pat0 = _con2391->m;
  kk_effects_dash_and_dash_types__exp _pat1 = _con2391->p;
  kk_std_core__list _pat3 = _con2391->l;
  kk_box_t _x = _con2391->a;
  if (kk_tmcmc__trace_is_unique(trace)) {
