...
kk_std_num_random__sfc kk_std_num_random__copy(kk_std_num_random__sfc _this, kk_std_core_types__optional x0, kk_std_core_types__optional y0, kk_std_core_types__optional z0, kk_std_core_types__optional cnt0, kk_context_t* _ctx) { /* (sfc, x : optional<int32>, y : optional<int32>, z : optional<int32>, cnt : optional<int32>) -> sfc */ 
  int32_t _x1551;
  if (kk_std_core_types__is_Optional(x0)) {
    kk_box_t _box_x1436 = x0._cons.Optional.value;
    int32_t _x_132 = kk_int32_unbox(_box_x1436, NULL);
    kk_std_core_types__optional_drop(x0, _ctx);
    _x1551 = _x_132; /*int32*/
    goto _match1552;
  }
  int32_t _x = _this.x;
  ...
  _match1552: ;
  int32_t _x1554;
  if (kk_std_core_types__is_Optional(y0)) {
    kk_box_t _box_x1437 = y0._cons.Optional.value;
    int32_t _y_138 = kk_int32_unbox(_box_x1437, NULL);
    kk_std_core_types__optional_drop(y0, _ctx);
    _x1554 = _y_138; /*int32*/
    goto _match1555;
  }
  int32_t _x0 = _this.y;
  ...
  _match1555: ;
  int32_t _x1557;
  if (kk_std_core_types__is_Optional(z0)) {
    kk_box_t _box_x1438 = z0._cons.Optional.value;
    int32_t _z_144 = kk_int32_unbox(_box_x1438, NULL);
    kk_std_core_types__optional_drop(z0, _ctx);
    _x1557 = _z_144; /*int32*/
    goto _match1558;
  }
  int32_t _x1 = _this.z;
  ...
  _match1558: ;
  int32_t _x1560;
  if (kk_std_core_types__is_Optional(cnt0)) {
    kk_box_t _box_x1439 = cnt0._cons.Optional.value;
    int32_t _cnt_150 = kk_int32_unbox(_box_x1439, NULL);
    kk_std_core_types__optional_drop(cnt0, _ctx);
    _x1560 = _cnt_150; /*int32*/
    goto _match1561;
  }
  int32_t _x2 = _this.cnt;
  _x1560 = _x2; /*int32*/
  _match1561: ;
  return kk_std_num_random__new_Sfc(_x1551, _x1554, _x1557, _x1560, _ctx);
}
...
kk_box_t kk_std_num_random_strong_random(kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (action : () -> <random,ndet|e> a) -> <ndet|e> a */ 
  ...
  kk_std_core_hnd__clause0 _x1581 = kk_std_core_hnd_clause_tail_noyield0(kk_std_num_random_new_strong_random_fun1582(_ctx), _ctx); /*std/core/hnd/clause0<3,4,1,2>*/
...
int32_t kk_std_num_random__mlift1391_pseudo_random(kk_ref_t s, kk_std_num_random__sfc _y_4, kk_context_t* _ctx) { /* forall<_h,h1,e> (s : local-var<h1,sfc>, sfc) -> <local<h1>,local<_h>|e> int32 */ 
  ...
  kk_std_core_types__tuple2__drop(_match_1547, _ctx);
  kk_unit_t x0_1404 = kk_Unit;
  (kk_ref_set(s,(kk_std_num_random__sfc_box(sfc, _ctx)),kk_context()));
  if (kk_yielding(kk_context())) {
    kk_box_t _x1599 = kk_std_core_hnd_yield_extend(kk_std_num_random__new_mlift1391_pseudo_random_fun1600(x0, _ctx), _ctx); /*2*/
...
static kk_box_t kk_std_num_random_pseudo_random_fun1606(kk_function_t _fself, kk_std_core_hnd__marker _b_1495, kk_std_core_hnd__ev _b_1496, kk_context_t* _ctx) {
  ...
  _x1608 = (kk_ref_get(_x1609,kk_context())); /*0*/
  x_1411 = kk_std_num_random__sfc_unbox(_x1608, _ctx); /*std/num/random/sfc*/
  if (kk_yielding(kk_context())) {
    kk_box_t _x1610 = kk_std_core_hnd_yield_extend(kk_std_num_random_new_pseudo_random_fun1611(loc, _ctx), _ctx); /*2*/
...
kk_box_t kk_std_num_random_pseudo_random(kk_integer_t seed, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (seed : int, action : () -> <random|e> a) -> e a */ 
  ...
  kk_ref_dup(loc);
  _x1605 = kk_std_num_random_new_pseudo_random_fun1606(loc, _ctx); /*(std/core/hnd/marker<13,14>, std/core/hnd/ev<12>) -> 13 11*/
  _x1604 = kk_std_core_hnd__new_Clause0(_x1605, _ctx); /*std/core/hnd/clause0<11,12,13,14>*/
...
bool kk_std_num_random_random_bool(kk_context_t* _ctx) { /* () -> random bool */ 
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x1616 = kk_std_core_hnd_yield_extend(kk_std_num_random_new_random_bool_fun1617(_ctx), _ctx); /*2*/
...
double kk_std_num_random__mlift1393_random_double(int32_t lo, int32_t _y_14, kk_context_t* _ctx) { /* (lo : int32, int32) -> random double */ 
  ...
  double _x1621;
  kk_box_t _x1622 = kk_std_core_hnd__open_none2(kk_std_num_random__new_mlift1393_random_double_fun1623(_ctx), kk_int32_box(lo, _ctx), kk_int32_box(hi, _ctx), _ctx); /*3*/
...
double kk_std_num_random__mlift1394_random_double(int32_t lo, kk_context_t* _ctx) { /* (lo : int32) -> random double */ 
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x1627 = kk_std_core_hnd_yield_extend(kk_std_num_random__new_mlift1394_random_double_fun1628(lo, _ctx), _ctx); /*2*/
...
double kk_std_num_random_random_double(kk_context_t* _ctx) { /* () -> random double */ 
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x1631 = kk_std_core_hnd_yield_extend(kk_std_num_random_new_random_double_fun1632(_ctx), _ctx); /*2*/
    return kk_double_unbox(_x1631, _ctx);
  }
  int32_t x0_1424 = kk_std_num_random_random_int32(_ctx); /*int32*/;
  if (kk_yielding(kk_context())) {
    kk_box_t _x1635 = kk_std_core_hnd_yield_extend(kk_std_num_random_new_random_double_fun1636(x_1420, _ctx), _ctx); /*2*/
  ...
  double _x1640;
  kk_box_t _x1641 = kk_std_core_hnd__open_none2(kk_std_num_random_new_random_double_fun1642(_ctx), kk_int32_box(x_1420, _ctx), kk_int32_box(hi, _ctx), _ctx); /*3*/
...
kk_integer_t kk_std_num_random_random_int(kk_context_t* _ctx) { /* () -> random int */ 
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x1646 = kk_std_core_hnd_yield_extend(kk_std_num_random_new_random_int_fun1647(_ctx), _ctx); /*2*/
