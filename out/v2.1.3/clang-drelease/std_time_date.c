...
kk_string_t kk_std_time_date_show_1(kk_std_time_date__clock c, kk_std_core_types__optional prec, kk_context_t* _ctx) { /* (c : clock, prec : optional<int>) -> string */ 
  ...
  _match10548: ;
  _x10546 = kk_integer_box(_x10547); /*108*/
  _x10545 = kk_std_core_types__new_Optional(_x10546, _ctx); /*optional<108>*/
  kk_std_core_types__optional _x10550 = kk_std_core_types__new_Optional(kk_integer_box(kk_integer_from_small(2)), _ctx); /*optional<108>*/
