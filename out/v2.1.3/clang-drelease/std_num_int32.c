...
int32_t kk_std_num_int32_abs(int32_t i, kk_context_t* _ctx) { /* (i : int32) -> exn int32 */ 
  ...
  _x2154 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x2060, (_fun_unbox_x2060, m, ev_21562, kk_std_core__exception_box(exn_21561, _ctx), _ctx)); /*53*/
...
kk_string_t kk_std_num_int32_show_hex32(int32_t i, kk_std_core_types__optional width, kk_std_core_types__optional use_capitals, kk_std_core_types__optional pre, kk_context_t* _ctx) { /* (i : int32, width : optional<int>, use-capitals : optional<bool>, pre : optional<string>) -> string */ 
  ...
  _match2179: ;
  _x2177 = kk_integer_box(_x2178); /*108*/
  _x2176 = kk_std_core_types__new_Optional(_x2177, _ctx); /*optional<108>*/
  ...
  _x2183 = true; /*bool*/
  _match2184: ;
  _x2182 = kk_bool_box(_x2183); /*108*/
  _x2181 = kk_std_core_types__new_Optional(_x2182, _ctx); /*optional<108>*/
  ...
  _match2189: ;
  _x2187 = kk_string_box(_x2188); /*108*/
  _x2186 = kk_std_core_types__new_Optional(_x2187, _ctx); /*optional<108>*/
