...
static inline kk_function_t kk_trace_m(kk_trace__trace trace, kk_context_t* _ctx) { /* forall<a,e> (trace : trace<a,e>) -> (() -> e a) */ 
  struct kk_trace_Trace* _con1499 = kk_trace__as_Trace(trace);
  kk_function_t _x = _con1499->m;
  kk_effects_dash_and_dash_types__exp _pat0 = _con1499->p;
  kk_std_core__list _pat2 = _con1499->l;
  kk_box_t _pat3 = _con1499->a;
...
static inline kk_effects_dash_and_dash_types__exp kk_trace_p(kk_trace__trace trace, kk_context_t* _ctx) { /* forall<a,e> (trace : trace<a,e>) -> effects-and-types/exp */ 
  struct kk_trace_Trace* _con1500 = kk_trace__as_Trace(trace);
  kk_function_t _pat0 = _con1500->m;
  kk_effects_dash_and_dash_types__exp _x = _con1500->p;
  kk_std_core__list _pat2 = _con1500->l;
  kk_box_t _pat3 = _con1500->a;
  if (kk_trace__trace_is_unique(trace)) {
    kk_box_drop(_pat3, _ctx);
    kk_std_core__list_drop(_pat2, _ctx);
...
static inline kk_std_core__list kk_trace_l(kk_trace__trace trace, kk_context_t* _ctx) { /* forall<a,e> (trace : trace<a,e>) -> effects-and-types/trace_values */ 
  struct kk_trace_Trace* _con1501 = kk_trace__as_Trace(trace);
  kk_function_t _pat0 = _con1501->m;
  kk_effects_dash_and_dash_types__exp _pat1 = _con1501->p;
  kk_std_core__list _x = _con1501->l;
  kk_box_t _pat3 = _con1501->a;
  if (kk_trace__trace_is_unique(trace)) {
    kk_box_drop(_pat3, _ctx);
    kk_function_drop(_pat0, _ctx);
    kk_trace__trace_free(trace);
...
static inline kk_box_t kk_trace_a(kk_trace__trace trace, kk_context_t* _ctx) { /* forall<a,e> (trace : trace<a,e>) -> a */ 
  struct kk_trace_Trace* _con1502 = kk_trace__as_Trace(trace);
  kk_function_t _pat0 = _con1502->m;
  kk_effects_dash_and_dash_types__exp _pat1 = _con1502->p;
  kk_std_core__list _pat3 = _con1502->l;
  kk_box_t _x = _con1502->a;
  if (kk_trace__trace_is_unique(trace)) {
