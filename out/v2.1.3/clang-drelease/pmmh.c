...
static kk_box_t kk_pmmh__mlift119_new__model_fun275(kk_function_t _fself, kk_box_t _b_194, kk_context_t* _ctx) {
  ...
  kk_function_t _bv_193 = _self->_bv_193; /* (steps : int) -> <effects-and-types/yield,effects-and-types/sample,effects-and-types/score,div,exn,std/num/random/random,effects-and-types/score,ndet,effects-and-types/sample|62> 78 */
...
static kk_box_t kk_pmmh__mlift119_new__model_fun272(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_drop_match(_self, {kk_function_dup(model_132);}, {}, _ctx)
  kk_function_t _x273;
  kk_function_t _bv_193 = kk_handlers_advance(kk_pmmh__new_mlift119_new__model_fun274(model_132, _ctx), _ctx); /*(steps : int) -> <effects-and-types/yield,effects-and-types/sample,effects-and-types/score,div,exn,std/num/random/random,effects-and-types/score,ndet,effects-and-types/sample|62> 78*/;
...
static kk_box_t kk_pmmh__mlift119_new__model_fun278(kk_function_t _fself, kk_box_t _b_198, kk_context_t* _ctx) {
  ...
  kk_std_core__list _x280 = kk_std_core__list_unbox(_b_198, _ctx); /*effects-and-types/histogram<(steps : int) -> <effects-and-types/sample,effects-and-types/score,effects-and-types/yield,div,exn,std/num/random/random,effects-and-types/score,ndet,effects-and-types/sample|62> 78>*/
  _x279 = kk_smc__mlift512_smc(false, kk_integer_from_small(1), step__num, _x280, _ctx); /*effects-and-types/histogram<1>*/
...
static kk_box_t kk_pmmh__mlift119_new__model_fun270(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_std_core__list x_538 = kk_sampling_populate(particle__num, kk_pmmh__new_mlift119_new__model_fun272(model_132, _ctx), _ctx); /*effects-and-types/histogram<(steps : int) -> <effects-and-types/sample,effects-and-types/score,effects-and-types/yield,div,exn,std/num/random/random,effects-and-types/score,ndet,effects-and-types/sample|62> 78>*/;
  if (kk_yielding(kk_context())) {
    ...
    _x271 = kk_smc__mlift512_smc(false, kk_integer_from_small(1), step__num, x_538, _ctx); /*effects-and-types/histogram<78>*/
  }
...
static kk_box_t kk_pmmh_new__model_fun295(kk_function_t _fself, kk_box_t _b_219, kk_context_t* _ctx) {
  ...
  kk_function_t _bv_218 = _self->_bv_218; /* (steps : int) -> <effects-and-types/yield,effects-and-types/sample,effects-and-types/score,div,exn,std/num/random/random,effects-and-types/score,ndet,effects-and-types/sample|62> 78 */
...
static kk_box_t kk_pmmh_new__model_fun292(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_drop_match(_self, {kk_function_dup(model_144);}, {}, _ctx)
  kk_function_t _x293;
  kk_function_t _bv_218 = kk_handlers_advance(kk_pmmh_new_new__model_fun294(model_144, _ctx), _ctx); /*(steps : int) -> <effects-and-types/yield,effects-and-types/sample,effects-and-types/score,div,exn,std/num/random/random,effects-and-types/score,ndet,effects-and-types/sample|62> 78*/;
...
static kk_box_t kk_pmmh_new__model_fun298(kk_function_t _fself, kk_box_t _b_223, kk_context_t* _ctx) {
  ...
  kk_std_core__list _x300 = kk_std_core__list_unbox(_b_223, _ctx); /*effects-and-types/histogram<(steps : int) -> <effects-and-types/sample,effects-and-types/score,effects-and-types/yield,div,exn,std/num/random/random,effects-and-types/score,ndet,effects-and-types/sample|62> 78>*/
  _x299 = kk_smc__mlift512_smc(false, kk_integer_from_small(1), step__num, _x300, _ctx); /*effects-and-types/histogram<1>*/
...
static kk_box_t kk_pmmh_new__model_fun290(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_std_core__list x_538 = kk_sampling_populate(particle__num, kk_pmmh_new_new__model_fun292(model_144, _ctx), _ctx); /*effects-and-types/histogram<(steps : int) -> <effects-and-types/sample,effects-and-types/score,effects-and-types/yield,div,exn,std/num/random/random,effects-and-types/score,ndet,effects-and-types/sample|62> 78>*/;
  if (kk_yielding(kk_context())) {
    kk_std_core__list_drop(x_538, _ctx);
    ...
    _x291 = kk_smc__mlift512_smc(false, kk_integer_from_small(1), step__num, x_538, _ctx); /*effects-and-types/histogram<78>*/
  }
