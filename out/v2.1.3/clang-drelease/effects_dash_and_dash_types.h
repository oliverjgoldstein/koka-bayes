...
static inline kk_effects_dash_and_dash_types__exp kk_effects_dash_and_dash_types__copy(kk_effects_dash_and_dash_types__exp _this, kk_std_core_types__optional i0, kk_context_t* _ctx) { /* (exp, i : optional<double>) -> exp */ 
  ...
  if (kk_std_core_types__is_Optional(i0)) {
    kk_box_t _box_x414 = i0._cons.Optional.value;
    double _i_191 = kk_double_unbox(_box_x414, NULL);
    kk_std_core_types__optional_drop(i0, _ctx);
    _x484 = _i_191; /*double*/
    goto _match485;
  }
  double _x = _this.i;
  _x484 = _x; /*double*/
  _match485: ;
  return kk_effects_dash_and_dash_types__new_Exp(_x484, _ctx);
}
...
static inline kk_std_core_hnd__clause0 kk_effects_dash_and_dash_types__select_sample(kk_effects_dash_and_dash_types__hnd_sample hnd, kk_context_t* _ctx) { /* forall<e,a> (hnd : .hnd-sample<e,a>) -> std/core/hnd/clause0<double,.hnd-sample,e,a> */ 
  struct kk_effects_dash_and_dash_types__Hnd_sample* _con496 = kk_effects_dash_and_dash_types__as_Hnd_sample(hnd);
  kk_std_core_hnd__clause0 fun_sample = _con496->fun_sample;
...
static inline kk_std_core_hnd__clause1 kk_effects_dash_and_dash_types__select_score(kk_effects_dash_and_dash_types__hnd_score hnd, kk_context_t* _ctx) { /* forall<e,a> (hnd : .hnd-score<e,a>) -> std/core/hnd/clause1<exp,(),.hnd-score,e,a> */ 
  struct kk_effects_dash_and_dash_types__Hnd_score* _con497 = kk_effects_dash_and_dash_types__as_Hnd_score(hnd);
  kk_std_core_hnd__clause1 fun_score = _con497->fun_score;
...
static inline kk_std_core_hnd__clause0 kk_effects_dash_and_dash_types__select_yield(kk_effects_dash_and_dash_types__hnd_yield hnd, kk_context_t* _ctx) { /* forall<e,a> (hnd : .hnd-yield<e,a>) -> std/core/hnd/clause0<(),.hnd-yield,e,a> */ 
  struct kk_effects_dash_and_dash_types__Hnd_yield* _con498 = kk_effects_dash_and_dash_types__as_Hnd_yield(hnd);
...
static inline double kk_effects_dash_and_dash_types_sample(kk_context_t* _ctx) { /* () -> sample double */ 
  ...
  size_t _x499 = ((size_t)0); /*size_t*/
  ev_404 = kk_evv_at(_x499,kk_context()); /*std/core/hnd/ev<effects-and-types/.hnd-sample>*/
  kk_box_t _x500;
  struct kk_std_core_hnd_Ev* _con501 = kk_std_core_hnd__as_Ev(ev_404);
  kk_std_core_hnd__marker m = _con501->marker;
  kk_box_t _box_x445 = _con501->hnd;
  kk_effects_dash_and_dash_types__hnd_sample h = kk_effects_dash_and_dash_types__hnd_sample_unbox(_box_x445, NULL);
  kk_effects_dash_and_dash_types__hnd_sample_dup(h);
  kk_std_core_hnd__clause0 _match_483;
  struct kk_effects_dash_and_dash_types__Hnd_sample* _con503 = kk_effects_dash_and_dash_types__as_Hnd_sample(h);
  kk_std_core_hnd__clause0 fun_sample = _con503->fun_sample;
  ...
  _match_483 = fun_sample; /*std/core/hnd/clause0<double,effects-and-types/.hnd-sample,3435,3436>*/
  kk_function_t _fun_unbox_x448 = _match_483.clause;
  _x500 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_context_t*), _fun_unbox_x448, (_fun_unbox_x448, m, ev_404, _ctx)); /*37*/
  return kk_double_unbox(_x500, _ctx);
}
...
static inline kk_unit_t kk_effects_dash_and_dash_types_score(kk_effects_dash_and_dash_types__exp s, kk_context_t* _ctx) { /* (s : exp) -> score () */ 
  ...
  size_t _x504 = ((size_t)0); /*size_t*/
  ev_406 = kk_evv_at(_x504,kk_context()); /*std/core/hnd/ev<effects-and-types/.hnd-score>*/
  kk_box_t _x505;
  struct kk_std_core_hnd_Ev* _con506 = kk_std_core_hnd__as_Ev(ev_406);
  kk_std_core_hnd__marker m = _con506->marker;
  kk_box_t _box_x453 = _con506->hnd;
  kk_effects_dash_and_dash_types__hnd_score h = kk_effects_dash_and_dash_types__hnd_score_unbox(_box_x453, NULL);
  kk_effects_dash_and_dash_types__hnd_score_dup(h);
  kk_std_core_hnd__clause1 _match_482;
  struct kk_effects_dash_and_dash_types__Hnd_score* _con508 = kk_effects_dash_and_dash_types__as_Hnd_score(h);
  kk_std_core_hnd__clause1 fun_score = _con508->fun_score;
  ...
  _match_482 = fun_score; /*std/core/hnd/clause1<effects-and-types/exp,(),effects-and-types/.hnd-score,3528,3529>*/
  kk_function_t _fun_unbox_x457 = _match_482.clause;
  _x505 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x457, (_fun_unbox_x457, m, ev_406, kk_effects_dash_and_dash_types__exp_box(s, _ctx), _ctx)); /*53*/
  kk_unit_unbox(_x505); return kk_Unit;
}
...
static inline kk_unit_t kk_effects_dash_and_dash_types_yield(kk_context_t* _ctx) { /* () -> yield () */ 
  ...
  size_t _x509 = ((size_t)0); /*size_t*/
  ev_409 = kk_evv_at(_x509,kk_context()); /*std/core/hnd/ev<effects-and-types/.hnd-yield>*/
  kk_box_t _x510;
  struct kk_std_core_hnd_Ev* _con511 = kk_std_core_hnd__as_Ev(ev_409);
  kk_std_core_hnd__marker m = _con511->marker;
  kk_box_t _box_x464 = _con511->hnd;
  kk_effects_dash_and_dash_types__hnd_yield h = kk_effects_dash_and_dash_types__hnd_yield_unbox(_box_x464, NULL);
  kk_effects_dash_and_dash_types__hnd_yield_dup(h);
  kk_std_core_hnd__clause0 _match_481;
  struct kk_effects_dash_and_dash_types__Hnd_yield* _con513 = kk_effects_dash_and_dash_types__as_Hnd_yield(h);
  kk_std_core_hnd__clause0 control_yield = _con513->control_yield;
  ...
  _match_481 = control_yield; /*std/core/hnd/clause0<(),effects-and-types/.hnd-yield,3435,3436>*/
  kk_function_t _fun_unbox_x467 = _match_481.clause;
  _x510 = kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_context_t*), _fun_unbox_x467, (_fun_unbox_x467, m, ev_409, _ctx)); /*37*/
  kk_unit_unbox(_x510); return kk_Unit;
}
